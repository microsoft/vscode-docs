...
If your extension needs to preserve some user state across different machines then provide the state to [Setting Sync](/docs/editor/customizing/settings-sync) using `vscode.ExtensionContext.globalState.setKeysForSync`.
