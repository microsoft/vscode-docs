...
| ------------------------------------------------------- | :------: | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`                                                  |    Y     | `string`                                   | The name of the extension - should be all lowercase with no spaces. Note the name has to be unique to Marketplace.                                                                                                                                                                                                                                                    |
...
| `displayName`                                           |          | `string`                                   | The display name for the extension used in the Marketplace. Note the display name has to be unique to Marketplace.                                                                                                                                                                                                                                                            |
