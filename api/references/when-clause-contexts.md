...
`view` | True when view identifier matches.<br>Example: `"view == myViewsExplorerID"`.
`viewItem` | True when viewItem context matches.<br>Example:  `"viewItem == someContextValue"`.
