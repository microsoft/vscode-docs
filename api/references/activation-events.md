...
MetaDescription: To support lazy activation of Visual Studio Code extensions, your extension controls when it should be loaded through a set of Activation Events.
---
