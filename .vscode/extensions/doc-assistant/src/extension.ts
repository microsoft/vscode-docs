...
import { registerReleaseNoteTocDiagnostics } from './releaseNoteTocDiagnostics';
import { registerMarkdownAuthoringSupport } from './markdown/providers';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    registerReleaseNoteTocDiagnostics(context);
    registerMarkdownAuthoringSupport(context, logger);
}
