...
<video src="images/1_52/goto-definition.mp4" title="Video showing Go to Definition." autoplay loop controls muted></video>
...
<video src="images/1_52/explorer-undo.mp4" title="Video showing Selecting undo from the Edit menu while in the Explorer." autoplay loop controls muted></video>
...
<video src="images/1_52/explorer-progress.mp4" title="Video showing Showing progress in the File Explorer." autoplay loop controls muted></video>
...
<video src="images/1_52/splitview-overflow.mp4" title="Video showing Improved workbench overflow." autoplay loop controls muted></video>

### Sash hover border color

You can now customize a border hover color for sashes (`sash.hoverBorder`) across the workbench.

<video src="images/1_52/sash.mp4" title="Video showing Sash hover border color." autoplay loop controls muted></video>
...
<video src="images/1_52/checkout-detached.mp4" title="Video showing Selecting Git: Checkout to (detached)... and then selecting a ref to checkout in detached mode." autoplay loop controls muted></video>
...
<video src="images/1_52/remove-recent-task.mp4" title="Video showing Remove recent task from Quick Pick menu." autoplay loop controls muted></video>
...
<video src="images/1_52/extensions-auto-refresh.mp4" title="Video showing Extension view auto refresh." autoplay loop controls muted></video>
...
<video src="images/1_52/configure-keybinding.mp4" title="Video showing Configure keybinding for a command from the Command Palette." autoplay loop controls muted></video>
...
<video src="images/1_52/sticky-tab-stops.mp4" title="Video showing Sticky Tab Stops." autoplay loop controls muted></video>
...
<video src="images/1_52/configure-terminal-settings.mp4" title="Video showing Configure Terminal Settings." autoplay loop controls muted></video>
...
<video src="images/1_52/terminal-keybindings-notification.mp4" title="Video showing Send Keybindings to Shell." autoplay loop controls muted></video>
...
<video src="images/1_52/inline-markdown-smart-select.mp4" title="Video showing Smart select within a Markdown document expands from the content within an inline Markdown type to include the Markdown symbols." autoplay loop controls muted></video>
...
<video src="images/1_52/notebook-large-output-optimization.mp4" title="Video showing Large Output Rendering Optimization." autoplay loop controls muted></video>
...
<video src="images/1_52/markdown-tree-tooltip.mp4" title="Video showing Markdown tree tooltip." autoplay loop controls muted></video>
...
<video src="images/1_52/view-welcome.mp4" title="Video showing View welcome content button enablement." autoplay loop controls muted></video>
