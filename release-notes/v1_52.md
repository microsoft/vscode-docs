...
* **[Accessibility improvements](#accessible-progress-control)** - Screen reader support for workbench progress and exception information.
...
* Check out our new Learn Module on how to best leverage the editor's GitHub integration: [Introduction to GitHub in Visual Studio Code](hhttps://docs.microsoft.com/en-us/learn/modules/introduction-to-github-visual-studio-code/).
