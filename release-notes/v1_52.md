...
JSDoc `@see` tags let you reference other functions and classes in your JSDoc comments. The example below shows `crash` function referencing the `WrappedError` class from another file:
