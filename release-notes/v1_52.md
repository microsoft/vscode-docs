...
With the addition of the VS Code builds for Linux ARMv7 and ARM64, you can now run VS Code on Chromebooks, which are a nice low cost option for beginning programmers. Learn how to set up VS Code for JavaScript or Python development in our recent [Learning with VS Code on Chromebooks](https://code.visualstudio.com/blogs/2020/12/03/chromebook-get-started) blog post.
