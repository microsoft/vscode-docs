...
* **[Improved word-based suggestions](#wordbased-suggestions-from-other-documents)** - Display word-based suggestions from other open files.
...
* `@command:commandId` - Filters by command ID. For example, `@command:workbench.actions.showCommands`.
...
* Check out our new Learn module on how to best leverage the editor's GitHub integration with this [Introduction to GitHub in Visual Studio Code](https://docs.microsoft.com/learn/modules/introduction-to-github-visual-studio-code/).
