...
After focusing on housekeeping, we have also addressed several feature requests and community [pull requests](#thank-you). There are a number of updates in this version that we hope you will like, some of the key highlights include:

* **[Accessibility improvements](#accessible-progress-control)** - Screen readers can now capture workbench progress and the exception information area.
...
* **[Preview editor improvements](#preview-editor-improvements)** - Keep editors open, or turn off preview editors altogether.
