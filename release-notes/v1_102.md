...
#### `#activePullRequest` tool

Get information about the active pull request in the current workspace with the `#activePullRequest` tool. This tool returns information about the pull request, such as its title, description, and status for use in chat.

This tool is automatically attached to chat when opening a pull request in a workspace.
