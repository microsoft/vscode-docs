...
![Maximised Chat](./images/1_102/max-sidebar.png)

A new icon next to the close button allows you to toggle, or the new command `workbench.action.toggleMaximizedAuxiliaryBar` can be used.
...
* [@award999](https://github.com/award999): Updates to the swift language docs [PR #8523](https://github.com/microsoft/vscode-docs/pull/8523)
* [@kazarmy (Khairul Azhar Kasmiran)](https://github.com/kazarmy): Replace hanging "and" with "." [PR #8522](https://github.com/microsoft/vscode-docs/pull/8522)
* [@MuyangAmigo (Junjie Li)](https://github.com/MuyangAmigo): Refresh AITK Evaluation Page [PR #8472](https://github.com/microsoft/vscode-docs/pull/8472)
* [@UziTech (Tony Brix)](https://github.com/UziTech): Add scroll on middle click release notes [PR #8476](https://github.com/microsoft/vscode-docs/pull/8476)
