...
To snooze suggestions, click the Copilot status bar item in the bottom right corner, or run the **Snooze Inline Suggestions** command from the Command Palette and select a duration from the dropdown menu. During the snooze period, no inline suggestions or NES will appear.

![Copilt status bar view with the snooze button at the bottom](images/1_102/nes-snooze.png)
