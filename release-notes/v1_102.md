...
- `setting(chat.editRequests.inline)`: Hover over a request and click on the text to begin an edit inline with the request.
- `setting(chat.editRequests.hover)`: Hover over a request to reveal a toolbar with a button to begin an edit inline with the request.
- `setting(chat.editRequests.input)`: Hover over a request to reveal a toolbar, which will start edits in the input box at the bottom of chat.
