...
!["cd c:\Github\mi" will show results for all absolute folders matching that term](terminal-absolute-windows.png)
...
![Flags like --help will show a flag icon, options like --diff will show a different icon](terminal-flags-options.png)
