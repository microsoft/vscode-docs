...
<video src="images/1_84/inline_chat_sparkle.mp4" autoplay loop controls muted title="Inline chat sparkle gutter icon"></video>
...
File icon themes authors can now define name specific icons for root folders using the new properties `rootFolderNames` and `rootFolderNamesExpanded`. See the [File Icon Theme guide](/api/extension-guides/file-icon-theme) for more information.
