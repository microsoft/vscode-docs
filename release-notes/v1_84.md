...
More improvements have been made to how the next cells are revealed when executing through notebooks with `shift` + `enter` to help focus on the output and reduce the amount of movement when re-executing cells.
