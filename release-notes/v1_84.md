...
The `Tensorboard` functionality has now been moved out of the Python extension into the standlone [Tensorboard extension](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.tensorboard).
