...
The implementation is currently in an early stage, and can expect to see improvements over the next few iterations.
...
There is also a new button that allows you to open the Test Logs more easily from the Test Explorer view when errors on test discovery occur.
