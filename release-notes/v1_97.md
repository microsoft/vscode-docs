...
When writing queries for Chat or Edits, you can now reference files that have been modified in your Git source control view by using the `#changes` context variable. For example, you could prompt for `summarize my #changes`.
