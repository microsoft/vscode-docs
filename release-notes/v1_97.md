...
We have expanded the functionality of the Source Control Graph view by adding actions scoped to a history item reference (ex: branch tag, etc.) to the context menu. The first set of actions that we added are: **Checkout**, **Delete Branch**, and **DeleteTag** with more actions to follow in the upcoming milestones.
