...
![copilot edits agent mode](images/1_97/agent-mode.png)
...
> **Note**: Copilot Edits may use many chat requests in agent mode, so it will periodically pause and ask you whether to continue. You can customize this with `setting(chat.agent.maxRequests)`. This defaults to 15 for paid users, and 5 for free users.
...
![Chart of issue counts over the last years](images/1_97/housekeeping.png)
