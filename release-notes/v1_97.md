...
A confirmation dialog will show when you `esc` or otherwise close a comment widget that has un-submitted comments. You can disable this confirmation with the setting `setting(comments.thread.confirmOnCollapse)`.

#### Quick actions in the comment editor

Quick actions can be used from the comments widget editor.
