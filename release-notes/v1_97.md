...
#### Settings editor search improvements

This iteration, we fixed a regression where search queries with missing letters were not showing results.

We also fixed an issue where a narrow Settings editor would still reveal the table of contents during a search.
