...
You will now be able to launch a VS Code Native REPL from your REPL in Terminal. Setting `python.terminal.shellIntegration.enabled` to true should display a clickable link in the Python REPL in terminal, allowing you to directly open the VS Code Native REPL from the terminal.
