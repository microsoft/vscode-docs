...
Our experimentation has shown that this yields much better Inline Chat results. Therefore, temporal context is now on by default for Inline Chat. You can configure it via `setting(github.copilot.chat.editor.temporalContext.enabled)`.
...
![Screenshot of Copilot chat response which lists the modified files and changes when prompting for '#changes'.](images/1_97/copilot-chat-git-changes.png)
...
![Searching in a narrow Settings editor for 'edtor cursstyle' shows 'editor.cursorStyle' setting and does not reveal table of contents on left](images/1_97/settings-editor-search.png)
...
<video src="images/1_97/terminal-progress.mp4" title="Progress indicator in terminal title." autoplay loop controls muted></video>
...
![Searching in the Variables view](images/1_97/debug-search-values.png)
