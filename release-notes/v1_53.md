...
**Note:** We had originally planned to push the Apple Silicon builds to Stable this iteration but an issue was identified late in the iteration cycle where a Wasm module loaded in the extension host will crash the process. We are actively investigating in upstream issue [#115646](https://github.com/microsoft/vscode/issues/115646), which you can follow for updates. We will push for a Stable release of the Apple Silicon builds once the issue has been fixed.
