...
* **[Apple Silicon builds](#apple-silicon)** - VS is now available for Apple Silicon.
...
A new documentation page touches on the topic of what "workspaces" are in VS Code. If you are interested in learning more about the differences between folder, multi-root and untitled workspaces, take a look at [What is a VS Code "Workspace"](https://code.visualstudio.com/docs/editor/workspaces).
