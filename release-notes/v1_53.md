...
**Consolidated condition editing for all breakpoint types**
TODO@isidorn
...
**Watches view supports multi selection**
TODO@isidorn

**Debug console icon moved into menu**
to gain space for the drop down menu...
TODO@isidorn
