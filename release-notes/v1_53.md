...
**Note:** We originally planned to push the Apple Silicon builds to Stable. But, late in the iteration users reported that on macOS Big Sur 11.2 loading a WASM module crashed the extension host. You can follow along our investigation of the problem in upstream issue [#115646](https://github.com/microsoft/vscode/issues/115646).
