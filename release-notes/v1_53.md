...
If a user tries to quit VS Code while there is a file operation in progress we now show a confirmation dialog.

We also show a confirmation dialog for destructive undo operations from the Explorer.
...
**Start a debug configuration multiple times**

We have lifted the artificial restriction...
TODO@isidorn
