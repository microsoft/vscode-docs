...
See the [Code Action](https://code.visualstudio.com/docs/editor/editing/refactoring#_keybindings-for-code-actions) documentation for more information on configuring keybindings for refactorings.
