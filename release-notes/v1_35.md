...
You can play with the [comment sample extension](https://github.com/microsoft/vscode-extension-samples/tree/master/comment-sample) to get a better understanding of the API or take a deep look at the [GitHub Pull Requests](https://github.com/microsoft/vscode-pull-request-github/pull/1168) extension source code.
