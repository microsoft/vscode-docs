...
* **[Breadcrumb navigation displayed by default](#breadcrumbs-displayed)** - Quickly navigate to files and symbols via breadcrumbs.
...
* **[Better merge conflict display](#compare-merge-conflict-with-complete-context)** - See merge conflict changes within surrounding source code.
...
Breadcrumbs for quick file and symbol navigation is now on by default. This can be toggled in the View menu **View** > **Toggle Breadcrumbs** command.
