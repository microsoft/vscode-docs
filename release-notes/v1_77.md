...
* [Ruby in VS Code](https://code.visualstudio.com/docs/languages/ruby) - Learn about Ruby language support (snippets, linting, debugging) using the [Ruby LFS](https://marketplace.visualstudio.com/items?itemName=Shopify.ruby-lsp) extension.
