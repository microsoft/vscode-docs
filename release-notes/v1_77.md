...
* [@ShauryaAg (Shaurya Agarwal)](https://github.com/ShauryaAg): fix: modify argument regex to only allow certain set of values [PR #361](https://github.com/devcontainers/cli/pull/361)
* [@ShauryaAg (Shaurya Agarwal)](https://github.com/ShauryaAg): fix: fixed fromStatement parsing to parse quotes in variable expressions [PR #356](https://github.com/devcontainers/cli/pull/356)
* [@ShauryaAg (Shaurya Agarwal)](https://github.com/ShauryaAg): fix: handle parsing variable expression in dockerfile [PR #337](https://github.com/devcontainers/cli/pull/337)
