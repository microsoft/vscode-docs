...
This experience is available when the agent host is enabled for the Claude agent with `setting(chat.agentHost.enabled)` and `setting(chat.agents.claude.preferAgentHost)`.
