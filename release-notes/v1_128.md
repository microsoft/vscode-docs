...
<video src="images/1_128/claude-multi-chat-session.mp4" title="Video showing multiple chats running in parallel within a single Claude agent-host session."controls muted></video>
...
<video src="images/1_128/quick-chat.mp4" title="Video showing starting a workspace-less quick chat in the Agents window."controls muted></video>
...
<video src="images/1_128/sub-agent-chats.mp4" title="Video showing read-only subagent chats opened from a running session in the Agents window."controls muted></video>
