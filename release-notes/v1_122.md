...
* [Support for 1M context windows](#1m-context-window-for-anthropic-and-openai-models): Support for 1M context windows for Anthropic and OpenAI models.
...
Under the new model, each interaction consumes AI credits which are calculated based on token (input, output, and cached) cost based on the model used. More complex interactions and more capable models consume more credits, while lightweight models and simpler tasks use fewer. Learn more about how your usage can impact cost in our [docs]().
