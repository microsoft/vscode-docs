...
#### PR eval assessment flow improvement

Eval assessments now use true before/after comparisons by default, matching runs on the same agent and model instead of comparing across models. This makes it easier to understand the effect of a change in a PR without the comparison being skewed by a different model.
