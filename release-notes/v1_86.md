...
* **[Flexible Auto Save options](#more-powerful-and-flexible-auto-save-options)** - Fine-tune Auto Save to not save on errors or specific file types.
* **[Source Control Git Merge](#source-control)** - More merge options with support for merging tags.
* **[GitHub Copilot updates](#github-copilot)** - Confirm AI suggestions on save, add file context.
