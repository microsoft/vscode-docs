...
* **[Per-window zoom levels](#per-window-zoom-levels)** - Adjust the zoom level for each window independently.
* **[Hey Code voice command](#accessibility)** - Start a chat session with a voice command.
* **[Multi-file diff editor](#multi-file-diff-editor)** - Quickly review diffs across multiple files.
...
* **[Flexible Auto Save options](#more-powerful-and-flexible-auto-save-options)** - Fine-tune Auto Save to not save on errors or only for specific file types.
* **[Source Control Git Merge](#source-control)** - More merge options with support for merging tags.
* **[GitHub Copilot updates](#github-copilot)** - Confirm AI suggestions on save, add file context, use selection context.
