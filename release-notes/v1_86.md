...
We now have [shell integration for Python REPL](https://code.visualstudio.com/docs/terminal/shell-integration) enabled for Mac and Linux. When executing commands in the Python REPL, colored circles decorators will indicate whether the commands succeeded or failed. This also enables support for the **Terminal: Run Recent Command...** command. This feature also provides support for the **Terminal: Run Recent Command…** command, allowing you to view and utilize the REPL’s command history.
