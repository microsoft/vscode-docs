...
With a new setting `accessibility.voice.keywordActivation` you can enable VS Code to understand the "Hey Code" phrase to start a voice session with Copilot Chat. Available options are:
