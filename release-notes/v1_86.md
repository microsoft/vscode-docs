...
We've been working on an API to enable extension authors to contribute their own chat agents to the chat panel in VS Code. We've made a few changes to the API:
