...
The video below shows using **Peak Implementations** to see all implementations of the `ICommandService` interface in a Peek view:
...
![Visual Studio Online extension](images/1_41/vsonline-extension.png)
