...
* [Montana Rowe (@calcnerd256)](https://github.com/calcnerd256): Correct misuse of "then" where "than" is appropriate. [PR #866](https://github.com/microsoft/language-server-protocol/pull/866)