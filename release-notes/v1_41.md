...
- Navigate to results using "Go to Definition"-style commands, such as "Peek Definition" and "Open Definition to Side".
- Rerun a search to update all results
