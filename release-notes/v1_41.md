...
The Code Action and Refactoring menus now include [custom keybindings](https://code.visualstudio.com/docs/editor/refactoring#_keybindings-for-code-actions).
...
You can learn more at [Developing with Visual Studio Online](https://code.visualstudio.com/docs/remote/vsonline) and get started creating and customizing a development environment with the [Visual Studio Online Quickstarts](https://docs.microsoft.com/visualstudio/online/quickstarts/vscode).
...
* Remote - Containers: Easier to try out sample repositories (for example [vscode-remote-try-python](https://github.com/microsoft/vscode-remote-try-python)) in a container.
