...
This iteration we added continuous build and test pipeline for Monaco Editor. We will build Monaco Editor core from master branch of VS Code repository and perform sanity testing against it to catch potential bugs or unexpected breaking changes as early as possible.
