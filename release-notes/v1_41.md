...
### Keybindings in code action menus

Code action and refactoring menus now include [custom keybindings](https://code.visualstudio.com/docs/editor/refactoring#_keybindings-for-code-actions).
...
If you run into any issues or have any requests for certain components, please create an issue so that we can triage and track the requests.
