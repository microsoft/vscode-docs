...
To add more programming language support to [vscode.dev](https://vscode.dev), the VS Code team has been investigating compiling Python to [WebAssembly](https://webassembly.org) to run interpreters and debuggers in the browser. If you are interested in this approach and want to learn more, check out the recent [VS Code and WebAssemblies](https://code.visualstudio.com/blogs/2023/06/05/vscode-wasm-wasi) blog post.
