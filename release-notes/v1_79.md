...
<video src="images/1_79/readonly-mode.mp4" controls muted title="Readonly mode set for a node_modules folder"></video>
...
<video src="images/1_79/tab-size-fixed.mp4" controls muted title="Fixed tab size"></video>
...
<video title="Using the paste as control to change how an image is inserted into a notebook Markdown cell" src="images/1_79/paste-as-widget.mp4" controls muted></video>
...
<video src="images/1_79/git-branch-picker.mp4" controls muted title="Open a branch on GitHub.com from the branch picker"></video>
...
<video src="images/1_79/rich-content-notebook-search.mp4" controls muted title="Rich content notebook search"></video>

Using the new notebook search toggle, you can also filter which types of cell content you would like to search in.

<video src="images/1_79/rich-content-notebook-search-toggle.mp4" controls muted  title="Rich content notebook toggle cell content"></video>
...
<video src="images/1_79/notebook-output-hotkeys.mp4" controls muted title="Use raw hotkeys while focused on the output"></video>
...
<video src="images/1_79/formatOnRun.mp4" controls muted title="Format on cell execution"></video>
...
<video title="Linked editing some JSX tags" src="images/1_79/ts-linked-editing.mp4" controls muted></video>
...
<video src="images/1_79/ts-rename-jsx.mp4" controls muted title="Renaming a JSX tag using F2"></video>
...
<video title="@param completions in a JavaScript file" src="images/1_79/js-param-snippets.mp4" controls muted></video>
...
<video title="Coping a file into the workspace by drag and dropping it" src="images/1_79/markdown-copy.mp4" controls muted></video>
...
<video src="images/1_79/copilot-notebook-context.mp4" controls muted title="Copilot uses notebook as context"></video>
...
<video src="images/1_79/copilot-notebook-fix.mp4" controls muted title="Copilot fix cell execution errors"></video>
...
<video src="images/1_79/copilot-ghpr-apply-suggestion.mp4" controls muted title="Apply review comment with Copilot"></video>

#### Experimental Quick Question experience

<video src="images/1_79/quick-question.mp4" controls muted title="Ask a quick question with Copilot"></video>
...
<video src="images/1_79/move-chat-sessions.mp4" controls muted title="Moving chat sessions from sidebar to editor"></video>
...
<video src="images/1_79/codeblock-keybindings.mp4" controls muted title="Copilot Chat code block navigation"></video>
...
<video src="images/1_79/run-python-file-dedicated-terminal.mp4" controls muted title="Running a Python file creates a separate, dedicated terminal for that file."></video>
...
<video src="images/1_79/ts-move-to-file.mp4" controls muted title="Moving a symbol between Typescript files"></video>
...
<video src="images/1_79/share-provider.mp4" controls muted title="Share... icon next to the Command Center"></video>
...
<video src="images/1_79/profile-switch.mp4" controls muted title="Switch profile with hex editor dirty"></video>
