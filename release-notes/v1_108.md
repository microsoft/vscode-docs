...
![Screenshot of the Agent Sessions view showing changed files and associated pull requests for sessions.](images/1_108/agentsessions.png)
...
![Screenshot of the chat Quick Pick showing a list of agent sessions.](images/1_108/agentpicker.png)
...
![Screenshot of the chat title control.](images/1_108/agentittle.png)
...
Breakpoints can now be shown as a tree, group by their file, using the setting `setting(debug.breakpointsView.presentation:true)`.

![](./images/1_108/debug-bp-tree.png)
...
![](./images/1_108/coverage-navigation.png)
