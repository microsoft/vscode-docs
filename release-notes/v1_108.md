...
Learn more about creating and using skills in the [Agent Skills documentation](https://code.visualstudio.com/docs/agent-customization/agent-skills).
...
![Screenshot of the overlay that appears in the middle of the terminal with the current columns and rows when a terminal resize happens.](images/1_108/terminal-resize-overlay.webp)
