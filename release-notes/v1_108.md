...
### Preview: Authoring extensions in TypeScript

It is possible to author VS Code extensions directly in TypeScript without a build step. This works, but there is still a bit of adventure involved! Many aspects are still untested, such as how to write and run tests, how to publish extensions, and other workflow considerations.
