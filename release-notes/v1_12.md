...
**Note**: This is only a first cut of support for native tabs on macOS Siera. We are still missing some functionality but will update this feature as soon as we can.
