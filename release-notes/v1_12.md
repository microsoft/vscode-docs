...
During this milestone, we closed 2199 issue across all VS Code repositories. However, while we were busy closing issues, you were busy opening them. 1925 new issues, to be exact, and we decreased our total issue count by 274. By comparison, in March we closed 1719 issues while you opened 2221 issues, and our total issue count grew by 369. Overall, April looks pretty good. 

And in case you wonder: Out of the 3775 issues that we currently track in https://github.com/Microsoft/vscode alone, 2368 are feature requests. It seem that we won't run out of work anytime soon :-). 
