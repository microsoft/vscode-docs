...
During this milestone, we closed 2199 issue across all VS Code repositories. However, while we were busy closing issues, you were busy opening them. 1925 new issues, to be exact, and we decreased our total issue count by 274. By comparison, in March we closed 1719 issues while we gained 2221 issues, and our total issue count grew by 369. Overall, April looks pretty good.

And in case you are wondering, out of the 3775 issues that we currently track in [github.com/Microsoft/vscode](https://github.com/Microsoft/vscode/issues) alone, 2368 are feature requests. We won't run out of work anytime soon :-).
...
* **[Community source control providers](#source-control)** - SCM provider extensions for TFVC, Perforce and Mercurial.
* **[Better IntelliSense filtering](#dynamic-intellisense-sorting)** - IntelliSense items are resorted, putting top suggestions first.
...
* **[Grunt task autodection](#grunt-task-autodection)** - Use the VS Code task runner to perform Grunt tasks.
* **[Just My Code improvements](#just-my-code-improvements)** - Easily ignore files with the **Toggle skipping this file** action.
* **[Improved China download speed](#china-downloads)** - Users should see dramatically faster downloads (as much as 300x).


The release notes are arranged in the following sections related to VS Code focus areas. Here are some further updates:

* **[Workbench](#workbench)** - macOS native Tabs and swipe gestures, integrated terminal link line and column support.
...
![kimbie dark](images/1_12/theme-kimbie-dark.png)![solarized-light](images/1_12/theme-solarized-light.png)![tomorrow blue](images/1_12/theme-tomorrow-blue.png)
...
TypeScript 2.3 also brings type checking to plain old JavaScript files. This is a great way to catch common programming mistakes and these type checks also enable some exciting quick fixes for JavaScript.
...
* Open a text document as a preview editor. This means its tab will be reused when opening another document. This can be done like so: `vscode.window.showTextDocument(doc, { preview: true})`
