...
Learn more about [auto model selection in VS Code](https://code.visualstudio.com/docs/agent-customization/language-models).
...
Learn more about [customizing chat in VS Code](https://code.visualstudio.com/docs/agent-customization/overview) to your practices and team workflows.
...
<video src="images/1_104/changed-files-list.mp4" title="Video uncollapsing the changed files list and accepting file entries to remove them from the list." controls muted></video>
...
Learn more about [customizing chat in VS Code](https://code.visualstudio.com/docs/agent-customization/overview) with prompt files, chat modes, and custom instructions.
...
[Tool sets](https://code.visualstudio.com/docs/chat/copilot-chat#_define-tool-sets) are a convenient way to group related tools together and VS Code has several built-in tool sets like `edit` or `search`.
...
We've improved the integration of [GitHub coding agents](https://code.visualstudio.com/docs/agents/agent-types/cloud-agents) with chat sessions to deliver a smoother, more intuitive experience.
...
<video src="images/1_104/chat-sessions-view.mp4" title="Video showing Chat Sessions view and integration with GitHub coding agents." controls muted></video>
...
* Delegate from chat (`setting(githubPullRequests.codingAgent.uiIntegration)`):
    ...
    <video src="images/1_104/delegate-to-coding-agent.mp4" title="Delegating a task from sidebar chat to coding agent" controls muted></video>
...
Automatically approving terminal commands can greatly streamline agent interactions, but it also comes with [security risks](https://code.visualstudio.com/docs/agents/security). This release introduces several improvements to terminal auto approve to enhance both usability and security.
...
Learn more about [terminal auto approve](https://code.visualstudio.com/docs/chat/copilot-chat#_autoapprove-terminal-commands) in our documentation.
...
* Input request detection
    ...
    <video src="images/1_104/prompt-input-demo.mp4" title="Example of input being detected and responded to" controls muted></video>
...
* Compound task support
    ...
    <video src="images/1_104/build-task.mp4" title="Example of agent running the VS Code - Build task" controls muted></video>
...
VS Code supports [automatic discovery of MCP servers](https://code.visualstudio.com/docs/agent-customization/mcp-servers#_add-an-mcp-server) installed in other apps like Claude Code. As MCP support has matured in VS Code, auto-discovery is now disabled by default, but you can re-enable it using the `setting(chat.mcp.discovery.enabled)` setting.
...
<video src="images/1_104/pylance-hover-summaries.mp4" title="Video showing AI-powered hover summaries with Pylance." controls muted></video>
...
<video src="images/1_104/pylance-run-code-snippet.mp4" title="Code snippet generated and executed by GitHub Copilot in the Chat panel via the pylancerunCodeSnippet tool." controls muted></video>
