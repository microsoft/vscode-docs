...
#### Warnings for curl and similar commands
...
TODO: Tyriar
- Command https://github.com/microsoft/vscode/issues/258895
- Tab well entry https://github.com/microsoft/vscode/issues/259002
- Empty editor entry https://github.com/microsoft/vscode/issues/259417
- New terminal dropdown https://github.com/microsoft/vscode/issues/259417
- Top-level terminal menu https://github.com/microsoft/vscode/issues/259571
- Compact mode https://github.com/microsoft/vscode/issues/259601
...
TODO: Tyriar
- git/gh icons https://github.com/microsoft/vscode/issues/240232
- Performance improvements https://github.com/microsoft/vscode/issues/258512
- Remove sed dependency on git completions for Windows https://github.com/microsoft/vscode/issues/261016
- More specs https://github.com/microsoft/vscode/issues/263167

### Terminal sticky scroll improvements

We have now enabled terminal sticky scroll by default when rich shell integration is enabled. <br>
Here are some improvements:

#### Fixed prompt flashing when in pagers
Terminal sticky scroll no longer shows a brief flash of the command prompt when scrolling down through pager content (such as git diff on Windows). Previously, the sticky scroll would momentarily display the prompt for one frame during pager navigation, creating a distracting visual flicker.

#### Compatible with tab-moves-focus setting
Terminal sticky scroll now properly respects the (kb(editor.tabFocusMode)) setting, preventing focus from getting infinitely stuck within the sticky scroll area. Previously, users with tab moves focus enabled could not navigate out of the terminal sticky scroll using keyboard navigation.

### Terminal find improvements

#### Improved search result counting for multi-line matches

VS Code's terminal search now correctly counts results when search matches span across multiple lines. Previously, multi-line matches were incorrectly counted as multiple separate results instead of a single match

#### Prevent editor copy from being overriden by terminal copy-on-selection

We now prevent `(kb(terminal.integrated.copyOnSelection))` from overriding text recently copied from the editor. Previously, when terminal.integrated.copyOnSelection was enabled, selecting text in the terminal would immediately replace editor clipboard content, making it impossible to paste editor content into the terminal find.
