...
### Window border color support for Windows
...
This iteration, we finalized the `LanguageModelChatProviders` API. This enables extensions to contribute language models to VS Code and Copilot Chat.

You can learn more about how to utilize this API in our [extension guide](https://code.visualstudio.com/api/extension-guides/ai/language-model-chat-provider) or in our [extension sample](https://github.com/microsoft/vscode-extension-samples/tree/main/chat-model-provider-sample).
