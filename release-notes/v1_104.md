...
We have now enabled terminal sticky scroll by default. We have also made several improvements to provide better experience when in pager, exiting out of alt-buffer, and also have made terminal sticky scroll compatible with (kb(editor.tabFocusMode)) setting.
