...
We've improved the integration of [GitHub coding agents](https://code.visualstudio.com/docs/copilot/copilot-cloud-agent) with chat sessions to deliver a smoother, more intuitive experience.
