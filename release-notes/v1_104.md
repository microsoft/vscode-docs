...
When you have an `AGENTS.md` file in your workspace root(s), it is now automatically picked up as context for chat requests. See <https://agents.md/> for more information about `AGENTS.md` files.
