...
<table class="highlights-table">
  ...
  <tr>
    <td>Auto model selection <a href="#auto-model-selection"><br>Show more</a></td>
...
This iteration, we're introducing auto model selection in chat. When you choose the **Auto** model in the model picker, VS Code automatically selects model to ensure that you get the optimal performance and avoid rate limits. Auto model selection is available to all VS Code Insiders users and will be rolling out to users on VS Code Stable.
...
Learn more about [model selection in VS Code](https://code.visualstudio.com/docs/copilot/customization/language-models).
