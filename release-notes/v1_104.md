...
We have now enabled terminal sticky scroll by default. We have also made several improvements to provide better experience when using pager, after exiting out of the alt buffer, and also have made terminal sticky scroll compatible with `(kb(editor.tabFocusMode))` setting.
...
https://github.com/microsoft/vscode/issues/222075 - Terminal sticky scroll can show up for 1 frame when using page down in a pager
https://github.com/xtermjs/xterm.js/pull/5390 - Fix scrollbar teleport after exiting alt buffer
