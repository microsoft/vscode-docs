...
This iteration, we've finalize our terminal shell API, allowing extensions to see user's current shell type in their Terminal. 
Subscribing to event `onDidChangeTerminalState` will allow you to see the changes of user's shell type in the Terminal. 
For example, shell type could change from zsh to bash. 
List of all the shell that are identifiable are currently listed [here](https://github.com/microsoft/vscode/blob/99e3ae5586a74ab1c554b6a2a50bb9eb3a4ff7fd/src/vscode-dts/vscode.d.ts#L7740-L7750)
