...
When a new MCP server is added, a refresh action shown in chat that can be used to start the server and discover the tools. Afterwards servers are started on-demand to save resources.
...
Last iteration, Copilot Vision was enabled for `Gpt 4o`. Check out our [release notes](https://code.visualstudio.com/updates/v1_98#_copilot-vision-preview) to learn more about how you can attach and use images in Coilot Chat.
...
Check out [this API proposal issue](https://github.com/microsoft/vscode/issues/245104) to see example usage and to stay up to date with the status of this API.
