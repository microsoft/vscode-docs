...
We're happy to announce that agent mode is coming to VS Code Stable! We're gradually rolling it out to all users, so you might not see it right away. If you already want to try out this agentic coding flow, download [VS Code Insiders](https://code.visualstudio.com/insiders/).
...
### Announcing agent mode general availability
