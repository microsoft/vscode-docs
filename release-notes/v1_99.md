...
Notebook support in Copilot Edits (including _agent_ mode) is now available in the stable release. This was a added last month as a preview feature in [VS Code Insiders](https://code.visualstudio.com/insiders).
