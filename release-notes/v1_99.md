...
Subscribing to event `onDidChangeTerminalState`, will allow you to see the changes of user's shell type in the Terminal. For example, shell type could change from zsh to bash. 
