...
* **Agentic coding flow**
  * Copilot agent mode is available in VS Code Stable. Enable it by setting `setting(chat.agent.enabled:true)` ([Read more...](#agent-mode-is-available-in-vs-code-stable)).
  * Extend agent mode with Model Context Protocol (MCP) server tools ([Read more...](#model-context-protocol-server-support)).
  * Adding new built-in tools to agent mode for thinking, fetching web content, and finding symbol usages ([Read more...](#agent-mode-tools)).

* **Code editing**
  * Announcing Next Edit Suggestions general availability ([Read more...](#next-edit-suggestions-general-availability)).
  * Removed unnecessary distractions while applying edits in the editor to keep you focused ([Read more...](#ai-edits-improvements)).

* **Chat**
  * Add more language models to chat with support for bringing your own key (preview) ([Read more...](#bring-your-own-key-byok-preview)).
  * Bringing ask, edit, and agent mode together in a unified chat experience, allowing easy context switching ([Read more...](#unified-chat-experience)).
  * Improved workspace search speed and accuracy with instant remote workspace indexing for GitHub repositories ([Read more...](#faster-workspace-searches-with-instant-indexing)).

* **AI-enhanced notebook editing**
  * Create and edit notebooks as easily as code files with support for edit and agent mode ([Read more...](#ai-notebook-editing-improvements)).
