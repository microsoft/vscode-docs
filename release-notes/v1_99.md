...
We now display specific file type icons in the terminal suggest widget.
...
#### Details provided for inline suggestion

Last iteration, we added support for inline suggestions—displayed as ghost text in the terminal to appear at the top of the suggestions list. We've added command details to this item this iteration.
