...
* **[Terminals in the editor](#terminals-in-the-editor-area)** - Now open terminals in the editor group.
...
There are now new settings to customize the editor's scroll bars:
