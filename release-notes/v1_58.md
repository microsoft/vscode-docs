...
Date: 2021-7-8
DownloadVersion: 1.58.1
---
# June 2021 (version 1.58)

**Update 1.58.1**: The update addresses these security [issues](https://github.com/microsoft/vscode/milestone/160?closed=1).
...
* **['Open in VS Code' badge](#open-in-vs-code-badge)** - Lets visitors quickly open your GitHub repo in VS Code.
...
If you maintain an open source project on GitHub, you can now add a badge to your repo so visitors can quickly open your code in VS Code, either using the [Remote Repositories extension](https://code.visualstudio.com/blogs/2021/06/10/remote-repositories) that we launched last month, or [cloning in a Dev Container](https://code.visualstudio.com/docs/remote/containers).

![Screenshot of the microsoft/vscode repo on GitHub with the added "Open in VS Code" badge in the README](images/1_58/open-in-vscode.png)

Clicking on the badge will bring you to a page on [open.vscode.dev](https://open.vscode.dev), where you can choose how to continue in VS Code; see this page for an [example for the microsoft/vscode](https://open.vscode.dev/microsoft/vscode) repo.
