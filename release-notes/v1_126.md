...
The context size and reasoning (thinking) effort controls are now combined into a single model customization picker. From one place, you can adjust both settings when tuning a model, instead of working with two separate dropdowns.
...
The Workspace Trust editor previously showed a **Trust Parent** button next to the **Trust** button. Because it was styled identically to **Trust** but trusted the entire parent folder, it was easy to select unintentionally and trust far more folders than you intended.
