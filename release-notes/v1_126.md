...
Previously, agent sessions ran in the extension host, whose lifecycle is tied to a single window, which made it difficult to share the same session across multiple windows.
