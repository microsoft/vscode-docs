...
The terminal tool has a new auto approve option to allow all future commands for the session:

![Allow All Commands in this Session is now an auto approve option for the terminal tool](images/1_107/terminal-allow-all.png)
