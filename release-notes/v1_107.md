...
Learn more about [using subagents in chat](https://code.visualstudio.com/docs/agents/subagents#_what-you-see-in-chat).
...
Learn more about [URL and domain approval](https://code.visualstudio.com/docs/agents/approvals#_url-approval) in VS Code chat.
...
Learn more about [using terminal commands with agents](https://code.visualstudio.com/docs/agents/tools#_run-terminal-commands).
