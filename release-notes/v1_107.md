...
**Update 1.107.1**: The update improves the [agent sessions experience](#integrating-agent-sessions-and-chat), adds an [agent workflow tutorial](https://code.visualstudio.com/docs/agents/agents-handoff-tutorial), and addresses these [issues](https://github.com/microsoft/vscode/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%22November+2025+Recovery+1%22+). The key highlights include:
