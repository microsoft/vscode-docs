...
**Update 1.107.1**: The update improves the [agent sessions experience](#integrating-agent-sessions-and-chat), adds [agent workflow guidance](https://code.visualstudio.com/docs/agents/run/agent-harnesses), and addresses these [issues](https://github.com/microsoft/vscode/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%22November+2025+Recovery+1%22+). The key highlights include:
...
**Update 1.107.1**: This update significantly improves the side-by-side sessions experience. Hiding the sessions with the toggle now remembers your choice, allowing you to resize the Chat view at will. Learn how to [choose and use an agent harness](https://code.visualstudio.com/docs/agents/run/agent-harnesses).
...
Learn more about [using subagents in chat](https://code.visualstudio.com/docs/agents/run/subagents#_what-you-see-in-chat).
...
Learn more about [URL and domain approval](https://code.visualstudio.com/docs/agents/run/approvals#_url-approval) in VS Code chat.
...
Learn more about [using terminal commands with agents](https://code.visualstudio.com/docs/agents/run/tools#_run-terminal-commands).
...
Learn more about editing [sensitive files in chat](https://code.visualstudio.com/docs/agents/run/review-code-edits#_edit-sensitive-files).
