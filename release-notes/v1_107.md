...
Additionally, we'll roll out the Stable November build over a 24 hour time window. Just like Insiders, you can always run `Check for Updates...` to force the update to be applied.
