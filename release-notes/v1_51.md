...
The [Coding Pack for Python](https://aka.ms/coding-pack-for-python-win) installs Python 3.8, specific Python libraries, VS Code, and essential extensions like Python and LiveShare, making it easy for new coders to get started. It is currently available for Windows.
