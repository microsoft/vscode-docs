...
This addresses a **[feature request](https://github.com/microsoft/vscode/issues/26952)** to navigate SCM commit history. Press the `UpArrow` and `DownArrow` to display the prior and next commits, respectively. To move directly to the first and last position of the input box, press `alt` in conjunction with the corresponding arrow key.
