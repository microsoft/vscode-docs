...
<video src="images/1_51/custom-tree-hover.mp4" title="Video showing Custom tree hover." autoplay loop controls muted></video>
...
<video src="images/1_51/local-echo.mp4" title="Video showing Gif showing typing with 250ms latency where characters entered immediately are dimmed." autoplay loop controls muted></video>
...
<video src="images/1_51/suggest-drag.mp4" title="Video showing Resizable Suggestions control." autoplay loop controls muted></video>
...
<video src="images/1_51/suggest-left.mp4" title="Video showing Moving cursor while suggestions are showing." autoplay loop controls muted></video>
...
<video src="images/1_51/emmet-custom-snippets.mp4" title="Video showing Emmet custom snippets working again." autoplay loop controls muted></video>
...
<video src="images/1_51/scm-commit-history-demo.mp4" title="Video showing After typing a message in the SCM input box, then staging and committing changes, pressing the up arrow reveals the message that was just committed." autoplay loop controls muted></video>
...
<video src="images/1_51/markdown-smart-select-demo.mp4" title="Video showing Smart select within a Markdown document expands from a block element, to the block element containing it, to the rest of the content under a header, to the header itself." autoplay loop controls muted></video>
...
<video src="images/1_51/download-folder.mp4" title="Video showing Download folder." autoplay loop controls muted></video>
...
<video src="images/1_51/webview-styles.mp4" title="Video showing Webview style samples." autoplay loop controls muted></video>
