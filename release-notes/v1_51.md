...
The [Coding Pack for Python](https://aka.ms/coding-pack-for-python-win) installs Python, specific Python libraries, VS Code, and essential extensions like Python and LiveShare making it easy for new coders to get started. It is currently available for Windows.

![Coding Pack for Python](images/1_51/coding-pack-python.png)
