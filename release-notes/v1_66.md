...
<video src="images/1_66/local-history.mp4" controls muted title="Local history showing file saves, a rename, and undo entries"></video>
...
<video src="images/1_66/settings-editor-lang-css-settings.mp4" controls muted title="Modification of a boolean CSS language-specific setting to turn off CodeLens in the Diff editor"></video>
...
<video src="images/1_66/settings-editor-workspace-override.mp4" controls muted title="The editor tab size being set and reset via the Settings editor Workspace tab item"></video>
...
<video src="images/1_66/comment-plus.mp4" controls muted title="Line hover showing comment plus button"></video>
...
<video src="images/1_66/command-navigation.mp4" controls muted title="A rectangle is briefly displayed around the command being navigated to"></video>
...
<video src="images/1_66/inline-quick-suggest.mp4" controls muted title="Inline completions show and update as you type"></video>
...
<video src="images/1_66/scm.mp4" controls muted title="Example of the modified decorator for source control"></video>
...
<video src="images/1_66/web-dnd.mp4" controls muted title="Drop folder into vscode.dev"></video>
...
<video src="images/1_66/notebook-find-scrollbar.mp4" controls muted title="Find decorations rendered in the scroll bar"></video>
...
<video src="images/1_66/markdown-ref-link.mp4" controls muted title="Clicking a shorthand link in a Markdown file"></video>
...
<video src="images/1_66/proposal-drop-into-editor.mp4" controls muted title="Creating a link in a Markdown file using the proposed drop into editor API"></video>
