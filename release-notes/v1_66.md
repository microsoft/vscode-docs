...
* For GitHub we've removed the initial "Continue" page so your log in experience requires one less click.
* For Microsoft, we try to minimize the amount of times we take you out of VS Code to log in if you've already logged in with Microsoft for Settings Sync or an another extention.
