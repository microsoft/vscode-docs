...
### New color themes kind: High Contrast Light
...
When such a theme is used, [`ColorTheme.kind`](https://code.visualstudio.com/api/references/vscode-api#ColorTheme) will have value `HighContrastLight`.
