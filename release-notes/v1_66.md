...
The workbench now supports rendering with reduced animations when the OS reduced motion setting is enabled. This can be overriden or disabled with the `workbench.reduceMotion` setting.
