...
### Improved Windows background update stability

We've done some stability work on our custom Windows background updater in order to address some issues which resulted in broken installation folders for a subset of our users. This is a continuous work item and there'll be more improvements in the upcoming releases.
...
We've improved our homegrown IPC stack to [support byte buffer messages](https://github.com/Microsoft/vscode/pull/56820) between processes. This enables certain scenarios such as sending binary data between our different processes without overhead as well allowing us to optimize IPC for performance.
