...
We have tweaked the new breadcrumb bar, made various improvements, and fixed bugs:

* Focused document symbols are now being highlighted in the editor
* Breadcrumbs now turn on when disabled but when the focus command is run
