...
* **[Settings editor](#settings-editor)** - New Settings editor to discover, search and modify VS Code settings.
* **[Custom menu bar](#custom-title-bar-and-menus-on-windows-and-linux)** - Fully themable title and menu bars on Windows and Linux.
* **[Breadcrumbs improvements](#breadcrumbs-improvements)** - Highlight symbols in the editor when using breadcrumbs.
* **[New Terminal menu](#new-terminal-menu)** - New menu for creating new terminals and managing tasks.
...
* **[JSON conditional evaluation](#json)** - Support for 'if', 'then', and 'else' keywords.
* **[Loaded Scripts view](#loaded-scripts-view-now-built-in)** - Now built-in and available for debug extensions.
...
### Jump to Definition for CSS, SCSS and Less links

Jump-to-definition support is now available for `@import` and `url()` links in CSS, SCSS and Less.
