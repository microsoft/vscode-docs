...
We are introducing the concept of comments this iteration, which allow extensions to create and manage conversations within editors and a new `Comments` panel. This enables extensions to tackle code review scenarios.
