...
# Update stopped temporarily

As we are looking into an issue that impacts Windows users with non-ascii characters in their user name not being able to start VS Code anymore (https://github.com/Microsoft/vscode/issues/57982) we have stopped the update temporarily. We are working on a fix and will have an update out soon! If you are impacted by this issue you can download our [Insiders](https://code.visualstudio.com/insiders) version which includes a fix.
