...
Since diagnostic codes are now surfaced in [Problems Panel](#problems-panel:-code), it is no longer necessary for the extensions to add them to the [`Diagnostic.message`](https://github.com/Microsoft/vscode/blob/master/src/vs/vscode.d.ts#L4074) property.
