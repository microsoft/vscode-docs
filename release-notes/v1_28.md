...
## Fonts on macOS Mojave are looking blurry
...
```
from the terminal followed by a restart to get back the previous behaviour. Note that this change is global for every application and not specific to VSCode. See [issue 51132](https://github.com/Microsoft/vscode/issues/51132) for the related discussion.
