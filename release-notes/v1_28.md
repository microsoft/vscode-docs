...
It was great to see how much you care about our progress. [Benjamin Lannon](https://github.com/lannonbr) published a personal site with a [live tracker](https://vscode-issue-tracker.netlify.com/) of our issue numbers in our [main repository](https://github.com/Microsoft/vscode/issues). It shows nicely the progress we made since September 11:
...
As a side effect of the grooming we have addressed several feature requests and the Pull Requests also resulted in  new features described below.
...
We further improved the CPU consumption of the output panel when it is not visible.
...
### Define keybindings to send custom sequenes
...
### HTML & CSS path completion excludes dot files
...
Note that this change is global for every application and not specific to VS Code. See [issue 51132](https://github.com/Microsoft/vscode/issues/51132) for the related discussion.## Extension Authoring
