...
<video src="images/1_67/se-filter-button.mp4" controls muted title="Selecting the Settings editor filter button and then applying a language filter from the dropdown"></video>
...
<video src="images/1_67/editor-placeholder.mp4" controls muted title="Editor placeholder with the option to create a missing file"></video>
...
<video src="images/1_67/languageStatus.mp4" controls muted title="Animated language status with an error item for formatter conflicts"></video>
...
<video src="images/1_67/language-detection.mp4" controls muted title="demonstrating detecting various languages in a notebook"></video>
...
<video src="images/1_67/confirm-quit.mp4" controls muted title="Confirmation dialog shown after using a keyboard shortcut to start closing VS Code"></video>
...
<video src="images/1_67/multiline-comments.mp4" controls muted title="Selecting multiple lines and leaving a comment"></video>
...
<video src="images/1_67/inlineSuggest.mp4" controls muted title="Trigger characters and ghost text"></video>
...
<video src="images/1_67/editor-drop.mp4" controls muted title="Dragging and dropping an emoji into VS Code"></video>
...
<video src="images/1_67/scm-repositories-view-sort.mp4" controls muted title="Sort repositories in the Source Control Repositories view"></video>
...
<video src="images/1_67/editor-diff-decorators.mp4" controls muted title="Toggle editor decorator settings for added/modified lines"></video>
...
<video src="images/1_67/disable-breakpoints.mp4" controls muted title="Shift clicking on breakpoints to disable and re-enable them"></video>
...
<video src="images/1_67/md-drop-link.mp4" controls muted title="Inserting links into Markdown by dragging and dropping from the Explorer"></video>
...
<video src="images/1_67/md-drop-external.mp4" controls muted title="Dropping a image from a web browser into VS Code to add a Markdown image"></video>
...
<video src="images/1_67/md-file-references.mp4" controls muted title="Finding all references to a Markdown file"></video>
...
<video src="images/1_67/md-rename-header.mp4" controls muted title="Renaming a Markdown header using F2"></video>
...
<video src="images/1_67/java-inlay-hints.mp4" controls muted title="Java file with parameter name inlay hints displayed for literal arguments, displayed for all arguments, and disabled"></video>
...
<video src="images/1_67/java-lazy-variable.mp4" controls muted title="Debugger for Java supporting lazy variable resolution during a debugging session"></video>
...
<video src="images/1_67/export-settings-profile.mp4" controls muted title="Export Settings Profile"></video>
...
<video src="images/1_67/import-settings-profile.mp4" controls muted title="Import Settings Profile"></video>
...
<video src="images/1_67/api-drop.mp4" controls muted title="Using the drop extension sample to create a list of dropped files names"></video>
