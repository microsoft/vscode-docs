...
Please try out the new [isort extension](https://marketplace.visualstudio.com/items?itemName=ms-python.isort), which provides import organization using the [isort](https://pypi.org/project/isort/) library. Pre-release version of the extension is available to install.
