...
* Jump directly to a JavaScript implementation of a library function using the new **Go to Source Definition** command. You can learn more about this feature and share feedback [here](https://github.com/microsoft/TypeScript/issues/49003).
