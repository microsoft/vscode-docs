...
Welcome to the 1.129 release of Visual Studio Code. This release includes updates to the agent host, chat, editor experience, authentication, and proposed APIs.

* [Agents](#agents): Work with agent host sessions across windows and manage session hand-offs.
* [Chat](#chat): Run terminal commands with the `!` prefix and migrate prompt files to skills.
* [Editor experience](#editor-experience): Reopen files with alternate editors from the editor toolbar.
* [Authentication](#authentication): Sign in to Copilot with GitHub Enterprise in the agent host.
...
Prompt files (*.prompt.md) are only supported in the Local agent harness but not in other agents like Copilot or Claude. For users who have authored prompt files, we offer a way to create skills for these prompts.
