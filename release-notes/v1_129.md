...
The Copilot agent harness now supports prompt files (*.prompt.md) from the Local agent harness. For users that have authored prompt files, we offer a way to create skills for these prompts.
...
* Migrate selected files to skills and takes you to the newly created skills.
