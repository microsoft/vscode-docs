...
Learn more about [Autopilot and agent permissions](https://code.visualstudio.com/docs/agents/run/approvals#_permission-levels) in our documentation.
...
To try this feature, enable the `setting(chat.useCustomAgentHooks)` setting. For more information, see [Agent-scoped hooks](https://code.visualstudio.com/docs/agent-customization/hooks#_agentscoped-hooks) in our documentation.
...
Learn more about [Debugging chat interactions](https://code.visualstudio.com/docs/agents/agent-troubleshooting/chat-debug-view) in our documentation.
