...
Learn more about [forking a chat session](https://code.visualstudio.com/docs/agents/sessions/manage-sessions#_fork-a-chat-session) in the documentation.
...
Learn more about [using subagents](https://code.visualstudio.com/docs/agents/subagents) in the documentation.
