...
Learn more about [using MCP servers in VS Code](https://code.visualstudio.com/docs/agent-customization/mcp-servers).
...
Learn more about [forking a chat session](https://code.visualstudio.com/docs/agents/run/sessions/manage-sessions#_fork-a-chat-session) in the documentation.
...
Learn more about the [Agent Debug Log panel](https://code.visualstudio.com/docs/agents/agent-troubleshooting/chat-debug-view#_agent-debug-log-panel) in our documentation.
...
Learn more about [using subagents](https://code.visualstudio.com/docs/agents/run/subagents) in the documentation.
...
Learn more about [using agent plugins](https://code.visualstudio.com/docs/agent-customization/agent-plugins) in the documentation.
...
Learn more about the [Chat Customizations editor](https://code.visualstudio.com/docs/agent-customization/overview#_chat-customizations-editor) in the documentation.
...
Learn more about [thinking effort and reasoning](https://code.visualstudio.com/docs/agents/concepts/language-models#_thinking-and-reasoning) in the documentation.
