...
![octicons-update](images/1_31/octicons-updates.png)
...
* [Donald Pipowitch (@donaldpipowitch)](https://github.com/donaldpipowitch): `NOT MERGED - PLS REVIEW` add .vscodeignore syntax highlighting [PR #64960](https://github.com/Microsoft/vscode/pull/64960)
...
* [Guy Waldman (@guywald1)](https://github.com/guywald1)
  * `NOT MERGED - PLS REVIEW` Fix #58731 & add test & preserve input for "create new branch" [PR #58963](https://github.com/Microsoft/vscode/pull/58963)
  * [git] Add command to create branch from specific ref [PR #59078](https://github.com/Microsoft/vscode/pull/59078)
...
* [Segev Finer (@segevfiner)](https://github.com/segevfiner)
  * `NOT MERGED - PLS REVIEW` Fix the condition used to determine if we should shift focus while debugging [PR #66874](https://github.com/Microsoft/vscode/pull/66874)
