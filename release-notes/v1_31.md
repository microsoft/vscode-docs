...
With this release, we bring you hot reload when you install extensions in VS Code, this is one of the most upvoted feature requests. You are no longer required to reload (restart) VS Code when you install or enable an extension. For example, you can do following without reloading the window:

* Install your favorite theme and set it.

![Extensions hot reload](images/1_31/hot-reload-theme.gif)

* Install the necessary language features for fixing a particular bug.
* Install a Debugger and test the fix.

![Extensions hot reload](images/1_31/hot-reload-languages-debugger.gif)

* Create a Pull Request with your fix.

![Extensions hot reload](images/1_31/hot-reload-pr.gif)
...
When developping a theme extension, you can see the colors applied live to the `Extension Development Host` window.
