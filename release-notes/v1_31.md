...
With this release, we bring you hot reload when you install extensions in VS Code, this is on of the most upvoted feature requests. You are no longer required to reload (restart) VS Code when you install or enable an extension. For example, you can do following without reloading the window:
