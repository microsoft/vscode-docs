...
Welcome views are a new addition to the workbench which gives capabilities to any view to create experiences for driving users to create content or configure VS Code, whenever they don't have any meaningful content to display. Some views have already adopted this infrastructure, e.g. the File Explorer.
...
### Allow moving debug viewlet items to the panel
TODO@isidorn
