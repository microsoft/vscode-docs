...
* The auto completion widget now shows documentation for the suggested symbols. Press `kb(editor.action.triggerSuggest)` to *xpand/collapse the docs part of the auto-completion widget.
