...
* **[CI recipe for extensions](#using-azure-pipelines-for-extension-ci)** - Azure pipeline build recipe for extensions.
* **[Preview of List All References](#references-view)** - List All References view shows reference search results.
...
Let us know what you think and we'll refine the experience in our next update.
