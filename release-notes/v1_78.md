...
<video src="images/1_78/terminal-accessibility-help.mp4" placeholder="images/1_78/terminal-accessibility-help.mp4" controls muted title="the terminal accessibility help menu is entered and a user navigates it line by line with arrow keys">
...
<video src="images/1_78/drop-widget.mp4" controls muted title="Changing how an image is dropped using the drop selector widget"></video>
...
<video src="images/1_78/scm-quick-fix.mp4" controls muted title="Fixing a spelling error in the Source Control quick input"></video>
...
<video src="images/1_78/notebook-toggle-scrolling.mp4" controls muted title="Toggle notebook cell scrolling"></video>
...
<video src="images/1_78/notebook-find-replace.mp4" controls muted title="Notebook Find and Replace improvements"></video>
...
<video src="images/1_78/md-video-insert.mp4" controls muted title="Inserting a video using drag and drop"></video>
...
<video src="images/1_78/pylance-fstring-conversion.mp4" controls muted title="Python string automatically converted to an f-string when typing {}."></video>
...
<video src="images/1_78/pylance-string-navigation.mp4" controls muted title="Opening Python files through go to definition (F12) on path-link strings."></video>
...
<video src="images/1_78/chat-code-actions.mp4" controls muted  title="Code Actions and Inline Chat"></video>
...
<video src="images/1_78/ts-rename-jsx.mp4" controls muted title="Renaming a JSX tag using F2"></video>
