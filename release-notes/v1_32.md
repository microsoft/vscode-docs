...
* The pattern is only matched in the Debug Console. It doesn't work yet if the debug target is launched in the Integrated Terminal (and it will never work in external terminals).
