...
- VS Code now shows the set of extensions included in an extension using `extensionPack` property in a separate tab in the extension editor when the extension is not categorized as **Extension Packs**.
