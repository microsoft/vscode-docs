...
* **[Improvements to breakpoints](#improvements-to-breakpoints)** - Inline menu and support for all access types of data breakpoints.
* **[Keyboard shortcuts uses table widget](#resizing-columns-in-keyboard-shortcuts-editor)** - Resize columns in the keyboard shortcuts editor.
