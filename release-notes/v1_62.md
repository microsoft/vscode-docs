...
We made https://vscode.dev available which is a lightweight version of VS Code running fully in the browser. You can open a folder on your local machine and start coding. No install is required. Please read the [blog post](https://code.visualstudio.com/blogs/2021/10/20/vscode-dev) for more details.
