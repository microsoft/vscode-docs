...
If you are an extension author, more details about how to become a verified publisher can be found in [this document](/api/working-with-extensions/publishing-extension.md#Verify-a-publisher).
