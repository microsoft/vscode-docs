...
If you are an extension author, you can contact the [VS Code Marketplace](https://marketplace.visualstudio.com) to have your domain verified.
...
The new **Emmet: Update Tag** command (`editor.emmet.action.updateTag`) updates the placeholder with the tag to be updated.
