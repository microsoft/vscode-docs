...
The list of kernels displayed in the kernel picker is now grouped to make it easier for one to identify and find kernels belonging to a specific Python envoironment.
