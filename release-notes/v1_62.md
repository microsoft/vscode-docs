...
After focusing on housekeeping, we have also addressed several feature requests and community [pull requests](#pull-requests). This resulted in many new features and settings, some of the key highlights include.
