...
<video src="images/1_95/copilot-edits-hero.mp4" title="Use Copilot Edits to modify an Express app." controls muted></video>
...
Get more details about [Copilot Edits](https://code.visualstudio.com/docs/chat/copilot-chat) in our documentation. Try it out now and provide your feedback through [our issues](https://github.com/microsoft/vscode/issues)!
...
<video src="images/1_95/chat-video.mp4" title="Chat in Secondary Side Bar." controls muted></video>
...
<video src="images/1_95/copilot-symbol-links-overview.mp4" title="Symbols links being rendered in a Copilot response. Clicking on then navigates to the symbol definition." controls muted></video>
...
<video src="images/1_95/settings-editor-preview-search.mp4" title="Searching for preview settings in Settings editor" controls muted></video>
...
This milestone, the team worked on building several extensions that showcase [Copilot extensibility in VS Code](https://code.visualstudio.com/api/extension-guides/ai/ai-extensibility-overview). These extensions demonstrate the following capabilities:
...
<video src="images/1_95/fix-summarize-issue.mp4" title="Summarize and Fix GitHub issue" controls muted></video>
...
<video src="images/1_95/iterate-on-sequence-diagram.mp4" title="Create a sequence diagram then iterate to remove a participant" controls muted></video>
...
<video src="images/1_95/diagram-with-links-short.mp4" title="Generate a diagram then click a link back to a referenced piece of code" controls muted></video>
...
<video src="images/1_95/mermaid-outline-view-iterate.mp4" title="Uses the mermaid visual outline view to generate a diagram and then iterate on it with chat" controls muted></video>
...
<video src="images/1_95/data-analysis-chat-participant.mp4" title="Analyzing CSV file using data analysis chat participant in Copilot." controls muted></video>
...
<video src="images/1_95/data-analysis-export-chat-participant.mp4" title="Exporting code used to perform data analysis and generate visualizations." controls muted></video>
...
<video src="images/1_95/data-analysis-csv-chat-participant.mp4" title="Exporting code used to perform data analysis and generate visualizations." controls muted></video>
...
<video src="images/1_95/vscode-commander-demo.mp4" title="Showing off VS Code Commander capabilities in the copilot chat view" controls muted></video>
...
<video src="images/1_95/python-variable-view.mp4" title="Opening the variable view within the debug panel after executing code in the native REPL" controls muted></video>
...
<video src="images/1_95/pylance-generate-docstring.mp4" title="Generating docstring templates for a function with Pylance by invoking Ctrl+Space inside a pair of triple quotes." controls muted></video>
...
<video src="images/1_95/pylance-fold-docstrings.mp4" title="Folding and unfolding docstrings with Pylance's new commands." controls muted></video>
...
<video src="images/1_95/pylance-ai-code-action.mp4" title="Implementing methods from an inherited abstract class with code action from Pylance and Copilot." controls muted></video>
...
<video src="images/1_95/jsts-update-imports-paste.mp4" title="Title" controls muted></video>
