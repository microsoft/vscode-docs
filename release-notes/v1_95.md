...
The new default location for the Chat view is the [secondary sidebar](https://aka.ms/vscode-secondary-sidebar) for a more integrated AI experience in VS Code:
