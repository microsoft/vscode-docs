...
The extension contributes a tools to gather symbol information within files or the entire workspace and can be consumed by other chat participants when the extension is installed
