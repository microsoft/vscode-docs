...
Last month, we introduced the [Account Preference Quick Pick](./v1_94#change-an-extensions-account-preference), which is useful for changing the preferred account to use for an extension should you need to change that for any reason.
