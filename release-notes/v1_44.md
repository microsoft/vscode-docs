...
The rule above colors all readonly variables in a Java file red.
...
New versions of the LSP client (6.2.0-next.2) and server (6.2.0-next.2) libraries have been published. They contain proposed support for links in diagnostics and insert / replace editor support for completion items.
