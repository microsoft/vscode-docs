...
* [Dhairya Nadapara (@dhairyanadapara)](https://github.com/dhairyanadapara): `NOT MERGED - PLS REVIEW` added note in api docs for registerTextEditorCommand [PR #91823](https://github.com/microsoft/vscode/pull/91823)
...
* [Ye Zhihao (@Vigilans)](https://github.com/Vigilans): `NOT MERGED - PLS REVIEW` Action commands to open settings/keybindings editor support query as argument [PR #87813](https://github.com/microsoft/vscode/pull/87813)
