...
![Screenshot showing the dropdown options for adding a new model in the Language Models editor, with the new Custom Endpoint option.](images/1_121/custom-endpoint-provider.png)
...
![Screenshot showing the Custom Endpoint model configuration form with an API type dropdown.](images/1_121/custom-endpoint-provider-api-types.png)
