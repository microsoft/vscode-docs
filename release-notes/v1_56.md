...
<video src="images/1_56/actions.mp4" title="Video showing Actions hover feedback is improved with a background color." autoplay loop controls muted></video>
...
<video src="images/1_56/conflicting-defaults.mp4" title="Video showing A image editor is opened and the user is prompted with a notification to configure their default editor or keep the current one." autoplay loop controls muted></video>
...
<video src="images/1_56/python-flow.mp4" title="Video showing VS Code prompts to install the Python extension if it is missing." autoplay loop controls muted></video>
...
<video src="images/1_56/debug-column.mp4" title="Video showing An code execution is stopped and a column indicator is rendered in the middle of a line." autoplay loop controls muted></video>
...
<video src="images/1_56/notebook-toggle-line-numbers.mp4" title="Video showing Toggle line number of a cell." autoplay loop controls muted></video>
...
<video src="images/1_56/getting-started-markdown.mp4" title="Video showing Stepping through the Luna Paint extension's walkthrough contribution." autoplay loop controls muted></video>
...
<video src="images/1_56/custom-hover.mp4" title="Video showing Custom hover in Activity Bar and Panel." autoplay loop controls muted></video>
...
<video src="images/1_56/remote-repositories.mp4" title="Video showing Remote Repositories Demo showing various source control operations." autoplay loop controls muted></video>
