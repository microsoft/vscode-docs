...
Welcome to the April 2021 release of Visual Studio Code. The VS Code team has been busy this month working on several longer lead time updates so check out the [Preview features](#preview-features) section to learn what's coming soon. Here are some of the highlights included in this release:
...
* **[Notebook LaTeX support](#math-support-in-markdown-cells)** - Math support in Notebook Markdown cells.
* **[Remote - Containers Volume view](#remote-development)** - Inspect and manage mounted volumes within Docker containers.
...
**Join us live** at the [VS Code team's livestream](https://code.visualstudio.com/livestream) on Tuesday, May 11 8 at 8am Pacific (4pm London) to see a demo of what's new in this release, and ask us questions live.
...
VS Code uses [KaTeX](https://katex.org) for rendering the equations. There are two ways to embed a math equation into Markdown:
...
Other extensions do the same. They serve content from ftp-servers, from cloud storage or from databases and seamlessly provide these as files to the user in VS Code.
