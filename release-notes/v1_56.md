...
Once you enter a URL or choose a repository or pull request, VS Code will open a new workspace for that repository. You can tell that you are in a remote repository via the remote provider name, for example "GitHub", in the remote status indicator on the left side of the Status bar.
...
* Limited extension support — as with language servers, many extensions don't work with remote repositories. We expect this to change as extensions adapt to the virtual environment.
