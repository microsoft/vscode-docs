...
### Experimental custom hover support in Activity bar and Panel
...
* Focus terminal tabs view - `kb(workbench.action.terminal.focusTabs)` (preview feature)
...
![Smart quotes and text replacement in the markdown preview](images/1_56/markdown-typographer)

`markdown.preview.typographer` is disabled by default.
