...
<video src="images/1_65/history-group-aware.mp4" controls muted title="Editor history keeps track of appropriate editor group"></video>
...
<video src="images/1_65/history-notebooks.mp4" controls muted title="Navigation across notebook cells"></video>
...
<video src="images/1_65/dnd-problems.mp4" controls muted title="Drag and Drop problem result into the editor"></video>
...
<video src="images/1_65/settings-editor-split-view.mp4" controls muted title="Settings editor adjustable split view"></video>
...
<video src="images/1_65/lang-detect.mp4" controls muted title="Using automatic language detection for several programming languages"></video>
...
<video src="./images/1_65/surround-with-snippet.mp4" controls muted title="Running the Surround With Snippet command, accepting the try/catch snippet"></video>
...
<video src="images/1_65/lazy-vars.mp4" controls muted title="Expanding lazy variables in the debugger"></video>
...
<video src="images/1_65/notebook-search-in-text-output.mp4" controls muted title="Search keyword 'item' in code cell then also in cell output"></video>
...
<video src="images/1_65/sticky-scroll.mp4" controls muted title="Notebook cell button and toolbar remain visible during scrolling"></video>
...
<video src="images/1_65/web-local-recent.mp4" controls muted title="Open recent folders in VS Code for the Web"></video>
...
<video src="images/1_65/remotehub-merge-conflicts.mp4" controls muted title="Merge conflict decorations and selecting Accept Current Change"></video>

There is also a **Stage Changes** action in the Source Control view for files containing merge conflicts.

<video src="images/1_65/remotehub-stage-conflicts.mp4" controls muted title="Staging merge conflicts"></video>
...
<video src="images/1_65/remotehub-stage-folder.mp4" controls muted title="Stage all changes under a folder after setting View as Tree"></video>
...
<video src="images/1_65/status-bar-focus-borders.mp4" controls muted title="Animation showing Status bar focus borders as the user tabs thought Status bar items"></video>
...
<video src="images/1_65/lazy-before.mp4" controls muted title="Reviewing property getter values without lazy evaluation"></video>
...
<video src="images/1_65/lazy-after.mp4" controls muted title="Reviewing property getter values with lazy evaluation triggered by '(...)' button"></video>
