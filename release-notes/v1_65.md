...
### Drag and Drop Problems and Search results into Editor
...
![Drag and Drop Problems](./images/1_65/dnd-problems.gif)

### Improved Language Feature Extension Recommendations

Language feature extension recommendations now take into consideration other prominent language feature extensions in the Marketplace while recommending. For example, VS Code does not recommend [Java Extension Pack](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack) if you have [Apache NetBeans Java](https://marketplace.visualstudio.com/items?itemName=ASF.apache-netbeans-java) extension installed.
...
We also provide a 'Stage Changes' action in the Source Control view for files containing merge conflicts.
