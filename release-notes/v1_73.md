...
* **[VS Code for the Web branch protection](#improved-branch-creation-and-protection-workflows)** - Easily create new branch when committing to protected branch.
* **[Command Center Home](#command-center-home)** - Shows helpful actions before Go to File list.
* **[New Python extensions](#python)** - New standalone extensions for isort, Pylint, and Flake8.
* **[Jupyter "Just My Code" debugging](#jupyter)** - Avoid stepping into library code when notebook cell debugging.
...
* Terminal Quick Fix - indicates that a Quick Fix is available on the current line of the Terminal (`audioCues.terminalQuickFix`).
...
A "home" view was added to the Command Center to make it easy to discover how to navigate to files, run commands, and more. Enable it via the **Window: Command Center** (`window.commandCenter`) setting.
...
* Dev Container [Templates](https://github.com/devcontainers/templates) - Quickly create a Dev Container based on an existing template.
* Dev Container [Features](https://github.com/devcontainers/features) - Add new capabilities to a Dev Container by including prepackaged features.
...
* [@jakebailey (Jake Bailey)](https://github.com/jakebailey)
  ...
  * Remove forgoten reference to typescript/lib/protocol [PR #163585](https://github.com/microsoft/vscode/pull/163585)
