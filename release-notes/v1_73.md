...
* Webviews can use local storage and other web apis that are partitioned per origin.
    ...
    In many cases, you should use the [webview state apis](https://code.visualstudio.com/api/extension-guides/webview#getstate-and-setstate) as these api handle both of the above problems for you.
