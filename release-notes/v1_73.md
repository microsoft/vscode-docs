...
A "home" view was added to the Command Center to make it easy to discover how to navigate to files, run commands, and more. Enable the Command Center UI in the title bar via the **Window: Command Center** (`window.commandCenter`) setting.
