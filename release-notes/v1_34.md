...
Before this release code lens locations weren't cached when switching between editors lines would wiggle a little. Those day are now over. The editor now optimistically caches code lens locations and restores them immediatly after opening a file.
