...
### Improved multi session debugging
When debugging multiple sessions, only the focused session shows an array for the current location.
TODO @isidorn
...
* noDebug and compact debugSessionOptions
TODO @isidorn
...
* [102048](https://github.com/microsoft/vscode/issues/102048): It takes too many clicks of "Load More Frames" to get the full call stack when there are lots of stack frames
