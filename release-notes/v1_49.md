...
* **[TypeScript optional chain refactoring](#convert-to-optional-chain-refactoring)** - Convert multiple checks to a concise optional chain.
...
* **[Improved keybinding diagnostics](#improved-keybinding-diagnostics)** - Logs keyboard shortcuts and command mapping.
...
The newly proposed [Webview View API](https://github.com/microsoft/vscode/issues/46585) allows extension to contribute webview based views to the sidebar of panel. These views can offer specialized presentations of data, more advanced user interfaces, and much more.
