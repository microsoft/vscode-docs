...
There has been several bug and performance fixes on the 'Rename on Type' in HTML. When modifying a tag, the feature automatically renames the matching HTML tag.
The feature is optional and can be enabled by setting: `"editor.renameOnType": true`
