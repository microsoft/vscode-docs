...
The Sessions list now shows chats as children of their parent session. This tree hierarchy makes it easier to understand which chats belong together and to move between parallel work without managing a collection of unrelated sessions.
