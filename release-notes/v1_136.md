...
Word wrapping now takes the visual width of injected text into account, including color decorators, inlay hint spacing, inline progress indicators, and breakpoint placeholders. This keeps wrapped lines within the editor viewport instead of allowing decorations to push text offscreen.
