...
Need to step away from your desk, but want to ensure your agents stay on track? You can now take those sessions with you anywhere using remote control.

[Remote control for Copilot CLI](https://code.visualstudio.com/docs/copilot/agents/copilot-cli) allows you to check progress, respond to approvals, and steer work from another device - using GitHub.com or the GitHub mobile app - while it keeps running in the background.

https://github.com/user-attachments/assets/5c3ba3fe-68bd-4262-89a3-d562755ad5cd
...
Copilot now includes a built-in `githubTextSearch` tool that does a grep style search through the code of GitHub repository or entire GitHub organizations. This is a useful complement to the existing `githubRepo` tool which does semantic searches within a GitHub repo. Both of these tools can be a useful way for an agent to learn about a codebase outside of the one you are currently working on.

For more advanced GitHub features such as searching and manaaging issues or pull requests, consider using the [GitHub MCP server](https://github.com/github/github-mcp-server).
