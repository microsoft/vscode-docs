...
Need to step away from your desk, but want to ensure your agents stay on track? You can now take those sessions with you anywhere with remote control.

[Remote control for Copilot CLI](https://code.visualstudio.com/docs/copilot/agents/copilot-cli) sessions allows you to check progress, respond to approvals, and steer work from another device - using GitHub.com or the GitHub mobile app - while it keeps running in the background. 
