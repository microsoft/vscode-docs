...
If you are a current user of the system-wide Windows setup, you will be prompted to switch to the user setup, which we recommend using from now on. New users will be directed towards using it by default via our [Download](https://code.visualstudio.com/Download) page.
...
* [Ryuichi Inagaki (@ryu1kn)](https://github.com/ryu1kn): Error on "Undo Last Commit" if executed against the initial commit [PR #47578](https://github.com/Microsoft/vscode/pull/47578)
