...
### Run npm scripts from the 'package.json' file

You can now run an npm script in the `package.json` from the hover as shown below or using the command `Run Selected Npm Script`.
