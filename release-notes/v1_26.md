...
* **[Smart extensions search](#intellisense-for-extension-search)** - Filter Marketplace queries to find the extensions you want.
...
* [Jesus Abarca (@jabas06)](https://github.com/jabas06): Update recipe to make debugging work with version 6 of Angular CLI [PR #117](https://github.com/Microsoft/vscode-recipes/pull/117)
* [@NileshParkhe83](https://github.com/NileshParkhe83): Pull request for Jest issue - SecurityError: localStorage is not available for opaque origins #119 [PR #120](https://github.com/Microsoft/vscode-recipes/pull/120)
