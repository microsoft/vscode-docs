...
On window reload, watch tasks can be reconnected to by enabling `task.experimental.reconnection`. This enables a faster return to work following an extension change or update that requires reloading.
