...
With the Azure Developer CLI, you can initialize, provision, and deploy an application, or better yet, use `'azd up'` to do so in one step! For a list of supported `azd` commands, see the [Developer CLI reference](https://docs.microsoft.com/azure/developer/azure-developer-cli/reference).
