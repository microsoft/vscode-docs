...
<video src="images/1_70/menu-bar-folding.mp4" controls muted title="responsive menu bar folding"></video>
...
<video src="images/1_70/macos-title-bar-zooming.mp4" controls muted title="macOS title bar zooming"></video>
...
<video src="images/1_70/manual-folding-range.mp4" controls muted title="manual folding ranges"></video>
...
<video src="images/1_70/restored-folding-ranges.mp4" controls muted title="restored folding ranges"></video>
...
<video src="images/1_70/search-multiselect.mp4" controls muted title="Search view multiple selection with exclude and accept actions"></video>
...
<video src="images/1_70/tree-filter.mp4" controls muted title="Tree Find control showing search and filter"></video>
...
<video src="images/1_70/terminal-si-run-recent-command.mp4" controls muted title="Run recent command's contiguous search will match the search term exactly, toggle Fuzzy Search to switch to fuzzy searching"></video>
...
<video src="images/1_70/debug-sessions.mp4" controls muted title="Debug Session Picker Demo"></video>
...
<video src="images/1_70/go-to-most-recently-failed-cell.mp4" controls muted title="Go To Most Recently Failed Cell Demo"></video>
...
<video src="images/1_70/automatic-debug-configuration.mp4" controls muted title="Flask automatic debug configuration"></video>
...
<video src="images/1_70/interactive-window-restore.mp4" controls muted title="Interactive Window restore"></video>
...
<video src="images/1_70/sticky-scroll.mp4" controls muted title=""Sticky scroll" showing the source code scope for a TypeScript file"></video>
...
<video src="images/1_70/settings-profiles.mp4" controls muted title="Settings Profiles demo, showing the theme, zoom level, and Activity bar position changing as the profile is switched"></video>
...
<video src="images/1_70/code-action-all.mp4" controls muted title="Code Action control demo, showing control access from the context menu, a lightbulb, and Quick Fix."></video>
...
<video src="images/1_70/qute-html-participant.mp4" controls muted title="Qute HTML participant"></video>
...
<video src="images/1_70/api-drop.mp4" controls muted title="Using the drop into editor API to insert an image in Markdown by dragging it from VS Code's Explorer"></video>
