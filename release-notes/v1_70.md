...
**Note:** if you are used to opening the find widget in the editor when invoking `kbstyle(Ctrl/Cmd+F)` while the file explorer has focus, you can configure your keybindings accordingly:
