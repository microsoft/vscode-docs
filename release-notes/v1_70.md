...
* **[Fold selection](#fold-selection)** - Create you own folded regions in the editor.
* **[Search multi-select](#search-multi-select)** - Select and then act on multiple search results.
...
* **[Python Get started experience](#get-started-experience)** - Quickly install and configure Python within VS Code.
