...
Selecting an item in the picker will focus the debug session in the call stack view. Debug actions (e.g., pause, step, restart, stop) will be performed on the focused debug session. Selecting a session also shows the session's debug console.
