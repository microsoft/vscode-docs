...
For more details, see the [Session Sync](https://code.visualstudio.com/docs/agents/sessions/session-history) and [Chronicle](https://code.visualstudio.com/docs/agents/sessions/session-history#_query-session-history-with-chronicle) documentation.
