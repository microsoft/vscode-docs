...
**Update 1.123.1**: The update addresses these [security issues](https://github.com/microsoft/vscode/issues?q=is%3Aissue+is%3Aclosed+milestone%3A1.123.1).

**Update 1.123.2**: The update addresses these [issues](https://github.com/microsoft/vscode/issues?q=is%3Aissue+is%3Aclosed+milestone%3A1.123.2).
...
> Make sure to rewatch [VS Code Live at Build 2026](https://aka.ms/VSCode/Livestage)!
...
For more details, see the [Session Sync](https://code.visualstudio.com/docs/agents/run/sessions/session-history) and [Chronicle](https://code.visualstudio.com/docs/agents/run/sessions/session-history#_query-session-history-with-chronicle) documentation.
