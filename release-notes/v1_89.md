...
After pasting, if you realize that you instead want the exact text you copied, you can use the paste widget to switch back to normal copy/paste behavior.
