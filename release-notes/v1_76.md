...
1. There is now a default keybinding to open the remote menu: `kb(workbench.action.remote.showMenu)`.
   ...
   <video src="images/1_76/remote-indicator.mp4" placeholder="images/1_76/remote-indicator.mp4" controls muted title="Opening the remote menu with the new default keybinding">
...
<video src="images/1_76/web-git-lfs.mp4" placeholder="images/1_76/web-git-lfs.mp4" controls muted title="Viewing a Markdown preview of a file containing Git LFS image references in vscode.dev">
    Sorry, your browser doesn't support HTML 5 video.
</video>
...
<video src="images/1_76/pylance-pytest-intellisense.mp4" placeholder="images/1_76/pylance-pytest-intellisense.mp4" controls muted title="Showcasing new pytest IntelliSense features">
      Sorry, your browser doesn't support HTML 5 video.
</video>
...
<video src="images/1_76/experimental_notebook_search.mp4" placeholder="images/1_76/experimental_notebook_search.mp4" controls muted title="Notebook rich content search demo">
    Sorry, your browser doesn't support HTML 5 video.
</video>
...
<video src="images/1_76/quickpick-tooltip.mp4" placeholder="images/1_76/quickpick-tooltip.mp4" controls muted title="Quick Pick with tooltips">
    Sorry, your browser doesn't support HTML 5 video.
</video>
