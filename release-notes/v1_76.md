...
Welcome to the Feburary 2023 release of Visual Studio Code. There are many updates in this version that we hope you'll like, some of the key highlights include:
...
Jupyter extension's error renderer is now removed in favor of the built-in error renderer.
