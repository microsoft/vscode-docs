...
The explorer view, like many other views in VS Code, can now be moved into the secondary sidebar or the bottom panel to allow for further workbench customization.
