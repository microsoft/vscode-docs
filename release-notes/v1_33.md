...
* New `workbench.action.addComment` and `workbench.action.submitComment` commands that allow customizing the keybindings of starting a new comment and submitting it
