...
The new `Convert to destructured parameters` refactoring for JavaScript and TypeScript lets you quickly organize long function parameter lists by converting the function to take a single named parameter object
