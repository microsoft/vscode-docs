...
* **[Advanced container configuration](#advanced-container-configuration)** - Tips, samples, and videos to help configure development containers.
...
![Pinning the TypeScript version via the status item](images/1_61/ts-pin-version-status.gif)
...
Now you no longer need to choose a configuration every time you start debugging, as the first selection you make is reused for the rest of the session.
...
* [Test tags](https://github.com/microsoft/vscode/issues/129456) allow you configure if and how certain tests can be run--or not.
