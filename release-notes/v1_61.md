...
With the ongoing improvements to the getting started experience, the help menu items got updated to more commonly used names. This is based on learnings from new users but hopefully helps everybody to make finding help more intuitive. **Welcome** is now **Get Started**, **Introductory Videos** is **Video Tutorials**, and **Interactive Playground** became **Editor Playground**. You will find the new names in both the help menu and the command palette. The help menu also got a **Show All Commands** as an additional entry point to open the Command Palette.
