...
A new command was added to split an editor into two sides without requiring a second editor group. This allows you to work in two editors side by side on the same file:
...
![Pinning the version status](images/1_61/ts-pin-version-status.png)
