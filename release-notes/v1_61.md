...
Jupyter Notebook renderers have been split out into a separate extension ([Jupyter Notebook Renderers](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.jupyter-renderers)), allowing users to view Notebook outputs such as plotly, vega, latex & the like on [github.dev](https://github.dev/).
...
This feature applies to all notebooks within Visual Studio Code, hence is accessible via the [outline view](https://code.visualstudio.com/docs/getstarted/userinterface#_outline-view) section found in the file explorer.
