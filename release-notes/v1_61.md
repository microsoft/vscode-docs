...
Bracket pair guides use the same colors as the bracket pair colorization feature.
As for indentation guides, the active bracket pair guide is highlighted.
