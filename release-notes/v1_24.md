...
Starting with this release, VS Code will highlight deleted lines when using the inline diff editor:

![Inline Diff Syntax Highlighting](images/1_24/inline-diff-syntax.png)

### Font Zoom actions

Font Zoom actions have been added. They can be invoked in order to increase or decrease the font size of the editor. This is an alternative form of zomming, where the rest of the UI is left as-is. Use the following keybindings to replace the default zoom actions:
