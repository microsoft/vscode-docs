...
To better distinguish between the **Start Debugging** and **Continue** actions in the debug viewlet header, we have introduced a new icon for **Continue** that better aligns with the debug icons.
