...
### Switch to debug viewlet of break
...
The CALL STACK view now shows the path segments to easily distinguish sources with the same name. A common scenario is having to debug mutliple stack frames all named `module.js`.
