...
* **[Preview: Grid layout](#editor-grid-layout)** - Custom vertical/horizontal layout, coming soon to Insiders.
...
* **[Editor](#editor)** - Zoom font size independent of your workbench, syntax highlight for deleted lines, z.
...
* **[Languages](#languages)** - JavaScript/TypeScript getter/setter refactoring, SCSS at-keyword completions.
...
Thanks to a [pull request](https://github.com/Microsoft/vscode/pull/49936), it is now possible to automatically switch to the Debug view when a breakpoint is hit. Just set the `debug.openDebug` setting to the new value `openOnDebugBreak`.
...
The new `move to file` refactoring for JavaScript and TypeScript lets you quickly move classes and functions to their own file:
...
### SCSS at-keywords completion

Completion for SCSS's [at-rules and directives](http://sass-lang.com/documentation/file.SASS_REFERENCE.html#directives) has been added.
...
We noticed that there are still extensions written in TypeScript that use tasks version `0.1.0` to compile TypeScript to JavaScript. Task version `2.0.0` is out since a while and we wrote a little [guide](https://code.visualstudio.com/docs/extensions/developing-extensions#_compiling-typescript) on how to update an extension using version `0.1.0` to version `2.0.0`.
...
During this milestone, [Vetur](https://github.com/vuejs/vetur) started taking advantage of VS Code's file watcher. As a result:
...
* [Sebastián Gurin (@cancerberoSgx)](https://github.com/cancerberoSgx): `NOT MERGED - PLS REVIEW` dependencies updated [PR #335](https://github.com/Microsoft/vscode-tslint/pull/335)
