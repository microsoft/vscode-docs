...
* **[Better Terminal link detection](#link-improvements)** - Detect links in Python stack traces, compiler errors, and more.
...
* **[AI Tools in VS Code](#github-copilot)** - Learn about AI coding help with GitHub Copilot.
...
We've also added a new [AI Tools in VS Code](https://code.visualstudio.com/docs/editor/artificial-intelligence) topic to the VS Code docs that will help you get started with Copilot.
