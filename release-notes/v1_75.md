...
Users can control how git repositories from parent folders are being handled using the `git.openRepositoryInParentFolders` setting. Users who would like to restore the old behaviour can set the `git.openRepositoryInParentFolders` setting to `always`.
