...
GPU-accelerated terminals now get pixel-perfect custom glyphs for the triangle and diagonal line powerline extra symbols glyphs. These characters are somewhat ambiguous whether they are single or double which charatcers and differ depending on the font used, we chose to render them as single width.
