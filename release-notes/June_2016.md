...
* Arguments can be passed to the terminal shell on Linux and Mac using the `terminal.integrated.shellArgs.*` settings.
...
* [Sajjad Hashemian (@sijad)](https://github.com/sijad):
  * Improve 'Open in Terminal' on Mac. [PR #6136](https://github.com/Microsoft/vscode/pull/6136)
