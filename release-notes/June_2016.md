...
### Show Type on Hover
For debug adapters that support types we now show the variable type on hover over the variable name in debug viewlet.
...
* [Ed Munoz (edumunoz)](https://github.com/edumunoz): Multiple fixes [PR #7367](https://github.com/Microsoft/vscode/pull/7367), [PR #7371](https://github.com/Microsoft/vscode/pull/7371)
