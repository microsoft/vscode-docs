...
It is now possible to drag the debug toolbar horizontally. Initiated by a [user request](https://github.com/Microsoft/vscode/issues/4580).
...
It is now possible to specify OS specific configurations inside 'launch.json'. Initiated by a [user request](https://github.com/Microsoft/vscode/issues/1873).
