...
For other extensions, you can opt them in by ID with the `setting(extensions.supportSessionsWindow)` setting. Any extension you enable this way needs to be installed in your default VS Code profile.
