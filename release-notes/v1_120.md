...
The model picker in the Chat view now groups models by their provider, making it easier to find the model you want when you have access to models from multiple sources. You can also search for models by name directly in the picker.
...
<video src="images/1_120/model-picker-demo.mp4" title="Video showing the model picker in the Chat view with models grouped by provider and search functionality." autoplay loop controls muted></video>
