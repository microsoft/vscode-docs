...
Reasoning-capable language models allow you to configure their "thinking effort", which is a way to trade off between response quality and speed/cost. You can learn more about thinking effort in our [documentation](https://code.visualstudio.com/docs/copilot/concepts/language-models#_thinking-effort).
...
As well, these IDs are being used [for validation](/docs/languages/markdown#link-validation)
