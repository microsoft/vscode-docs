...
* [BYOK improvements](#language-models): Track and optimize token usage and configure thinking effort for your BYOK models.
...
![Screenshot of the context window control in the Chat view showing accurate token usage and percent-full for BYOK models.](images/1_120/context-window-byok-token-usage.webp)
...
![Screenshot of the Language Models editor showing the Thinking Effort configuration option for a BYOK model.](images/1_120/byok-configure-thinking-effort.webp)
...
![Screenshot showing a terminal command confirmation in chat with an AI-generated risk badge and explanation below the command.](images/1_120/terminal-risk-assessment.webp)
...
![Screenshot of the source control diff rendered in a side-by-side Markdown preview.](images/1_120/md-diff-overview.webp)
...
![Screenshot of the source control diff rendered in an inline Markdown preview.](images/1_120/md-diff-inline.webp)
...
![Screenshot showing ID attribute completions in a Markdown link.](images/1_120/md-id-completion.webp)

They are also used for [link validation](https://code.visualstudio.com/docs/languages/markdown#_link-validation):

![Screenshot showing a validation error for a Markdown link with an unknown HTML id.](images/1_120/md-id-validation.webp)
