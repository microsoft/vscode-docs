...
In this release, we enabled the new diff editor by default. We also improved some of the new diff editor features.
...
When enabled, moved code is detected and arrows are drawn to indicate where code blocks moved to.
...
With this release, we now render breadcrumbs for collapsed code blocks. Clicking on a breadcrumb item will reveal the selected item:
...
Old toggle style (disabled and enabled):

![Alt text](images/1_82/diffEditor-oldToolbarDisabled.png), ![Alt text](images/1_82/diffEditor-oldToolbarEnabled.png)

New toggle style (disabled and enabled):

![Alt text](images/1_82/diffEditor-newToolbarDisabled.png), ![Alt text](images/1_82/diffEditor-newToolbarEnabled.png)
...
<video src="images/1_82/create-workspace-chat.mp4" controls title="Create workspaces from panel chat"></video>
...
<video src="images/1_82/untitled-hint.mp4" controls title="Inline chat in untitled text editor"></video>
