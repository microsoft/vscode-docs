...
The default download of VS Code for macOS is now a Universal build which runs natively on all Macs. On the [Downloads](https://code.visualstudio.com/download) page, you can find additional links to architecture-specific builds for Intel or Apple Silicon, which are smaller downloads compared to the Universal package.
