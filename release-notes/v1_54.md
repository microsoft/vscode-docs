...
* **[Table widget](#table-widget)** - Remote ports now visible in table widget.
* **[Brackets Keymap and Extension Pack](#brackets)** - Developers coming from the Brackets editor can feel right at home.
* **[Troubleshooting extensions blog post](#troubleshooting-extensions-blog-post)** - Learn to troubleshoot extensions using the extension bisect feature.
...
![List/tree UI](./images/1_54/tree-ux.png)
...
![Table widget](./images/1_54/table.png)
...
You can now compare changes across Git history timeline entries, using the **Select for Compare** and **Compare with Selected** commands — similar to comparing files in the Explorer view.
...
You can now register an authentication provider, which can be leveraged by other extensions to perform authentication against a service.
