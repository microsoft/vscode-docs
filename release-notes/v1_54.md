...
The 'Wrap with Abbreviation' and 'Wrap Individual Lines with Abbreviation' commands have been merged into the single 'Wrap with Abbreviation' command to reduce any confusion over which wrap command to use.

Additionally, the 'Wrap with Abbreviation' command now previews whitespace properly.
...
* [@lancewl (Hsuan-An Weng Lin)](https://github.com/lancewl): Enable stylesheet.shortHex option [PR #50](https://github.com/microsoft/vscode-emmet-helper/pull/50)
