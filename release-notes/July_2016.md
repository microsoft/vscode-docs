...
### Restart Frame
VS Code now has a 'Restart Frame' action in the stack frame context menu in the CALL STACK viewlet. 'Restart Frame' is only available for debug extensions that support this functionality, e.g. VS Code's built-in Node Debug.
