...
* [Sorin Iclanzan (@iclanzan)](https://github.com/iclanzan): Fix sensitivity is not always being applied. [PR #9005](https://github.com/microsoft/vscode/pull/9005)
* [Tamas Kiss (@kisstkondoros)](https://github.com/kisstkondoros):
  ...
  * Fixes mouse wheel zoom in case of inline diff view [PR #8853](https://github.com/microsoft/vscode/pull/8853)
  * New cursor animation styles implemented [PR #8153][def]
* [一丝 (@yisibl)](https://github.com/visible): Add Selection To Previous Find Match [PR #8677](https://github.com/microsoft/vscode/pull/8677)
* [Giorgos Retsinas (@elemongw)](https://github.com/elemongw): ["Mack" ] `kbstyle(Ctrl+P)` and `kbstyle(Ctrl+N)` for up and down navigation. [PR #7316](https://github.com/microsoft/vscode/pull/7316)
...
[def]: https://github.com/microsoft/vscode/pull/8153
[def2]: https://github.com/daviwil