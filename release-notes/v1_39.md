...
The [Node.js deployment tutorials](https://code.visualstudio.com/docs/azure/deployment) have moved to the [Azure JavaScript Developer Center](https://learn.microsoft.com/azure/javascript) on [learn.microsoft.com](https://learn.microsoft.com).

There you can find tutorials for using Visual Studio Code to:

* [Deploy Azure Functions](https://learn.microsoft.com/azure/javascript/tutorial-vscode-serverless-node-01)
* [Deploy to Azure App Service](https://learn.microsoft.com/azure/javascript/tutorial-vscode-azure-app-service-node-01)
* [Deploy Docker containers](https://learn.microsoft.com/azure/javascript/tutorial-vscode-docker-node-01)
* [Create a static website](https://learn.microsoft.com/azure/javascript/tutorial-vscode-static-website-node-01)
