...
* [Deploy Azure Functions](https://docs.microsoft.com/azure/javascript/tutorial-vscode-serverless-node-01)
* [Deploy to Azure App Service](https://docs.microsoft.com/azure/javascript/tutorial-vscode-azure-app-service-node-01)
* [Deploy Docker containers](https://docs.microsoft.com/azure/javascript/tutorial-vscode-docker-node-01)
* [Create a static website](https://docs.microsoft.com/azure/javascript/tutorial-vscode-static-website-node-01)
