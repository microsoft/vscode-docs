...
![Color theme tester with vscode.dev for GitHub Theme extension GitHub Dark Default](images/1_69/theme-tester-marketplace.png)
...
To access these APIs, your extension first needs to request access to the desired devices by running on these commands:
