...
![Do not disturb mode](images/1_69/do-not-disturb.jpg)

This new mode hides all non-error notification toasts when enabled. Progress notifications will be automatically shown in the status bar. Hidden notifications are still available to view in the notification center.
