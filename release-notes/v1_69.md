...
The commands detected by shell integration feed into the command navigation feature (`ctrl/cmd+up`, `ctrl/cmd+down`) which enable quick navigation between commands and selection of their output.
...
TODO: terminal-si-recent-command.png
...
TODO: terminal-powerline-before.png

After:

TODO: terminal-powerline-after.png
...
TODO: Image terminal-message-loud.png
TODO: Image terminal-message-subtle.png
