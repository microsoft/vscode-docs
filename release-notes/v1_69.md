...
This milestone we are announcing a preview of **edit sessions** in VS Code. Edit sessions enable you to bring your uncommitted working changes along when you continue working on a repository wherever VS Code is available, whether that is VS Code for the web, desktop VS Code, or across different machines.
...
- from a clone of a repository on a Windows device to a clone of that repository on a Mac device
