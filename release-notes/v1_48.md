...
And check out this blog post on using [Dev Containers in Education](https://code.visualstudio.com/blogs/2020/07/27/containers-edu) to help students and educators create stable, reproducible classroom setups.
