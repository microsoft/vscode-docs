...
* **[Accessibility improvements](#accessibility)** - New Settings editor prototypes.
* **[New menu layouts](#extensions-overflow-menu-cleanup)** - Refactored Overflow menus for both Extensions and Git.
* **[Settings Sync](#settings-sync)** - Settings Sync is now available for preview in stable.
* **[Debug URL Support](#debug-open-link-command)** - Debug any URL without a launch config.
...
The Extensions view **Views and More Actions** (**...**) menu has been refactored for better organization of Extensions views and other actions:
...
A new **Debug: Open Link** command has been added to quickly debug any URL. Previously, to debug a browser, you had to install the Debugger for Chrome extension and write a `launch.json` config file to debug a page. This command allows you to debug any URL without needing any additional launch configs.
