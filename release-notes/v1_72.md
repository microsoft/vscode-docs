...
To get started, just enable `"markdown.validate.enabled": true`. This will make VS Code analyze Markdown links to headers, images, and other local files. Invalid links will be reported as either warnings or errors.
