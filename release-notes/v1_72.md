...
To get started, enable `"markdown.validate.enabled": true`. VS Code will then analyze Markdown links to headers, images, and other local files. Invalid links will be reported as either warnings or errors.
