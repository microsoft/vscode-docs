...
We are releasing a 1.11.1 update to address a handful of [issues](https://github.com/Microsoft/vscode/milestone/40?closed=1).

Downloads: [Windows](https://vscode-update.azurewebsites.net/1.11.1/win32/stable) | [Mac](https://vscode-update.azurewebsites.net/1.11.1/darwin/stable) | Linux 64-bit: [.tar.gz](https://vscode-update.azurewebsites.net/1.11.1/linux-x64/stable) [.deb](https://vscode-update.azurewebsites.net/1.11.1/linux-deb-x64/stable) [.rpm](https://vscode-update.azurewebsites.net/1.11.1/linux-rpm-x64/stable) | Linux 32-bit: [.tar.gz](https://vscode-update.azurewebsites.net/1.11.1/linux-ia32/stable) [.deb](https://vscode-update.azurewebsites.net/1.11.1/linux-deb-ia32/stable) [.rpm](https://vscode-update.azurewebsites.net/1.11.1/linux-rpm-ia32/stable)
