...
However, if you want to play around with new colors, use the setting `workbench.experimental.colorCustomizations` to customize the currently selected theme.
 ...
 <video src="images/1_11/color-settings.mp4" title="Video showing color customization." autoplay loop controls muted></video>
...
<video src="images/1_11/keyboard-shortcuts.mp4" title="Video showing Keyboard Shortcuts." autoplay loop controls muted></video>
...
<video src="images/1_11/panel.mp4" title="Video showing Panel." autoplay loop controls muted></video>
...
When you drag and drop with or without copying the text, the style of the mouse pointer will change accordingly. You will see a `+` (plus) image when copying.
 ...
 <video src="images/1_11/dnd.mp4" title="Video showing dnd." autoplay loop controls muted></video>
...
<video src="images/1_11/config-exceptions.mp4" title="Video showing Configuring Exceptions." autoplay loop controls muted></video>
