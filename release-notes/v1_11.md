...
We are releasing a 1.11.2 update to add the 1.11 translations and address a handful of [issues](https://github.com/Microsoft/vscode/milestone/41?closed=1).

## 1.11.1 Update

In the 1.11.1 update, we fixed these [issues](https://github.com/Microsoft/vscode/milestone/40?closed=1).
