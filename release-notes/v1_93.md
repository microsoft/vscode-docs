...
### Action control theme key

The color of the Action control, such as the Code Action menu, can be configured by themes with the `editorActionList-background`, `editorActionList-foreground`, `editorActionList-focusForeground`, and `editorActionList-focusBackground` keys. By default, the Action control theme matches that of Quick Pick and Command Palette. Get more info about [customizing a color theme](https://code.visualstudio.com/docs/getstarted/themes#_customize-a-color-theme).
