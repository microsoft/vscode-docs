...
To make it easier to leverage chat participants with natural language, in the coming weeks, we're experimenting with enabling Copilot Chat to detect whether your question would benefit from being routed to a participant or chat command.

![Participant detection in panel chat](images/1_93/participant-detection.png)

You can manually enable or disable this feature by configuring <a href="vscode://settings/chat.experimental.detectParticipant.enabled" codesetting="true">`chat.experimental.detectParticipant.enabled`</a>.
