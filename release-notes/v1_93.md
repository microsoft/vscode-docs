...
* [Inline Chat](#use-current-editor-line-as-inline-chat-prompt) - Improved inline Chat with recent coding context and editor prompts.
...
#### Use current editor line as inline Chat prompt
...
* Enable the <a href="vscode://settings/github.copilot.editor.enableInlineChatCompletionTrigger" codesetting="true">`github.copilot.editor.enableInlineChatCompletionTrigger`</a> setting, so that Copilot detects that the current line has mostly text instead of source code, and then starts inline Chat.
...
#### Use recent coding files as Inline Chat context
