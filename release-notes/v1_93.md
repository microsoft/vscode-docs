...
* [GitHub Copilot](#github-copilot) - Add context in Quick Chat, improved test generation and chat history.
...
<div id="_github-copilot"/>

## GitHub Copilot

This milestone, we continued to improve the GitHub Copilot experience in VS Code, across the editor, the Chat view, and inline Chat.

We've also added several experimental features for you to try and for which we'd like to get your feedback:

* [Specify code-generation instructions](#code-generation-instructions)
* [Use recent coding files as context for inline Chat](#copilot-inline-chat-context)
* [Create inline Chat prompts from the editor](#current-line-context)
* [AI-generated debugging configuration](#start-debugging-from-chat)
* [Automatic chat participant detection](#chat-participant-detection)
* [Generate tests based on test coverage](#generate-tests-based-on-test-coverage)
...
<div id="code-generation-instructions"/>
<div id="_code-generation-instructions"/>
...
<div id="copilot-inline-chat-context"/>
<div id="_copilot-inline-chat-context"/>
...
<div id="current-line-context"/>
<div id="_current-line-context"/>
...
<div id="start-debugging-from-chat"/>
<div id="_start-debugging-from-chat"/>

### Experimental: Start debugging from Chat

**Setting**: <a href="vscode://settings/github.copilot.advanced.startDebugging.experimental.enabled>`github.copilot.advanced.startDebugging.experimental.enabled`</a>
...
<div id="chat-participant-detection"/>
<div id="_chat-participant-detection"/>
...
<div id="generate-tests-based-on-test-coverage"/>
<div id="_generate-tests-based-on-test-coverage"/>

### Experimental: Generate tests based on test coverage
