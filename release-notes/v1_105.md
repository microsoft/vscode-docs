...
Learn more about [using subagents in VS Code](https://code.visualstudio.com/docs/chat/chat-sessions#_subagents).
...
<video src="images/1_105/py_copy_test_id.mp4" title="Video showing the Copy Test Id command in the run gutter context menu." controls muted></video>
