...
<!-- TODO: link to suggested actions in 1.104 -->

To quickly pick up where you left off or to revisit some past conversations after starting a new chat session, you can now see your recent local chat conversations when the Chat view is empty.
...
The MCP marketplace is disabled by default. When no MCP servers are installed, you see a welcome view in the Extensions view that provides easy access to enable the marketplace:
