...
Learn more about how to use the [built-in plan agent in VS Code](https://code.visualstudio.com/docs/agents/planning).
...
Learn more about [using handoffs in custom chat modes](https://code.visualstudio.com/docs/agent-customization/custom-agents#_handoffs).
...
Learn more about [using subagents in VS Code](https://code.visualstudio.com/docs/agents/subagents).

### Integration with OpenAI Codex

> **Note**: This feature is currently only available in [VS Code Insiders](https://code.visualstudio.com/insiders/).

The new [Agent Sessions view](https://code.visualstudio.com/docs/agents/sessions/manage-sessions#_sessions-list) in VS Code Insiders now also integrates with OpenAI Codex. Manage both local and cloud-based agent sessions from a unified interface, making it easier to track progress and delegate tasks across multiple AI coding assistants.
...
The new [Agent Sessions view](https://code.visualstudio.com/docs/agents/sessions/manage-sessions#_sessions-list) in VS Code Insiders now supports the GitHub Copilot CLI. You can manage both local and cloud-based agent sessions from a unified interface, making it easier to track progress and delegate tasks across the Copilot CLI and Copilot Coding agent.
...
If you're [using OpenAI-compatible models](https://code.visualstudio.com/docs/agent-customization/language-models#_use-an-openaicompatible-model), you can also explicitly configure the list of edit tools with the `setting(github.copilot.chat.customOAIModels)` setting.
...
You can choose between different models with the model picker in chat. Learn more about [language models in VS Code](https://code.visualstudio.com/docs/agent-customization/language-models).
