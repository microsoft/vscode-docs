...
* **[JavaScript IntelliSense](#better-javascript-intellisense)** - Immediate IntelliSense as VS Code automatically installs JavaScript module and library type information.
...
The `vscode-eslint` and `vscode-tslint` extensions now provide settings to to fix auto fixable warnings on save. 
