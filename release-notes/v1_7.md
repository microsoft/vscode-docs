...
As ever, the latest and greatest version of our extension API is defined in the [`vscode.d.ts`](https://github.com/Microsoft/vscode/blob/master/src/vs/vscode.d.ts) file. **Note**, when you update your extension to use an API version 1.7.0 or newer, make sure you use the latest version of the [vscode](https://www.npmjs.com/package/vscode)-node-module (^1.0.3) and make sure to use TypeScript 2.0.
...
* Language smartness like code complete or hover doesn't work for JavaScript and TypeScript files without an extension. Requesting such a feature will result in an exception in the `TypeScript` output channel. For more information please see this [issue](https://github.com/Microsoft/TypeScript/issues/11883).
