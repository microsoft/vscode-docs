...
If you're curious about the details, you can read our [blog post](http://code.visualstudio.com/blogs/2016/11/3/rollback) describing the event and NPM and VS Code's mitigations.
...
In the recent months the grammar has been completly rewritten.
...
* Online debugging [documentation](http://code.visualstudio.com/docs/editor/debugging#_launch-configurations) has been rewritten and improved.
