...
#### Edit session are restored after restarts

Edit sessions now are fully restored after restarting VS Code: That includes the working set, acceptance state as well as the file states of all past edit steps.
