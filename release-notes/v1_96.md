...
You can now share an extension with others by using the **Copy Link** action in the context menu of an extension in the Extensions view. This will copy a link to the extension to your clipboard.

![Share an Extension](images/1_96/extension-copy-link.png)
