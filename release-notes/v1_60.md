...
* If you want to avoid accidentally closing the window during a debug session, you can enable the new setting `debug.confirmOnExit`. You will be prompted to confirm that you want to kill the debug session by closing the window.
