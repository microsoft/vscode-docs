...
<video src="images/1_60/language-detection-untitled.mp4" controls muted title="Language detection of untitled files"></video>
...
<video src="images/1_60/language-detection-pipe.mp4" controls muted title="Language detection of extension-less files"></video>

*Theme: [Panda Theme](https://marketplace.visualstudio.com/items?itemName=tinkertrain.theme-panda)*

Auto detect option in the Notebooks language picker:

<video src="images/1_60/language-detection-notebooks.mp4" controls muted title="Language detection of Notebooks"></video>
...
<video src="images/1_60/bracket-pair-colorization-checker_ts.mp4" controls muted title="Colorization of brackets at the top and bottom of a large file"></video>
...
<video src="images/1_60/inline-suggestions-suggest-preview.mp4" controls muted title="Accepting inline suggestion by pressing the Tab key twice"></video>
...
* When a debug session is active, the **Run To Line** action is now available in the editor's breakpoint gutter context menu:
  ...
  <video src="images/1_60/run-to-line.mp4" controls muted title="Run to Line action in breakpoints gutter"></video>
...
<video src="images/1_60/notebook-links.mp4" controls muted title="Clickable links to the headers of other notebook cells"></video>
...
<video src="images/1_60/locked-editor-group.mp4" controls muted title="New files open to the left when Markdown preview is in a locked editor group"></video>
...
<video src="images/1_60/auto-locked-editor-group.mp4" controls muted title="Auto locked editor group"></video>
...
<video src="images/1_60/quotes-quick-pick.mp4" controls muted title="Query with only 2 characters yields more accurate results"></video>

If you want to reduce the "clutter" of the results:

<video src="images/1_60/quotes-query-pieces.mp4" controls muted title="Results disappear when adding quotes"></video>
...
<video src="images/1_60/jupyter-rbl.mp4" controls muted title="Run By Line in Jupyter notebook"></video>
...
<video src="images/1_60/jupyter-debug.mp4" controls muted title="Debugging Jupyter notebook"></video>
...
<video src="images/1_60/python-run-and-debug-buttons.mp4" controls muted title="Using the new button to run and debug a Python file"></video>
...
<video src="images/1_60/themed-walkthrough.mp4" controls muted title="Example of built-in walkthrough using color themes"></video>
