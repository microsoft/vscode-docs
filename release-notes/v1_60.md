...
Following the new best practices, VS Code's checkbox *"Register VS Code to be the editor for associated file types"* will now checked by default during installation. Taking the opportunity, we also reviewed list of associated and update it to reflect frequently opened file types.
