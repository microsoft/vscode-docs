...
The dialog presented when closing a terminal editor that has active child processes is now specific for the terminal editor and will no longer offer a way to "Save" the terminal.

![Terminal with Child Processes Editor Confirmation Dialog](images/1_60/dirty-terminal-dialog.png)
