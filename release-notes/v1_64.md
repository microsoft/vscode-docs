...
<video src="images/1_64/sidepanel_outline.mp4" controls muted title="Moving Outline View to the Side Panel"></video>
...
<video src="images/1_64/panel_location.mp4" controls muted title="New Panel View Commands"></video>
...
<video src="images/1_64/panel_alignment.mp4" controls muted title="Aligning the Panel with Panel alignment commands"></video>
...
<video src="images/1_64/customize_layout.mp4" controls muted title="Experimental Customize Layout control"></video>
...
<video src="images/1_64/explorer-undo.mp4" controls muted title="Recording of the File Explorer under different undo configurations"></video>
...
<video src="images/1_64/terminal-auto-reply.mp4" controls muted title="Pressing Ctrl+C will immediately reply to the question and return to the prompt"></video>
...
<video src="images/1_64/notebook-find-in-markup-output.mp4" controls muted title="Notebook find in Markdown and outputs"></video>
...
<video src="images/1_64/collapse-gutter.mp4" controls muted title="Cell collapse UI"></video>
...
<video src="images/1_64/cell-executing-spinner.mp4" controls muted title="Notebook cell executing spinner"></video>
...
<video src="images/1_64/js-debug-exclude-caller.mp4" controls muted title="Selecting the Exclude Caller command and displaying the Excluded Callers view"></video>
...
<video src="images/1_64/ts-surround-with.mp4" controls muted title="Surrounding selected code with an if statement"></video>
...
<video src="images/1_64/github-commit-signing-prs.mp4" controls muted title="Make verified commits and commit to pull requests from forks in VS Code for the Web"></video>
...
<video src="images/1_64/remotehub-scm-multiple-selection.mp4" controls muted title="Stage multiple selected changes with a single click"></video>
...
<video src="images/1_64/python-smart-selection.mp4" controls muted title="Expanding and shrinking Python code with Shift+Alt+RightArrow and Shift+Alt+LeftArrow"></video>
...
<video src="images/1_64/python-folding.mp4" controls muted title="Collapsing and expanding folding regions in Python code"></video>
...
<video src="images/1_64/localAndRemoteJupyterTogether.mp4" controls muted title="Remote Jupyter connections"></video>
...
<video src="images/1_64/vscode-bisect.mp4" controls muted title="VS Code bisect tool"></video>
