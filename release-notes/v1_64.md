...
Note we're also experimenting with moving the active/selected interpreter in the status bar towards the right, so please look towards the right side in case it isn't visible.
