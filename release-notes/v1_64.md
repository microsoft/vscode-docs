...
Note we're also experimenting with moving the active/selected interpreter in the status bar to the right, so please looks towards the right side in case it isn't visible.
