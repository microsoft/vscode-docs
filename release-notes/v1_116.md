...
* **Chat send performance**: Fixed an issue where chat message sending would be blocked by loading chat customizations. The message should now visually appear in the chat conversation immediately.
