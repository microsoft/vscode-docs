...
* **Keyboard navigation commands** — New keybindings let you quickly focus key views in the Agents app:
  * `Ctrl+Shift+G` (`Cmd+Shift+G` on macOS) — Focus the Changes view
  * `Ctrl+Shift+C` (`Cmd+Shift+C` on macOS) — Focus the Chat Customizations view
  * `Ctrl+Shift+E` (`Cmd+Shift+E` on macOS) — Focus the Files Explorer view
