...
Settings files will not show warnings for unknown or unsupported settings now. Warnings are also not shown when you have configured settigs from extensions which are disabled. Instead these are shown as unused code.
