...
### New tree adopted in tree view

Extension contributed tree views now use the new tree. This provides better performance and keyboard navigation, and these are the only differences you should notice.
...
## New Variable ${relativeFileDirname} for task and debug configurations
