...
VS Code now offers DMG installers for macOS to provide a native installation experience. The installers are available for all supported architectures from the [VS Code website](https://code.visualstudio.com/download).
