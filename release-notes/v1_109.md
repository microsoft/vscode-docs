...
If the first thing you do when starting VS Code is working with agent sessions, we have added a new, experimental agent sessions welcome page. It serves as a central entry point for working with agent sessions: showing your recent sessions and letting you start a new chat directly from the welcome page.
...
We're seeking your early feedback to help shape this feature.
...
* **Parallel dependent tasks**: When running tasks via agents, dependent tasks are now processed in parallel instead of sequentially. This can significantly improve build times for projects with multiple independent build steps.
