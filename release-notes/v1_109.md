...
By default, editor Inline Chat uses the default model of the selected vendor. This allows extensions to provide a model that’s specifically tailored for Inline Chat scenarios.
