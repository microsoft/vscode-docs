...
![Screenshot of the language model picker showing a hover flyout describing the currently selected model, Claude Opus.](images/1_109/model-picker.png)
...
![Screenshot of a mermaid diagram in a chat response.](images/1_109/chat-mermaid.png)
...
![Screenshot of chat that shows two active subagents with an active spinner next to them to indicate they're actively running.](images/1_109/subagents.png)
