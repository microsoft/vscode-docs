...
Screen reader users can now quickly access and listen to their current line and column position using the new Announce Cursor Position command `kbstyle(Ctrl/Cmd+Alt+Shift+G)`. 
