...
* **[Preview: Minimap](#preview-minimap)** - get a 10,000 foot view of your code structure with Minimap.
...
* **[File Explorer Keybindings](#configurable-explorer-key-bindings)** - you can now create shortcuts for the Explorer as other list/tree UI components. 
* Officual Linux repo supporting autoupdating packages
* **[Improved Exception view](#improved-exception-experience)** - Easily view exception details in the debugger.
* TODO **[Links in th Terminal]** - links in terminal output streamline the workflow between editor and commands.
...
* **[HTML DOM Navigation](#html)** - Use the outline view to quickly navigate to DOM elements by id and class name.
* **[Default Language Settings](#go-make-yaml-markdown)** - We now have language specific settings for Go, Make, YAML and Markdown.
...
* **[Extension Authoring](#extension-authoring)** - pluggable SCM provider, Modal message dialogs, provide language specific settings, control global command visibility.
...
### TODO:Save participants trigger
