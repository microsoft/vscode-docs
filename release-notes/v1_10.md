...
These languages are now using the new support for default configuration settings per language to define the default TAB setting (see Default Language specific editor settings below).
