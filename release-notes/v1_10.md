...
As asked by the [community](https://github.com/Microsoft/vscode/issues/12714), new predefined common variable `${lineNumber}` for tasks.json and launch.json was introduced. It resolves to the selected line in the currently opened file. Adding this variable facilitates automation (e.g. running tests) under cursor selection.
