...
We now provide more assistance while turning on sync by checking if you are about to sync with data from a different machine and allow you to take an appropriate action.
...
* Updated labels in issue hovers.
