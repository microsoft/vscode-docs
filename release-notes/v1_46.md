...
![Moving Timeline from Explorer to Activity Bar](images/1_46/timeline-to-scm.gif)

*Dragging the Timeline view from Explorer to Activity Bar*
...
![Open In Terminal from Source Control Providers view](images/1_46/scm-open-in-terminal.png)
...
=======
### Add missing import quick fixes can now be marked preferred
>>>>>>> Cleanup and add import all source action
