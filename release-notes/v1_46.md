...
![Pin Tabs](images/1_46/pin-tabs.gif)
 ...
 Pinned tabs have a number of useful behaviour to help mark files that are important to you:
 ...
 **Note:** consider to configure `workbench.editor.highlightModifiedTabs: true` to see the dirty indicator on pinned tabs too.
