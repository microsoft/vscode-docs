...
Some changes in this release around how the macOS Keychain is accessed from VSCode will require you to acknowledge the following prompt for keychain access on macOS even if you have acknowledged this already before:
