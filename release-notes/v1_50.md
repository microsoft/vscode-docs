...
<video src="images/1_50/settings-editor.mp4" title="Video showing settings editor as list." autoplay loop controls muted></video>
...
<video src="images/1_50/pinned_tabs.mp4" title="Video showing Pinned Tabs." autoplay loop controls muted></video>
...
<video src="images/1_50/ext-recommendations-queue.mp4" title="Video showing Extension Recommendations Queue." autoplay loop controls muted></video>
...
* **Auto sizing debug hover**
  ...
  <video src="images/1_50/autosize-hover.mp4" title="Video showing Auto Sizing debug hover." autoplay loop controls muted></video>
...
<video src="images/1_50/js-debug-realtime.mp4" title="Video showing Debug realtime view." autoplay loop controls muted></video>
...
<video src="images/1_50/scm-saves.mp4" title="Video showing a message is typed in the SCM and the window is reloaded showing the saved message." autoplay loop controls muted></video>
...
<video src="images/1_50/template-string-converter-extension.mp4" title="Video showing typing a dollar sign then open curly brace within a string converts the quotes to backticks." autoplay loop controls muted></video>
