...
* **[Updated "Create a Dev Container" tutorial](#updated-"create-a-dev-container"-tutorial)** - Create a reusable Docker container.
* **[C++ extension](#microsoft-c++-extension)** - The Microsoft C++ extension is out of preview, with support for ARM.
...
* Ability to install and enable extensions when VS Code is connected to a remote.
