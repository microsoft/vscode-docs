...
The [Agents window](https://code.visualstudio.com/docs/agents/run/agents-window) includes several updates that make it easier to review changes and manage chats. Updates that require a session running on [the agent host](#the-agent-host) are called out below.
...
<video src="images/1_130/timestamps-in-chat.mp4" title="Video showing timestamps and elapsed time in a chat message toolbar." autoplay loop controls muted></video>
