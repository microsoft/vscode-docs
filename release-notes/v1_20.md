...
### New setting to disable macOS touchbar entries (macOS)

A new setting `keyboard.touchbar.enabled` can be used to disable the macOS touchbar entries that VS Code is providing.
