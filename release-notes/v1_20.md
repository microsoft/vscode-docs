...
There is now a [Vue.js debugging recipe](https://github.com/microsoft/vscode-recipes/tree/main/vuejs-cli) to help configure Chrome debugging for applications which use the popular [Vue.js](https://vuejs.org/) framework.
