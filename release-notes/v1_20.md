...
Welcome to the January 2018 release of Visual Studio Code. This release includes work during the January milestone as well as the [community PRs](#thank-you) submitted in December and January so you'll see there are a lot of great updates. Here are some of the release highlights:
...
* **[Explorer displays file errors](#error-indicators-in-the-explorer)** - Quickly navigate to errors in your code base.
* **[Save large and protected files](#save-files-that-need-admin-privileges)** - Save Admin protected and files >256M from within VS Code.
...
* **[Image preview zoom](#image-preview-zooming)** - Zoom in and out of images with your mouse, scrollwheel or track pad.
* **[Terminal screen reader support](#screen-reader-support)** - The Integrated Terminal now has a "Screen Reader Optimized" mode.
* **[Improved debugging support for multi-root workspaces](#improved-debugging-support-for-multi-root-workspaces)** - Manage debug configurations across multiple projects.
...
There is a new setting, `editor.minimap.side`, which can be configured to render the minimap to the left:
