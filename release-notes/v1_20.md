...
>You can also check out this 1.20 release [highlights video](https://youtu.be/1u3DOH7Slcg) from Cloud Developer Advocate [Brian Clark](https://twitter.com/_clarkio).
...
The proposed `RenameProvider2` extension to the `RenameProvider` provide allows extensions to provide additional rename information, including range of the symbol to rename and the initial name shown when a user triggers rename:
