...
When you are working on file types not supported out of the box by VS Code or by any of the installed extensions, you may end up with a sub-par experience as the file will not even be syntax highlighted. If there are extensions in the marketplace that can support such files, you will now be prompted to check them out.

![Extension Recommendations for unknown file types](images/1_20/filerec.gif)

The extension recommendation list will now include extensions that are popular among others who work on the same repository as you.

![Extension Recommendation based on whats popular among others on the same repo](images/1_20/popular-extension.gif)
...
[Deploy using Docker](https://code.visualstudio.com/tutorials/docker-extension/getting-started) | Deploy your website using a Docker container.
...
There is now a [Vue.js debugging recipe](https://github.com/Microsoft/vscode-recipes/tree/master/vuejs-cli) to help configurate the [Chrome debugger](https://marketplace.visualstudio.com/items?itemName=msjsdiag.debugger-for-chrome) for applications which use the popular [Vue.js](https://vuejs.org/) framework.
...
`kb(settings.action.editFocusedSetting)`|Edit the focused setting in the settings editor|`settings.action.editFocusedSetting`
...
* [Dave Holoway (@adelphes)](https://github.com/adelphes): `NOT MERGED - PLS REVIEW` Add Debug:Evaluate command to REPL history [PR #39467](https://github.com/Microsoft/vscode/pull/39467)
...
* [Kirill Shaplyko (@Baltazore)](https://github.com/Baltazore):  Option to disable Touch Bar controls and leave control strip (#38333) [PR #40692](https://github.com/Microsoft/vscode/pull/40692)
...
* [Bura Chuhadar (@BuraChuhadar)](https://github.com/BuraChuhadar):  Feature 29241: Add option to disable git indicators in gutter [PR #29700](https://github.com/Microsoft/vscode/pull/29700)
...
* [Mikhail Evdokimov (@evdokimovm)](https://github.com/evdokimovm): `NOT MERGED - PLS REVIEW` Adding 'editor.sameCursorStyle' preference setting [PR #39119](https://github.com/Microsoft/vscode/pull/39119)
...
* [Josh Unger (@joshunger)](https://github.com/joshunger):  fix spelling of issues to issue since "report issues" can't be found in the command palette [PR #40808](https://github.com/Microsoft/vscode/pull/40808)
* [Kamil Szot (@KamilSzot)](https://github.com/KamilSzot):  Fix #41080 [PR #42003](https://github.com/Microsoft/vscode/pull/42003)
* [Keegan Carruthers-Smith (@keegancsmith)](https://github.com/keegancsmith):  git: Sort RepositoryPicks to rank active repo first [PR #37030](https://github.com/Microsoft/vscode/pull/37030)
...
* [Matthew Ferderber (@matthewferderber)](https://github.com/matthewferderber):  use previous commit msg for amend, Fixes #35182 [PR #35403](https://github.com/Microsoft/vscode/pull/35403)
* [Mika Andrianarijaona (@mikaoelitiana)](https://github.com/mikaoelitiana):  fix: add word boundray to check markdown italic [PR #41466](https://github.com/Microsoft/vscode/pull/41466)
* [Marek Lewandowski (@mlewand)](https://github.com/mlewand):  Added support for multiple selections in Open Link action [PR #41242](https://github.com/Microsoft/vscode/pull/41242)
...
* [Ali (@Radon222)](https://github.com/Radon222)
  * `NOT MERGED - PLS REVIEW` Fix #40011: Tweak overflow behaviour when setting tab is narrow [PR #40395](https://github.com/Microsoft/vscode/pull/40395)
  * Fix #40011: Tweak overflow behaviour when setting tab is narrow [PR #40462](https://github.com/Microsoft/vscode/pull/40462)
...
* [Shivam Mittal (@shivammittal99)](https://github.com/shivammittal99):  Setting to show Source Control Provider even for single repository [PR #39245](https://github.com/Microsoft/vscode/pull/39245)
...
* [Leo Yin (@viztor)](https://github.com/viztor): `NOT MERGED - PLS REVIEW` feat(workbench/window): add setting to switch TouchBar on macOS [PR #40400](https://github.com/Microsoft/vscode/pull/40400)
