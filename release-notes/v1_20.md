...
### Keybindings for quickfixes and code actions

The new `editor.action.codeAction` command lets you configure keybindings for specific code actions. This keybinding for example triggers extract function refactoring code actions:
