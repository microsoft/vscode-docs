...
Zoom by clicking, using the scrollwheel, or pinching on a track pad. The current zoom level is shown in the status bar. Click on the zoom status bar item to quickly switch zoom levels or reset the view.
