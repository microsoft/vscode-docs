...
* [Editor](/docs/editor/editing/codebasics.md) - An introduction to VS Code itself from editing all the way to debugging and tasks
...
VS Code now supports variables in the `launch.json` file in the same way as in `tasks.json` (see [Tasks](/docs/editor/debugtest/tasks.md#variables-in-tasksjson)).
...
## Tasks
We did a significant review of the [Tasks documentation](/docs/editor/debugtest/tasks.md) with this update and have included several examples of using tasks.

We also now support automatic detection of tasks in a `gruntfile`. This works the same as our support for the Gulp and Jake task runners (see [Tasks](/docs/editor/debugtest/tasks.md#autodetecting-gulp-grunt-and-jake-tasks)).
