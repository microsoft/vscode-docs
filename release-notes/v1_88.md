...
You can now configure `search.searchEditor.singleClickBehaviour` in your settings, which drives what happens when you single-click on a Search Editor entry. Currently, it only supports opening a Peek Definition.
