...
#### No reload required for extension updates

You can now restart extensions instead of reloading the window when an extension is updated as shown in the image below.

![Restart extensions instead of reloading the window](images/1_88/restart-extensions.png)

**Note:** When you are connected to a remote server like WSL or SSH or Dev Container, you will still need to reload the window to update extensions.
...
### Run in section in Sticky Scroll and Notebook Outline
