...
![Running a recent command will preview the last time it's run in the terminal temporarily](./images/1_88/terminal-run-recent-command-preview.mp4)
...
![Previews are shown in both the editor and terminal when scrolling through links](./images/1_88/terminal-open-detected-link.mp4)
