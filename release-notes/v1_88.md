...
<video src="images/1_88/custom-editors-float.mp4" title="Custom editors support in floating windows." controls muted></video>
...
<video src="images/1_88/custom-editor-labels.mp4" title="Adding an entry for a custom editor label" controls muted></video>
...
<video src="images/1_88/locked-scrolling.mp4" title="Synchronize scrolling two editors" controls muted></video>
...
<video src="images/1_88/quick-pick-sticky-scroll.mp4" title="Sticky Scroll support in the quick pick" controls muted></video>
...
<video src="images/1_88/quick-pick-separator-buttons-show-up.mp4" title="Separator buttons show up when you hover or focus an item in that section" controls muted></video>
...
<video src="images/1_88/quick-pick-separator-keybindings.mp4" title="Move between separators using keybindings" controls muted></video>
...
<video src="images/1_88/terminal-run-recent-command-preview.mp4" title="Running a recent command will preview the last time it's run in the terminal temporarily" controls muted></video>
...
<video src="images/1_88/terminal-open-detected-link.mp4" title="Previews are shown in both the editor and terminal when scrolling through links" controls muted></video>
...
<video src="images/1_88/md-drop.mp4" title="Smartly dropping an image into a Markdown file. Markdown image syntax is inserted when it can be used, but not used in code blocks" controls muted></video>
...
<video src="images/1_88/cell-error-diagnostics.mp4" title="Error diagnostics in cells at failure location" controls muted></video>
...
<video src="images/1_88/notebook-run-in-section.mp4" title="Run Cells in Section for notebook outline and Sticky Scroll" controls muted></video>
...
<video src="images/1_88/notebook-outline-filters.mp4" title="Notebook Outline filter controls." controls muted></video>
...
<video src="images/1_88/notebook-kernel-context.mp4" title="Notebook emebeds kernel state in context" controls muted></video>
...
<video src="images/1_88/run-precedent-cells.mp4" controls muted title="Run Precedent Cells"></video>
