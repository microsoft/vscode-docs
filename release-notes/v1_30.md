...
JavaScript and TypeScript anonymous callbacks were all previously labeled as `<function>` the outline view, breadcrumbs view, and document symbol list. This made it impossible to tell which function you were really after:
