...
We are always on the look-out for ways to cut down the time it takes to load VS Code.  Across the last month we made a variety of improvements that have resulted in a significantly improved time for an initial (cold) launch of VS Code.
