...
* **[Git status in the Explorer](#git-status-in-file-explorer)** - See pending file changes in the File Explorer.
* **[Inline change review](#inline-change-review)** - View pending changes and perform partial commits in the editor.
* **[Windows start up improvements](#windows-start-up)** - VS Code cold start is faster by 5 seconds.
...
The VS Code logo for Stable release is now blue. You can read all about our icon journey in this [blog post](https://code.visualstudio.com/blogs/2017/10/24/theicon).
...
The two views for [workspace recommendations](https://code.visualstudio.com/docs/editor/extension-gallery#_workspace-recommended-extensions) and general recommendations are now combined into a single view with the two kinds of recommendations showing up in split view. Use the command **Extensions: Show Recommended Extensions** to get to this view.
