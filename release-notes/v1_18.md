...
We have changed the default shortcut on the Mac for `Debug: Start Without Debugging` to `ctrl + F5` due to collision of the previous shortcut with built in mac functionality.
