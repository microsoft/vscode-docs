...
Decorations are a fundamental editor concept on which numerous features are built; e.g.: find matches highlights, diff annotations, word highlights, selection highlights, breakpoints, folding markers or inline colors are just some of them. Moreover, numerous extensions make use of decorations to customize the rendering of VS Code's editor:
...
* [Dániel Tar (@qcz)](https://github.com/qcz):  Improve consistency of Emmet messages [PR #36251](https://github.com/Microsoft/vscode/pull/36251)
