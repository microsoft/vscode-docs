...
Welcome to the October 2017 release of Visual Studio Code. There are a number of significant updates in this version that we hope you will like, some of the key highlights include:

* **[Multi-root workspaces released to Stable](#support-for-multi-root-workspaces)** - Work on multiple projects simultaneously.
* **[Vertical panel layout](#vertical-panels)** - Dock panels to either the bottom or right of your editor.
* **[Git status in the Explorer](#git-status-in-file-explorer)** - See file change status highlighted in the File Explorer.
* **[Inline pending change review](#inline-change-review)** - View pending changes and perform partial commits in the editor.
* **[Faster start-up on Windows](#windows-start-up)** - VS Code cold start is improved by 5 seconds.
* **[Auto import for JS/TS](#auto-import-for-javascript-and-typescript)** - Selected an export symbol and the appropriate import is added to your file.
...
* **[Install @types Quick Fix](#install-types-quick-fix-for-typescript)** - Add missing @types files to your project for npm module IntelliSense.
* **[Better editor performance](#faster-editor-decorations)** - We've sped up the rendering of editor decorations.
* **[Recommended extension badge](#recommended-extensions-badge)** - Recommendations are highlighted in Marketplace searches.
...
Please refer to our [Multi-root Workspaces](https://code.visualstudio.com/docs/editor/multi-root-workspaces) documentation for a full explanation of all the features that come with it. Extension authors should refer to our [Adopting Multi Root Workspace APIs](https://github.com/Microsoft/vscode/wiki/Extension-Authoring:-Adopting-Multi-Root-Workspace-APIs) wiki page that explains the new extension APIs to make your extension ready for multi-root workspaces.

### Blue logo for Stable

The VS Code logo for the Stable release is now blue. You can read all about our icon journey in this [blog post](https://code.visualstudio.com/blogs/2017/10/24/theicon).
