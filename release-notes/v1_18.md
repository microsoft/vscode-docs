...
### TypeScript 2.6
VS Code 1.18 ships with TypeScript 2.6. This update brings a number of exciting tooling improvements and also fixes a few bug. You can read more about TypeScript 2.6 [here](https://blogs.msdn.microsoft.com/typescript/2017/10/31/announcing-typescript-2-6/).
