...
A more fancy icon theme [Seti](https://github.com/jesseweed/seti-ui) is available as an extension and we expect the community to contribute many more themes.

![seti icon theme](images/1_5/icon-theme-seti.png)

File icon themes can be contributed by extensions through a new contribution point: `iconThemes`.
...
>**Note:** Using TypeScript 2.0 for implementing an extension is currently not supported. It will be possible in the next release.
