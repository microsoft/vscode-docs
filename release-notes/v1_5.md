...
The VS Code team was hard at work during August and we are happy with the relase we have and we hope you like it too. There are key updates to the UI, extension support, debugging and the extensibility APIs.
...
**Note:** We have planned to ship 1.5 fully translated. Unfortunately there are some delays with the translations and we do not want to wait and make the release available earlier. We will ship an update with all the translations as soon as we have them.
