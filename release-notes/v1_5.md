...
Please note that in his release every debug session creates a new integrated terminal. In the next Release we will try to reuse an integrated terminal if possible.
