...
### File Icon Theme
The file explorer now can show file icons from *file icon themes*. File icon themes can be provided by extensions and selected by users as their favourite set of file icons. File icons are shown in the file explorer, but in the future also at other places like in tab folders.
...
Out of the box, VS code ships with one icon theme; 'Standard'. 'Standard' consists only of file and folder icons. 
![standard icon theme](images/1_5/icon-theme-standard.png)

There will be a [Seti](https://github.com/jesseweed/seti-ui) theme as an extension and we hope the community will contribute many more themes.
...
### HTML
New settings have been added to control the which built-in code completion providers are active. Use these settings if you prefer not to see the corresponding proposals.
...
### LESS
The LESS syntax validation has been brough up-to-date to support some of the features recently added to LESS. Amongst them:
...
Check out the [LESS documentation](http://lesscss.org/features/) to learn more about thee features.
