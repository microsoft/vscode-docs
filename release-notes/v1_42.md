...
* `workbench.action.openNextRecentlyUsedEditorInGroup` is now working without a picker (use `workbench.action.quickOpenNextRecentlyUsedEditorInGroup` for the old behaviour)
* `workbench.action.openPreviousRecentlyUsedEditorInGroup` is now working without a picker (use `workbench.action.quickOpenPreviousRecentlyUsedEditorInGroup` for the old behaviour)
...
`kb(workbench.action.quickOpenNextRecentlyUsedEditor)`|Open Next Recently Used Editor via Picker|`workbench.action.quickOpenNextRecentlyUsedEditor`
...
`kb(workbench.action.quickOpenNextRecentlyUsedEditorInGroup)`|Open Next Recently Used Editor in Group via Picker|`workbench.action.quickOpenNextRecentlyUsedEditorInGroup`
