...
VSCode is mostly written in TypeScript. In addition to the compiler, we use linting to enforce certain style and engineering rules. In the past we have been using TSLint for that task, but roughly a year back the maintainers of TSLint have [annouced](https://medium.com/palantir/tslint-in-2019-1a144c2317a9) its deprecation in favor of ESLint.
