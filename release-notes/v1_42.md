...
You can automatically debug commands you run in the new JavaScript Debug terminal:
...
You can [file issues](https://github.com/mifcrosoft/vscode-js-debug/issues/new) if you run into any problems.
...
In this milestone, we've made progress on the new Git Timeline view, and have an early preview to share. This is a unified view for visualizing time-series events (for example, commits, saves, test runs, etc.) for a resource (file, folder). To enable the Timeline view, you must be using the [Insiders Edition](https://code.visualstudio.com/insiders/) and then add the following setting:
