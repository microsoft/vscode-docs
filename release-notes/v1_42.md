...
### Java supports Data Breakpoints

[Data Breakpoints](https://code.visualstudio.com/updates/v1_38#_breaking-when-value-changes-data-breakpoints) was introduced in 1.38. This feature allows you to create breakpoints that will get hit when the value of the underlying variable changes. The [Debugger for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-debug) extension has now supported it. See the illustration below:

![Data Breakpoints Java](images/1_42/data-breakpoints.png)

### Java supports Call Hierarchy

A call hierarchy view shows all calls from or to a function and allows you to drill into callers of callers and call of calls. [Peek Call Hierarchy](https://code.visualstudio.com/updates/v1_40#_call-hierarchy-provider-api) feature was add in 1.40 and now is supported by Java in VS Code. Just click `Peek -> Peek Call Hierarchy` in the context menu of any function:
