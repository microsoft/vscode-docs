...
The new `CodeActionKind.Source` identifies code actions that apply to the entire file. Organize imports is a good example of a `Source` code action since it can be triggered from any position in a file.
