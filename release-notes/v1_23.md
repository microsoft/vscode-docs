...
```bash
vscode-insiders://vscode.git/clone?url=https%3A%2F%2Fgithub.com%2FMicrosoft%2Fvscode-vsce.git
```

If you'd like to try this out:

* Windows: In a Command Prompt, type: `explorer "vscode-insiders://vscode.git/clone?url=https%3A%2F%2Fgithub.com%2FMicrosoft%2Fvscode-vsce.git"`.
* macOS: In a shell, type: `open vscode-insiders://vscode.git/clone?url=https%3A%2F%2Fgithub.com%2FMicrosoft%2Fvscode-vsce.git`.
