...
* **[Languages](#languages)** - TS/JS Organize Imports action, persistent Markdown previews.
...
The Git extension also adopted the new proposed API to handle [system-wide URIs](#protocol-handler-api) and invokes Git clone on specific URIs. Here's an example URI for VS Code Insiders which clones `https://github.com/Microsoft/vscode-vsce.git`:

```bash
vscode-insiders://vscode.git/clone?repo=https%3A%2F%2Fgithub.com%2FMicrosoft%2Fvscode-vsce.git
```

If you'd like to try this out:

- Windows: In a Command Prompt, type: `explorer vscode-insiders://vscode.git/clone?repo=https%3A%2F%2Fgithub.com%2FMicrosoft%2Fvscode-vsce.git`.
- macOS: In a shell, type: `open vscode-insiders://vscode.git/clone?repo=https%3A%2F%2Fgithub.com%2FMicrosoft%2Fvscode-vsce.git`.
...
Extension authors can now add their own [view containers](#contributions-to-the-activity-bar) to the Activity Bar. Depending on your installed extensions, after an update you may see UI such as custom explorers move from the File Explorer to a new custom view container. For example, below you can see that the explorers from the [Azure App Service](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azureappservice) and [Azure Cosmos DB](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-cosmosdb) extensions have moved to a dedicated Azure view.
...
The **Terminal: Clear** command (`kb(workbench.action.terminal.clear)`) will now tell supporting shells (bash.exe, bash, zsh) to clear, as opposed to the terminal itself wiping all lines except for the one the cursor is on. This makes it so clearing should now retain all lines of multi-line prompts.
...
* [@alexglazkov9](https://github.com/alexglazkov9):  Fix #46139: Integrated terminal doesn't open when window has no folders [PR #46518](https://github.com/Microsoft/vscode/pull/46518)
* [Brett Cannon (@brettcannon)](https://github.com/brettcannon):  Allow a space between # and `region` for folding in Python [PR #46885](https://github.com/Microsoft/vscode/pull/46885)
...
* [Florian Traber (@floriantraber)](https://github.com/floriantraber):  Fix #46860: Make git delete popup modal [PR #47052](https://github.com/Microsoft/vscode/pull/47052)
* [Filip Malinowski (@fmal)](https://github.com/fmal):  Fix #47752: Set background-color explicitly instead of shorthand declaration [PR #47785](https://github.com/Microsoft/vscode/pull/47785)
* [@ivorhuang](https://github.com/ivorhuang):  Fix #24425: Start debugger on Restart if debugger is not started yet [PR #47219](https://github.com/Microsoft/vscode/pull/47219)
...
* [Kenny Le (@kennyle1412)](https://github.com/kennyle1412):  Fix #45694: Split Terminal based on workspace path [PR #46461](https://github.com/Microsoft/vscode/pull/46461)
* [Laurel Williams (@lwillia)](https://github.com/lwillia):  Fix #43240: Fix triple click on extension id selecting extra info [PR #47921](https://github.com/Microsoft/vscode/pull/47921)
* [Matt Acosta (@mattacosta)](https://github.com/mattacosta):  Fix #33132: Regenerate php functions. [PR #47865](https://github.com/Microsoft/vscode/pull/47865)
* [Dmitry Ignatovich (@mechatroner)](https://github.com/mechatroner):  Fix #44986: Move huge file params to user config [PR #44988](https://github.com/Microsoft/vscode/pull/44988)
...
* [Pascal Fong Kye (@pfongkye)](https://github.com/pfongkye):  Fix #45605 : Meaningful warning message when formatting [PR #47919](https://github.com/Microsoft/vscode/pull/47919)
...
* [Pradeep Murugesan (@pradeepmurugesan)](https://github.com/pradeepmurugesan)
  *  Fix #47892: Deleting multiple directory message [PR #47956](https://github.com/Microsoft/vscode/pull/47956)
  *  Fix #46785: Open root folder when no file is in focus and reveal in finder [PR #47090](https://github.com/Microsoft/vscode/pull/47090)
  *  Fix #46406: Add the workspace symbol provider for markdown [PR #47610](https://github.com/Microsoft/vscode/pull/47610)
* [Benas Svipas (@svipben)](https://github.com/svipben):  Fix #45479: Different border styles for high contrast [PR #46956](https://github.com/Microsoft/vscode/pull/46956)
