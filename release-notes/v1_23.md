...
The JavaScript and TypeScript organize imports feature is now out of preview. Just run **Organize Imports** (`kb(typescript.organizeImports)`) to quickly remove unused imports and sort the remaining imports in your JavaSript and TypeScript code.
...
The folding range provider proposedin 1.22 got some updated and is now official API. Language extensions can now provide syntax aware folding ranges.
