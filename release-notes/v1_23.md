...
### The Test views container

VS Code now provides a new Test views container in the Activity bar so that extensions creating Test related views can contribute to this container. This is empty and hidden by default and is shown whenever views are contributed to it.
...
![Custom views container](images/1_23/test-views-container.png)

### Contributions to Activity bar: Custom view containers

You can now group the custom views you contribute into a new view container in the Activity bar using the new contribution point `viewsContainers`.
...
You can now contribute Source Control Management related custom views into the SCM view container in the activiity bar. You can show, hide and re-order these views just like in the Explorer.
