...
* **[Improved code folding](#fold-markdown-by-heading-level)** - Syntax aware folding in CSS, HTML, JSON, and Markdown files.
* **[Error and reference navigation across files](#error-and-reference-navigation-across-files)** - F4 and F8 around files in your workspace.
* **[New Hint suggestions](#hints-in-the-editor)** - See coding 'Hint' suggestions in the editor.
* **[Convert to ES6 refactoring](#suggestion-code-actions-for-javascript-and-typescript)** - Code Action to convert to ES6 classes.
* **[Auto Attach debugging](#node-debugging)** - Automatically attach to running Node.js processes.
* **[Log Points](#log-points)** - Log diagnostic messages without breaking on your debug session.
* **[Better large file support](#easier-way-to-open-large-files)** - Faster syntax highlighting and Find and Replace.
* **[Integrated Terminal multi-line links](#better-support-for-multi-line-links)** - Paths and URLs can span lines in the terminal.
* **[PREVIEW: Organize JS/TS imports](#organize-imports-for-javascript-and-typescript)** - Quickly remove unused imports and provide sorting.
...
* **[Workbench](#workbench)** - Windows OS: scrolling improvements and auto update support.
...
You can disable this feature using the `update.enableWindowsBackgroundUpdates` configuration setting, in case you'd like the old behaviour back or if the new update procedure is somehow problematic on your machine.
...
You can now file issues on extensions from the comfort of VS Code. The issue reporter now includes a dropdown to choose whether you are reporting an issue on VS Code itself or an extension. If the extension repository is on GitHub,
similar issue search and the 'Preview on GitHub' submission button will use that repository.
...
* [Juan Camilo Giraldo Chaverra (@camilogiraldo)](https://github.com/camilogiraldo):  Better uninstall dialog for extensions with dependencies. Fix #45197 [PR #45929](https://github.com/Microsoft/vscode/pull/45929)
...
* [Daniel Frankcom (@danielfrankcom)](https://github.com/danielfrankcom)
  *  #21423 | Add underline styling to debug console [PR #46042](https://github.com/Microsoft/vscode/pull/46042)
  *  Fixes #21423 | Add ANSI colour tokens as children of existing tokens [PR #45946](https://github.com/Microsoft/vscode/pull/45946)
* [Darius Keeley (@Dari-K)](https://github.com/Dari-K):  Hide tab fade until text overflows with sizing-shrink and close-button-left/off (fix #45728) [PR #45815](https://github.com/Microsoft/vscode/pull/45815)
* [Dominik Ivosevic (@DominikDitoIvosevic)](https://github.com/DominikDitoIvosevic):  Added support for links of file paths with spaces (#13245) [PR #43733](https://github.com/Microsoft/vscode/pull/43733)
...
* [Jackson Kearl (@JacksonKearl)](https://github.com/JacksonKearl)
  ...
  *  Standardize transpose logic. Add basic support for transposing multibyte characters. [PR #45499](https://github.com/Microsoft/vscode/pull/45499)
...
* [Ievgen Andrushchak (@killerDJO)](https://github.com/killerDJO):  Enable search of local Typescript Language Service Plugins (fix #45856) [PR #45858](https://github.com/Microsoft/vscode/pull/45858)
...
* [Mika Andrianarijaona (@mikaoelitiana)](https://github.com/mikaoelitiana):  fix: change default keybinding of cursorColumnSelectUp to ctrl+shift+… [PR #41471](https://github.com/Microsoft/vscode/pull/41471)
...
* [Zim Kalinowski (@zikalino)](https://github.com/zikalino):  make sure yml extesion is default for yaml files [PR #45756](https://github.com/Microsoft/vscode/pull/45756)
...
* [AJ Richardson (@aj-r)](https://github.com/aj-r):  Fix chrome session restore promt in Windows [PR #606](https://github.com/Microsoft/vscode-chrome-debug/pull/606)
* [Chance An (@changsi-an)](https://github.com/changsi-an)
  ...
  *  Launch Chrome in unelevated state on Windows platform by using `wmic call create`. [PR #619](https://github.com/Microsoft/vscode-chrome-debug/pull/619)
* [@digeff](https://github.com/digeff)
  ...
  *  Now we report the times of the different tasks that happen until we launch and show the user page [PR #610](https://github.com/Microsoft/vscode-chrome-debug/pull/610)
...
* [@digeff](https://github.com/digeff)
  ...
  *  Now we don't wait for the global telemetry properties to be ready before sending telemetry [PR #310](https://github.com/Microsoft/vscode-chrome-debug-core/pull/310)
  ...
  *  Now we report the times of the different tasks that happen until we launch and show the user page [PR #301](https://github.com/Microsoft/vscode-chrome-debug-core/pull/301)
  *  Now we send all the telemetry properties of the start-up timings event in sentence case [PR #313](https://github.com/Microsoft/vscode-chrome-debug-core/pull/313)
  *  Fix some unexplained breakpoints behavior [PR #296](https://github.com/Microsoft/vscode-chrome-debug-core/pull/296)
  *  Updated code so now we resolve pending breakpoints onScriptParsed instead onScriptPaused when using break on load [PR #290](https://github.com/Microsoft/vscode-chrome-debug-core/pull/290)
* [Raghav Katyal (@rakatyal)](https://github.com/rakatyal):  Clearing the context immediately to avoid sending multiple remove eve… [PR #318](https://github.com/Microsoft/vscode-chrome-debug-core/pull/318)
