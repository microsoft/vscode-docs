...
The extension API now supports adding [Related Information](#support-related-diagnostics-information) to diagnostics and this is shown in all places where diagnostics are shown.
...
The [previously proposed](https://code.visualstudio.com/updates/v1_21#custom-views-reveal) API to programatically reveal nodes in custom view has been promoted to Stable.
