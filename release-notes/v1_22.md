...
With this release, we will do syntax highlighting for the viewport immediately after a file is opened, based on the scope of the content in the viewport.

*Left: VSCode 1.21, Right: VSCode 1.22*
...
This setting will enable that a language
