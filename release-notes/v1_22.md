...
* [Marek Kaczkowski (@marekkaczkowski)](https://github.com/marekkaczkowski):  Fix for debugging-jest-tests "Jest Current File" on Windows issue #85 [PR #89](https://github.com/Microsoft/vscode-recipes/pull/89)
