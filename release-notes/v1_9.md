...
MetaDescription: See what is new in the Visual Studio Code January 2018 Release (1.9)
MetaSocialImage: 1_9/release-highlights.png
---
# January 2018 (version 1.9)
...
Welcome to the first 2018 release of Visual Studio Code. There are a number of significant updates in this version that we hope you will like, some of the key highlights include:
...
These are the [closed bugs](https://github.com/Microsoft/vscode/issues?q=is%3Aissue+label%3Abug+milestone%3A"December+2017%2FJanuary+2018"%22+is%3Aclosed) and these are the [closed feature requests](https://github.com/Microsoft/vscode/issues?q=is%3Aissue+milestone%3A"December+2017%2FJanuary+2018"%22+is%3Aclosed+label%3Afeature-request) for the 1.9 update.
