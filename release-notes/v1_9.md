...
Configuration `"workbench.editor.showTabCloseButton"` has been renamed to  `"workbench.editor.tabCloseButton"` and the value changed to `"off"` if you want to disable it. 
