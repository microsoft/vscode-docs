...
* **[Markdown Preview and Editor Integration](#markdown-preview-and-editor-integration)** - Scroll syncronization bewtween a Markdown preview and its editors.
...
* Syntax highlighting for Go, Rust, and Scala code blocks in markdown files.
...
* A blue bar in the left margin of the Markdown preview indicates the currently selected line.
