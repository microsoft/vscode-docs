...
We are releasing a 1.9.1 recovery build to update the 1.9 translations and address a handful of [issues](https://github.com/Microsoft/vscode/issues?q=is%3Aissue+milestone%3A%22January+Recovery+2017%22+is%3Aclosed). 
...
Downloads: [Windows](https://vscode-update.azurewebsites.net/1.9.0/win32/stable) | [Mac](https://vscode-update.azurewebsites.net/1.9.0/darwin/stable) | Linux 64-bit: [.tar.gz](https://vscode-update.azurewebsites.net/1.9.0/linux-x64/stable) [.deb](https://vscode-update.azurewebsites.net/1.9.0/linux-deb-x64/stable) [.rpm](https://vscode-update.azurewebsites.net/1.9.0/linux-rpm-x64/stable) | Linux 32-bit: [.tar.gz](https://vscode-update.azurewebsites.net/1.9.0/linux-ia32/stable) [.deb](https://vscode-update.azurewebsites.net/1.9.0/linux-deb-ia32/stable) [.rpm](https://vscode-update.azurewebsites.net/1.9.0/linux-rpm-ia32/stable)
