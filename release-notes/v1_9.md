...
* **[Control menu visibility](#control-menu-visibility-windows-linux)** - Hide or toggle the top VS Code menu.
* **[Source Code Management](#source-code-management)** - VS Code now supports more SCM provider other than Git.
