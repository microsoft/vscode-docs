...
We have added a Welcome page (**Help** > **Welcome**) with Quick Links for new users to get started quickly as well as links to recent folders and online documentation for your returning needs. Have the **Show welcome page on startup** option checked to keep it handy:

![Welcome document](images/1_9/welcome-page.png)

The Interactive Playground available from the Welcome page introduces you in a step-by-step guide to some of our advanced code editing features with interactive examples to try next to the instructions:
