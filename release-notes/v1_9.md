...
- **Wide charcater support**: Wide characters are now sized to consume exactly 2 character widths
- **Better space utilization**: The terminals within the termianl panel should now fill up as much space as possible
