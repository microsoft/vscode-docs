...
A new setting `workbench.editor.pinnedTabsOnSeparateRow` has been added. When activated, pinned tabs are displayed on a separate row above other tabs, and they automatically pin or unpin when dragged between the tab rows.
