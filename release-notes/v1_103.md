...
In the below example, a script containing multiple prompts for user input is run via the agent. Confirmation prompts appear and I can use the provided actions to respond.
