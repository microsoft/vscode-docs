...
<table class="highlights-table">
  ...
  <tr>
    <td>Auto-start MCP servers <a href="#bookmark">Show more</a></td>
    <td>Use checkpoints to return to previously good state <a href="#bookmark">Show more</a></td>
    <td>Git worktree support <a href="#bookmark">Show more</a></td>
  </tr>
  <tr>
    <td>Use more than 128 tools in chat requests <a href="#bookmark">Show more</a></td>
    <td>Revamped tool picker <a href="#bookmark">Show more</a></td>
    <td>Highlight <a href="#bookmark">Show more</a></td>
  </tr>
</table>
...
<div class="toc-nav-layout">
  <nav id="toc-nav">
    ...
    <ul>
      <li><a href="#bookmark">Chat</a></li>
      <li><a href="#bookmark">MCP</a></li>
      <li><a href="#bookmark">Accessibility</a></li>
      <li><a href="#bookmark">Editor Experience</a></li>
      <li><a href="#bookmark">Code Editing</a></li>
      <li><a href="#bookmark">Notebooks</a></li>
      <li><a href="#bookmark">Source Control</a></li>
      <li><a href="#bookmark">Debugging</a></li>
      <li><a href="#bookmark">Tasks</a></li>
      <li><a href="#bookmark">Terminal</a></li>
      <li><a href="#bookmark">Languages</a></li>
      <li><a href="#bookmark">Contributions to extensions</a></li>
      <li><a href="#bookmark">Extension Authoring</a></li>
      <li><a href="#bookmark">Proposed APIs</a></li>
      <li><a href="#bookmark">Engineering</a></li>
      <li><a href="#bookmark">Notable fixes</a></li>
      <li><a href="#bookmark">Thank you</a></li>
    </ul>
  </nav>
