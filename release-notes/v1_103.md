...
<table class="highlights-table">
  ...
  <tr>
    <td>Revamped tool picker <a href="#tool-picker-improvements"><br>Show more</a></td>
    <td>Use checkpoints to return to previously good state <a href="#chat-checkpoints"><br>Show more</a></td>
    <td>Git worktree support <a href="#git-worktree-support"><br>Show more</a></td>
  </tr>
  <tr>
    <td>Use more than 128 tools in chat requests <a href="#improved-tool-selection-experimental"><br>Show more</a></td>
    <td>Azure DevOps remote indexing support <a href="#azure-devops-repos-remote-index-support"><br>Show more</a></td>
    <td>Dedicated view for coding agent sessions <a href="#chat-sessions-experimental"><br>Show more</a></td>
  </tr>
</table>
