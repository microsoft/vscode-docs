...
We have a new experimental setting `inlineChat.notebookAgent` that will allow the inline chat widget to use the full suite of notebook tools to allow for additional capabilities like running cells and installing packages.
