...
Terminal inline chat now better detects your active shell, even when working within subshells (e.g., launching Python or Node from PowerShell or zsh). This dynamic shell detection improves the accuracy of inline chat responses by providing more relevant command suggestions for your current environment.
