...
After the policy is enabled, organization members can [add models from built-in providers](https://code.visualstudio.com/docs/agent-customization/language-models#_bring-your-own-language-model-key) or install language model provider extensions.
