...
![Alt text](images/1_85/copilot-terminal-explain-link.png)

Activating the explain follow up will give a detailed explanation of the suggested command:

![Alt text](images/1_85/copilot-terminal-explanation.png)
