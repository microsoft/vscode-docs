...
### Sticky Scroll in Trees (Preview)
...
Copilot Chat now sees cross-file context from your codebase when you ask it to explain Rust code. To use this, select some code in your active editor, then use the **Copilot > Explain This** from the context menu or `/explain` from inline or panel chat.
