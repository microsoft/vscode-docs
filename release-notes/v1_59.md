...
By default this setting is disabled to preserve todays behaviour: if you open an editor to the side and close that editor group later only to open the editor again to the side, no view state is restored because you are opening a new editor grup.
