...
### Python
In the [Python extension](https://marketplace.visualstudio.com/items?itemName=ms-python.python), we've improved the sorting of the list of Python interpreters. In the past, virtual environments would be displayed way down at the bottom, which used to take a lot of scrolling and/or searching. Now virtual environments located on the project root are displayed first, followed by globally installed environments.
