...
Terminal profiles contributed by extensions can now be selected as the default profile.

TODO@meganrogge: Image of dropdown with (default) against a contributed profile
