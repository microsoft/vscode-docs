...
This iteration we are introducing the ability for extensions to add separators (aka "categories") to a quick pick via a proposed API. This is useful for grouping items or just having a bit of space between items:
