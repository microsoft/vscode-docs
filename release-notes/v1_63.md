...
* Avoid unnecessarily searching for `Jupyter` packages when `Jupyter` runtime isnt' required to start Kernels. ([#8350](https://github.com/microsoft/vscode-jupyter/issues/8350) [#8352](https://github.com/Microsoft/vscode-jupyter/issues/8352))
