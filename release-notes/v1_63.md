...
<video src="images/1_63/browse-themes.mp4" controls muted title="Preview Color Themes from the Marketplace"></video>
...
<video src="images/1_63/find-actions.mp4" controls muted title="Find actions in both the Search view and the editor"></video>
...
<video src="images/1_63/notebook-file-links.mp4" controls muted title="File links in a Jupyter notebook"></video>
...
<video src="images/1_63/notebook-toolbar-dynamic-label.mp4" controls muted title="Show and hide notebook toolbar labels dynamically"></video>
...
| Before | After |
|---|---|
| <video src="images/1_63/hover-providers-before.mp4" controls muted title="Hovers are rendered at the end"></video> | <video src="images/1_63/hover-providers-after.mp4" controls muted title="Hovers are rendered incrementally"></video> |
...
<video src="images/1_63/ts-method-completion.mp4" controls muted title="Completing method signatures in TypeScript"></video>
...
<video src="images/1_63/ts-attribute-completion.mp4" controls muted title="Completing JSX attribute values"></video>
...
<video src="images/1_63/md-custom-editor.mp4" controls muted title="Switching an editor tab to a Markdown preview"></video>
...
<video src="images/1_63/emmet-remove-tag.mp4" controls muted title="Emmet Remove Tag demo removing a surrounding div element"></video>
...
<video src="images/1_63/pip_install.mp4" controls muted title="Pip install in Jupyter"></video>
...
<video src="images/1_63/kernel_override_python_builtins.mp4" controls muted title="Better kernel errors in Jupyter"></video>
...
<video src="images/1_63/python-module-rename.mp4" controls muted title="Module rename with Pylance"></video>
