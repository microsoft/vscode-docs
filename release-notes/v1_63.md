...
Unlike the `Markdown: Open Preview` command, `Reopen With` does not open a new editor tab: it simple changes how an already opened editor tab is displayed. Use `Reopen With` again to switch the file back to the default text view.
