...
If you have installed the pre-release version of an extension and have extensions auto-upate enabled, VS Code automatically upates to the new pre-release version if available.
