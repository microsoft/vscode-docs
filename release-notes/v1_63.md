...
Read [this article](https://certitude.consulting/blog/en/invisible-backdoor/) or [this article](https://www.trojansource.codes/) for how invisible or confusable Unicode characters can be used in spoofing attacks.
...
To be on the safe side, thee [restricted mode](https://code.visualstudio.com/docs/editor/workspace-trust#_restricted-mode) of the workspace trust should be used to review source code, as *all* non-ASCII characters are highlighted in untrusted workspaces.
