...
We now support syntax highlighting of [fenced codeblocks](https://docs.github.com/en/github/writing-on-github/working-with-advanced-formatting/creating-and-highlighting-code-blocks) inside markdown cells:
...
In addition, markdown text that looks like an http and https is now automatically turned into a link:

![A link automatically created from text](images/1_63/notebook-bare-link.png)

This matches the behavior of other notebook renderers, such as Jupyter lab.
