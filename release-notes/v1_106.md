...
A copy button now appears in diagnostic hovers (errors, warnings, info, and hints) to make copying error messages easier.
...
The `setting(chat.tools.terminal.shellIntegrationTimeout)` setting has been deprecated in favor of this consolidation.
...
You can now manage your authentication accounts directly from the Command Palette using the new **Manage Accounts** command. This command provides access to account management features even when the Account menu is hidden or not easily accessible.
