...
<table class="highlights-table">
  ...
  <tr>
    <td>Plan complex coding tasks with built-in plan agent <a href="#agents"><br>Show more</a></td>
    <td>Select from deleted code in diff editor <a href="#code-editing"><br>Show more</a></td>
    <td>Manage MCP server access <a href="#mcp-server-access-for-your-organization"><br>Show more</a></td>
  </tr>
  <tr>
    <td>Create and monitor across various background agents <a href="#agents"><br>Show more</a></td>
    <td>Enjoy the refreshed product icons <a href="#editor-experience"><br>Show more</a></td>
    <td>Manage Linux devices with JSON policies <a href="#"><br>Show more</a></td>
  </tr>
</table>
