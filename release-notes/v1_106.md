...
#### Search
Agent sessions panel now support search to help you easily find your sessions.

<video src="images/1_106/sessionsPaneSearch.mp4" title="Title" autoplay loop controls muted></video>
...
### Multi file diff editor now supports navigation

Just like you can navigate to next or previous changes in diff editor for single file, you can now do so across files in the mutl--file diff editor. Use keybindings or the navigation up and down arrow keys to review your changes across files.

<video src="images/1_106/multiFileDiffNav.mp4" title="Title" autoplay loop controls muted></video>

## Notebooks

### Search
Notebooks now supports searching across cells. Use key bindings (F3 and Shift-F3) to navigate to next and previous match just like you would in editor.

<video src="images/1_106/notebookSearch.mp4" title="Title" autoplay loop controls muted></video>
