...
### Agent Sessions from Chat Extension

In this release we have migrated the integration of Agent Sessions off of the GitHub Pull Request extension and into the core Chat extension to provide a more native experience.
This paves the way for smoother transitions and interactions between VS Code and GitHub Misson Control such as opening an Agent Session directly from the Agent Sessions view in the browser and vice versa.
