...
Learn more about the [Agent Sessions view](https://code.visualstudio.com/docs/agents/run/sessions/manage-sessions/#_agent-sessions-view) in the VS Code documentation.
