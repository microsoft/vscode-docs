...
This release has some big infrastructure changes for Visual Studio Code. We've updated to the latest Electron shell (version 1.3.7) and now include TypeScript 2.0.  We added programmatic access to user and workspace settings and you'll see this is action in several places in the UI (**File** > **Auto Save**, **Configure File Associations**). And we're continuing to improve Extension management (**Configure Workspace Recommended Extensions**) which we feel is critical for a flexible and powerful editor. All of this work puts VS Code in great shape for us and our extension partners moving forward.

Here are some other highlights:

* **Workbench**: File Icons added to OPEN EDITORS and Tabs. Automatic detection of corrupted installation.
* **Editor**: Format On Save, Vim style relative line numbers.
* **Languages**: New TypeScript 2.0 language features as well as simplified typings installation.
* **Extensions**: Create workspace recommended Extension lists. Extension packs to automatically include dependencies.
* **Debugging**: Support for running NPM and other script runners on launch. Glob pattern support for easier Source Map setup.
