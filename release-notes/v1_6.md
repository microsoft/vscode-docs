...
* **[Editor](#editor)** - Format On Save, search term history, Auto save menu item, Streamlined file associations, Unicode improvements, Improvements to LineNumber and Whitespace settings.
...
>**Note:** When navigating through the release notes, you can always use `kb(cursorTop)` to return here to the top.
...
<a class="scroll-to-top" id="scroll-to-top" onclick="scroll(0,0)">
