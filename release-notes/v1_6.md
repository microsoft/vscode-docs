...
We are releasing a 1.6.1 recovery build to add the final 1.6 release translations and fix several important [issues](https://github.com/Microsoft/vscode/milestone/31?closed=1).
