...
## Extension Authoring <a name="extension-authoring"></a>
...
---|-------|----------
Search||
`kb(find.history.showNext)`|Show Next Search Term|`find.history.showNext`
`kb(find.history.showPrevious)`|Show Previous Search Term|`find.history.showPrevious`
`kb(toggleSearchCaseSensitive)`|Toggle Search Case Senstive|`toggleSearchCaseSensitive`
`kb(toggleSearchRegex)`|Toggle Search regex|`toggleSearchRegex`
`kb(toggleSearchWholeWord)`|Toggle Search Whole Word|`toggleSearchWholeWord`
Integrated Terminal||
`kb(workbench.action.terminal.scrollUpPage)`|Integrated Terminal Scroll Up|`workbench.action.terminal.scrollUpPage`
`kb(workbench.action.terminal.scrollDownPage)`|Integrated Terminal Scroll Down|`workbench.action.terminal.scrollDownPage`
`kb(workbench.action.terminal.clear)`|Integrated Terminal Clear|`workbench.action.terminal.clear`
Extensions||
`kb(workbench.extensions.action.configureWorkspaceRecommendedExtensions)`|Configure Workspace Recommended Extensions|`workbench.extensions.action.configureWorkspaceRecommendedExtensions`
`kb(workbench.extensions.action.showWorkspaceRecommendedExtensions)`|Show Workspace Recommended Extensions|`workbench.extensions.action.showWorkspaceRecommendedExtensions`
