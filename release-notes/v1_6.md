...
* **[Search term history](#search-term-history)** - past search terms are available in the search dialog.
...
* **[VIM style relative line numbers](#improvements-to-linenumber-and-whitespace-settings)** - line numbers can be shown relative to the current cursor position.
...
There are of course many other updates in this release as well, read on for the complete list...
...
* **[Miscellaneous](#miscellaneous)** - Improving command discoverability, new location for dirty indicator in tabs mode, Electron update, Bundled extension support, Corrupt install notification, Improvements in issue reporting, Mac OS Sierra update.
...
* **[Thank You](#thank-you)** - each release we accept community contributions into the code base.
