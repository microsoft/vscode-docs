...
* **[API for Settings](#new-apis)** - it's now possible to change settings via an API, this allows new options like persistent [autosave](#auto-save-menu-item), and [file associations](#file-associations-configuration).
* **[VIM style relative line numbers](#improvements-to-llinenumber-and-whitespace-settings)** - line numbers can be shown relative to the current cursor position.
