...
>**Note:** On Windows make sure to specify the executable with the correct extension, e.g. use `npm.cmd` instead on just `npm` which exists but is the shell script for linux and macOS.
