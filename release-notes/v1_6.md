...
MetaSocialImage: 1_6_release-highlights.jpg
---
...
* **[TypeScript 2.0](#typescript-20)** - Language improvements for [JavaScript](#javascript) and [TypeScript](#typescript) as well as [extension authoring](#extension-authoring).
...
* **[*PREVIEW*  TS/JS Grammar](#preview-typescriptjavascript-grammar)** - A new colorizer for TS/JS with over 200 fixes. We will include it in the next release.
...
<img alt="Switch windows using command palette" style="max-width:580px" src="images/1_6/switch-window-animation.gif"/>
...
>**Note:** On Windows make sure to specify the executable with the correct extension, for example use `npm.cmd` instead on just `npm` which exists but is the shell script for Linux and macOS.
