...
Creating an extension authored in JavaScript now also uses the new support to use NPM for managing typeing files.

`yo code` new creates a workspace that recommends to install the eslint extension. 
