...
This release has some big infrastructure changes for Visual Studio Code and several useability imporvements. 
...
Ok lets move onto some fo the specific items...
...
The randomization for the experiments is done once per stable/insiders release stream.  The net effect of this for exisitng users is that you may notice these new commands in the empty editor window as well.  We really want to aid in the discovery of sever of the products key features so you should expect to see us tweek this a little as time goes on.
