...
To improve the transition between text and merge editors we no longer disable the old inline conflict decorators. When the new merge editor opens, you can get the previous experience with a single click in the editor toolbar. Files under conflict now have a new button **Open in Merge Editor** to open the new merge editor directly, regardless of the setting `git.mergeEditor`:

![Use 'Open File' in the merge editor to see old decorators](images/1_71/merge-editor-transition.gif)
