...
<video src="images/1_71/mergeHint.mp4" controls muted title="Conflicting files shows a hint to open in the merge editor"></video>
...
<video src="images/1_71/merge-editor-open-file-old-decorators.mp4" controls muted title="Use Open File in the merge editor to see old decorators"></video>
...
<video src="images/1_71/merge-editor-side-by-side.mp4" controls muted title="The new and old merge experiences can be used at the same time"></video>
...
<video src="images/1_71/codec.mp4" controls muted title="A notebook playing an mp4 video file"></video>
...
<video src="images/1_71/renameToggle.mp4" controls muted title="A file in the Explorer being renamed demonstrating that subsequent presses of the F2 key toggle selecting various pieces of the file name"></video>
...
<video src="images/1_71/sticky-scroll-ctrlclick.mp4" controls muted title="Sticky scroll Ctrl/Cmd click to go to a symbol definition"></video>
...
<video src="images/1_71/suggestMatchWordStart.mp4" controls muted title="IntelliSense demo with and without match on word start"></video>
...
<video src="images/1_71/comments-filtering.mp4" controls muted title="Comments filtering"></video>

### Editor decoration

The Comments editor gutter decoration now uses codicons and has new styling.

<video src="images/1_71/comments-editor-decoration.mp4" controls muted title="Comments editor gutter decoration"></video>
...
<video src="images/1_71/screenshot_paste.mp4" controls muted title="Pasting an image file into a Markdown cell in a Jupyter notebook."></video>
...
<video src="images/1_71/pylance-notebooks-lsp.mp4" controls muted title="Writing Python code showing auto import, auto complete suggestions, extract method, and a rename symbol functionality."></video>
...
<video src="images/1_71/live-preview-multi-root-demo.mp4" controls muted title="Live Preview multi-root demo"></video>
...
<video src="images/1_71/md-link-update.mp4" controls muted title="Markdown file links are updated on move and rename"></video>
...
<video src="images/1_71/settings-profiles-temp.mp4" controls muted title="Temporary Settings Profile demo"></video>
...
<video src="images/1_71/continue-on-codespaces.mp4" controls muted title="Continue On in GitHub Codespaces"></video>
