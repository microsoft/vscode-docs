...
TODO: @Tyriar screenshot of various underlines

Included in this is improved underline rendering when GPU acceleration is enabled which avoids the glyph and the underline overlapping:

TODO: @Tyriar screenshot of zoomed underline

This is currently not supported on Windows due to [an outstanding issue in ConPTY](https://github.com/microsoft/terminal/issues/7228).
