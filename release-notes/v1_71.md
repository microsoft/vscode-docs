...
To try this out, set `"workbench.experimental.editSessions.enabled": true` in your settings, enable [Settings Sync](https://code.visualstudio.com/docs/editor/advanced/settings-sync), and run the **Edit Sessions: Sign In** command in VS Code for the Web or desktop.
