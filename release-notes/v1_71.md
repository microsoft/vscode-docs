...
### Windows 7 support EOL

Windows 7 [extended end date](https://docs.microsoft.com/en-us/lifecycle/products/windows-server-2008-r2) was announced to be January, 2020 and Node.js was blocked to run on this OS version since v14+. However, Electron continues to support this version by patching libuv and attempts to align the EOL timeline with [Google Chrome](https://cloud.google.com/blog/products/chrome-enterprise/extending-chrome-on-windows-7-to-support-enterprise-customers). With Electron 19 update the libuv patch has [regressed](https://github.com/electron/electron/issues/35219). We don't have plans to fix the patch in Electron and instead recommend users to update newer Windows version for consuming VSCode desktop application. We have also removed the OS version from our [supported platform list](https://code.visualstudio.com/docs/supporting/requirements#_platforms) in favor of this change.
