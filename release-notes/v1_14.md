...
* `emmet.showExpandedAbbreviation`
    ...
    Control the Emmet suggestions that show up in the suggestion/completion list by updating this setting.
...
We made some improvements to the indentation rules in the 1.9 release. With this release, language extension authors can put the indentation rules to `language-configuration.json` file instead of registering them in the extension activation phase.
