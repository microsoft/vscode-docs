...
VS Code 1.14 better filters JavaScript suggestions to only include those you typically care about while workin in plain old JavaScript:
...
VS Code 1.14 includes initial support for refactoring JavaScript and TypeScript. The first supporeted refactoring converts a JavaScript ES5-style function class to an ES6 class:
