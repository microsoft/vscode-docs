...
The new `markdown.preview.breaks` setting controls the rendering of line breaks in the markdown preview. When you enable it, all new lines in paragraphs are converted into `<br>` tags in the output html. 

By default, single line breaks in markdown paragraphs and ignored.

![Markdown preview normally ignores single line breaks](images/1_14/md-no-breaks.png)

By setting `"markdown.preview.breaks": true`, single line breaks are converted rendered as new lines:
