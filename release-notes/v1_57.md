...
![Running git show will result in the terminal's title changing to git](images/1_57/terminal-titleMode-executable)

When this is set to `sequence`, the title will be based on what the shell sets it to.
