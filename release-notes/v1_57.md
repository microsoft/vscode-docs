...
If this context menu is interfering with an extension in your webview, you can prevent it from showing up by calling `preventDefault` on the `contextmenu` event:
