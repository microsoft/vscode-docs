...
* **[Markdown preview scrolling](#markdown-preview-bi-directional-scroll-synchronization)** - Markdown preview now supports bi-directional scrolling.
...
>You can also check out this 1.21 release [highlights video](https://youtu.be/WPIecjgOTpE) from Cloud Developer Advocate [Brian Clark](https://twitter.com/_clarkio).
...
* **[Debugging](#debugging)** Breakpoint icons.
...
* **[Engineering](#engineering)** - Duplicate issue detection.
