...
* **[Markdown Preview Scrolling](#)** - our Markdown preview now supports bi-directional scrolling.
* **[Improved Large File Support](#)** - additional optimizations in how we handle the text buffer.
...
* **[PREVIEW: Horizontal Search rtesults](#)** - you can now view search results in a horizontal pannel.
...
* **[Workbench](#workbench)** - Automatically create subfolders, improved NPM script detection, symbolic links displayed in explorer.
* **[Editor](#editor)** - Emmet filter improvements, improved breakpoint icons.
...
```
## Preview Features
Preview features are fully functional but hidden behind a setting.  We welcome your feedback and are working to clean-up the feature before making it more broadly available.
