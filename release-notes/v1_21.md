...
We added a dedicated [Refactoring](https://code.visualstudio.com/docs/editor/editing/refactoring) topic describing VS Code's support for refactorings such as **Extract Method**, **Extract Variable**, and **Rename Symbol**.
