...
To get these completions automatically without the manual trigger, enable the quick suggestions feature for strings in html files by adding the below to your settings:
```
"[html]": {
