...
To use esbuild in existing extensions check out the guides in the [bundling extensions](https://code.visualstudio.com/api/working-with-extensions/bundling-extension.md) as well as in the [web extensions](https://code.visualstudio.com/api/extension-guides/web-extensions.md) guides.

A sample also can be found at [vscode-extension-samples/esbuild-sample](https://github.com/microsoft/vscode-extension-samples/esbuild-sample).
