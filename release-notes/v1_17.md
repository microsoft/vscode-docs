...
JavaScript and TypeScript have provided intellisense for import paths ever since VS Code 1.9, however you may you have known about this because it required manually triggering the intellisense while typing the import. With VS Code 1.17, we now automatically show module and path suggestions as soon as you start typing an `import` or `require` path:
...
### Improved colorization of regular expressions and embedded languages in Dark+ and Light+ themes

VS Code's builtin Dark+ and Light+ themes now highlight regular expression components so that they can be more easily identified:
