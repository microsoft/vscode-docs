...
To learn more, check out our [snippet grammar](https://code.visualstudio.com/docs/editor/customizing/userdefinedsnippets#_snippet-syntax) to see what you can do and then get creative.
