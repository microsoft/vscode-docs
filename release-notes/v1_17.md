...
There is a new `Source Control Providers` section which gives you an overview of your
...
You can now use the `scm/sourceControl` menu id to contribute commands to the inline source control
provider rows in the new `Source Control Providers` section of the SCM view. Only context menu
commands are supported for now.
