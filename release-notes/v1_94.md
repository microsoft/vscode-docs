...
This iteration a new experimental setting called `setting(editor.experimentalEditContextEnabled)` has been made introduced. This setting enables the use of the [EditContext API](https://www.w3.org/TR/edit-context/) to power the editing experience in VS Code. The adoption of the [EditContext API](https://www.w3.org/TR/edit-context/) has allowed us to fix certain IME composition bugs. Generally we believe it will improve the editing experience on the long term, and ultimately it will be enabled by default.
