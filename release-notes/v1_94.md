...
In order to leverage this, simply trigger a log in (either with a built-in feature like Settings Sync or with an Extension) and you'll be given the option to log in to a different account.
