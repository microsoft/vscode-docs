...
### Semantic Search in the Search View (Preview)
**Setting**: `setting(github.copilot.chat.search.semanticTextResults)`.

We've added semantic search in the search view in preview. This feature allows you to search for text in the search view using natural language queries leveraging Copilot. After enabling this setting, you will see an expandable node in your search results to trigger the semantic search.
