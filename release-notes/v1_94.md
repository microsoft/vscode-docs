...
<video src="images/1_94/chat-file-complete.mp4" title="File suggestions when typing #filename" controls muted></video>

### Improved file links in chat responses

We've improved the rendering of any workspace file paths that are mentioned in Copilot responses. These paths are very common when  you ask [`@workspace`](https://code.visualstudio.com/docs/chat/copilot-chat#_chat-participants) questions.
...
<video src="images/1_94/copilot-path-dnd.mp4" title="Dragging and dropping a workspace file from copilot into the editor" controls muted></video>
...
<video src="images/1_94/copilot-attach-dnd.mp4" title="Dragging files and editors into chat" controls muted></video>
...
<video src="images/1_94/copilot-in-REPL.mp4" title="Using Copilot Inline Chat in the native REPL editor" controls muted></video>
...
<video src="images/1_94/notebook-accept-run.mp4" title="Accept and run generated code directly from Inline Chat" controls muted></video>
...
<video src="images/1_94/notebook-kernel-variable.mp4" title="Attach a context variable by using `#` in a notebook chat request" controls muted></video>
...
<video controls src="./images/1_94/semantic-search-in-search-view.mp4" title="Semantic Search in Search View" controls muted></video>
...
<video src="images/1_94/file-explorer-find.mp4" title="Searching for files in explorer find" controls muted></video>
...
<video src="images/1_94/notebook-multi-cursor.mp4" title="Notebook multi cursor demo" controls muted></video>
