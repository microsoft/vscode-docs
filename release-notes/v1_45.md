...
One of our team's top priorities is making Visual Studio Code a more accessible product and improving experiences for every user, so we have created a new Gitter channel for VS Code accessibility: https://gitter.im/Microsoft/vscode-a11y. We encourage users to join and directly give our team feedback, voice problems, and share accessibility practices.
