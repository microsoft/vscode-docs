...
* **[GitHub authentication support](#git-authentication-for-github-repositories)** - Automatic Git authentication for GitHub repositories.
...
The new `terminal.integrated.wordSeparators` setting let you customize the separator characters used to delimit a word when you double-click in the terminal.
...
### Git authentication for GitHub repositories
...
The product icons that ship with VS Code are contained in the [Codicon icon font](https://github.com/microsoft/vscode-codicons) and form the **default** product icon theme. Extensions can now provide new product icon themes to redefine these icons and give VS Code a new appearance.
