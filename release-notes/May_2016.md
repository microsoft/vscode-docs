...
- Thanks to a Pull Request (see below) there is now support for quick fixing some TSLint warnings.
- Thanks to another Pull Request there is now support to exclude files from linting.
