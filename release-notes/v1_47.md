...
The arguments `performSearch` and `focusResults` haave been added to search editors to allow keybindings to configure wheather a saarch should be run automatically, and further if the results of that search should be start out focused rather than the query.
