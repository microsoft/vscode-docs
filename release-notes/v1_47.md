...
The `search.searchEditor.defaultNumberOfContextLines` setting has been updated to have a defualt value of 1 instead of 0, meaning 1 context line will be shown before and aafter each result line in the search editor. To go back to the old behavior this can be changed back to 0.
