...
The arguments `performSearch` and `focusResults` have been added to search editors to allow keybindings to configure wheather a search should be run automatically, and further if the results of that search should be start out focused rather than the query.
