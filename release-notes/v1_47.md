...
Date: 2020-7-9
DownloadVersion: 1.47.1
---
# June 2020 (version 1.47)

**Update 1.47.1**: The update addresses this security [issue](https://github.com/microsoft/vscode/milestone/128).
...
* [Jupyter Notebook Debugging with the Xeus Kernel](https://github.com/microsoft/vscode-simple-jupyter-notebook/blob/master/README.md) sample
...
A full list of notable changes can be found in the [README](https://github.com/microsoft/vscode-hexeditor/blob/master/README.md). Any feedback or issues experienced can be filed against the [vscode-hexeditor repository](https://github.com/microsoft/vscode-hexeditor).
