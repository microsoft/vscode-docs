...
* **[Windows ARM builds](#stable-windows-arm-build)** - Windows on ARM is now available in stable.
* **[New JavaScript debugger](#new-javascript-debugger)** - Debug in the terminal, multi target support.
...
* Remote - Containers and Remote - WSL: Check out the recent [Using Remote Containers in WSL 2](https://code.visualstudio.com/blogs/2020/07/01/containers-wsl) blog post.
