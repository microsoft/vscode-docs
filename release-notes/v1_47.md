...
### Search Editor: Default Context Lines

The setting `search.searchEditor.defaultNumberOfContextLines` has been added to configure the numer of context lines to use when creating new search editors. The default for this value has been set to 1, which is a change from prior iterations where it was 0.
