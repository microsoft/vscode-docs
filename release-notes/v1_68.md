...
VS Code now bundles [TypeScript 4.7.3](https://devblogs.microsoft.com/typescript/announcing-typescript-4-7/). This major TypeScript brings new language features including [improved Control-Flow Analysis](https://devblogs.microsoft.com/typescript/announcing-typescript-4-7/#control-over-module-detection) and support for [ECMAScript Module Support in Node.js](https://devblogs.microsoft.com/typescript/announcing-typescript-4-7/#ecmascript-module-support-in-node-js). It also includes new tooling features and fixes a number of important bugs!
...
However some codebases like haing some degree of manual control over how their imports are organized. Grouping external vs internal imports is one of the most common examples of this:
...
Yuck! This happens because all of the imports are being sorted alphabetically, and we even try preserving comments and newlines while doing so.
