...
For users who set their browser to one of our core supported languages, https://vscode.dev will automatically apply translations in that language.

For example, if I were to configure my language in Edge, I'd do so here:
