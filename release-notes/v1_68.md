...
A GitHub Action and an Azure DevOps Task are available for running a repository's dev container in continuous integration (CI) builds. This allows you to reuse the same setup you are using locally for development to build and test your code in CI. See the [documentation](https://github.com/devcontainers/ci/blob/main/README.md) for more details.
