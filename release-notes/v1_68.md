...
### Minimum contrast ratio improvements
...
* Persist shell `status` such that [`bash-git-prompt` and other programs now work](https://github.com/microsoft/vscode/issues/146377)
* Allow the use of a [custom `ZDOTDIR` for `zsh`](https://github.com/microsoft/vscode/pull/148635)
* Fix [decorations getting out of sync on slower machines](https://github.com/microsoft/vscode/issues/145801)
* Improve handling of [existing debug traps in bash](https://github.com/microsoft/vscode/issues/146873)
* [Polish messaging](https://github.com/microsoft/vscode/issues/148839) by removing the activation message from the buffer in favor of a `How does this work?` command action and activation status in the tab hover
