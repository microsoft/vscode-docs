...
We are releasing a 1.8.1 recovery build to address a handful of [key issues](https://github.com/Microsoft/vscode/issues?q=is%3Aissue+milestone%3A%22November+Recovery+2016%22+is%3Aclosed) before the end of year. Thank you for helping us find them quickly! 

* Removed 'Focus Default Settings' command in an invalid context. ([#17468](https://github.com/Microsoft/vscode/issues/17468))
* Fixed Quick Outline in Default Keyboard Shortcuts. ([#17376](https://github.com/Microsoft/vscode/issues/17376))
* Fixed an issue with savings file on a mounted drive. ([#17345](https://github.com/Microsoft/vscode/issues/17345))
* Resolved an issue with Copy command in certain contexts. ([#17232](https://github.com/Microsoft/vscode/issues/17232))
* Solved a problem scrolling in large minified files. ([#17208](https://github.com/Microsoft/vscode/issues/17208))

There is no action needed from you. VS Code will automatically update when we release the build. Additionally, you can download the new build using the links below. 
