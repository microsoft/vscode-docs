...
* **[Hot Exit](#hot-exit)** - VS Code now remembers unsaved files.
* **[Configurable Activity Bar](configurable-activity-bar)** - Arrange the Activity Bar icons to your liking.
* **[Git clone](#git-clone-support)** - Clone your repo from within VS Code.
* **[Distraction Free Mode](#distraction-free-mode)** - Focus on just your source code with Distraction Free Mode.
* **[New Selection Menu](#selection-menu)** - Easily discover and use the editor selection commands. 
* **[JavaScript IntelliSense in HTLM](#javascript-support-in-html)** - Get full JavaScript language support in HTML files.
