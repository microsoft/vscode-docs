...
The [Agents window](https://code.visualstudio.com/docs/agents/run/agents-window) is a dedicated companion window optimized for exploring, iterating on, and reviewing agent sessions across projects and machines. This release brings new ways to organize the sessions list and keep a busy list of sessions manageable.
