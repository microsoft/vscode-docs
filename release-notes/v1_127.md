...
![Screenshot showing the + New Chat button in the multi-chat session header.](images/1_127/multi-chat-session-new-chat-action.png)
...
![Screenshot showing the multi-chat session tab strip with the trailing + button and the Conversations dropdown listing chats with checkboxes to show or hide them.](images/1_127/multi-chat-session-chat-actions.png)

![Screenshot showing the Delete Chat action in the right-click context menu of a multi-chat session tab.](images/1_127/multi-chat-session-delete-chat-action.png)
...
![Screenshot showing the consistent Workspace and Changes pills in the session header.](images/1_127/session-header-pills.png)
...
<img width="1462" height="652" alt="Screenshot showing troubleshoot results for an agent host session in the Agents window." src="https://github.com/user-attachments/assets/f2878194-469a-41bf-b38f-5687730bc56e" />
...
![Screenshot showing the credit usage hover for a subagent section in a chat response.](images/1_127/subagent_cost_hover.png)
...
![Screenshot showing the sandboxing toggle available in the Default Approvals mode.](images/1_127/sandboxing-toggle.png)
...
<img src="images/1_127/browser-permission-prompt.png" alt="Screenshot showing a system dialog where app.zoom.us requests microphone access, with options to Allow, Block, or Cancel." width="282" height="221" />
