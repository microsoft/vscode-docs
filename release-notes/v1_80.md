...
`Open Accessible View` `kb(editor.action.accessibleView)` allows screen reader users to inspect content character by character, line by line. Invoke this when a hover or panel chat response is focused.
