...
### Remote menu
This milestone, we have updated the remote menu with entries to help you quickly install and get started with a remote connections (SSH, Remote Tunnels, GitHub Codespaces, etc.). We have also added a **Connect to...** start entry on the Welcome page to help you get started with remote connections. 
