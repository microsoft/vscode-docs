...
The new context menu for images in the Markdown preview allows you to copy the image from the preview and paste it into the Markdown editor. When copying the image, the preview editor must be focused.
...
You can ask Copilot to create workspaces for popular project types in VS Code.
...
You can ask Copilot to create Jupyter notebooks based on your requirements in VS Code.
