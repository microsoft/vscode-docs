...
`kb(workbench.action.terminal.clear)`|Clear Terminal|`workbench.action.terminal.clear`
Extensions||
`kb(workbench.extensions.action.updateAllExtensions)`|Update All Extensions|`workbench.extensions.action.updateAllExtensions`
`kb(workbench.extensions.action.openExtensionsFolder)`|Open Extensions Folder|`workbench.extensions.action.openExtensionsFolder`
Navigation||
`kb(workbench.action.focusActiveEditorGroup)`|Focus Active Editor Group|`workbench.action.focusActiveEditorGroup`
`kb(workbench.action.switchWindow)`|Switch Window (Instance)|`workbench.action.switchWindow`
Help||
