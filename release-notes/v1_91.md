...
The **Apply In Editor** command on a code block in panel chat uses the language model to find the best way to apply the changes to the current editor.

![The Apply In Editor command](images/1_91/apply-in-editor.png)
