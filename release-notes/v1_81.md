...
Thanks to a community contribution, the JavaScript debugger now supports the [Fast Node Manager](https://github.com/Schniz/fnm) in its runtime version. Users of FNM can now use the `runtimeVersion` property of the `launch.json` to select the Node.js version to use.
