...
The panel inline terminal tab that shows when there is a single terminal now uses the custom hover.
...
* **Conversational chat**: The Quick Chat experience has been updated to show your full conversation while still keeping the last question and answer in focus.
...
* `quickQuestion` - Show the Chat icon in the title bar to launch the Quick Chat.
