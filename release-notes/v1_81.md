...
You can now apply a setting to all profiles by clicking on the `Apply Setting to All Profiles` action in the Settings editor.
...
You can now apply an extension to all profiles by clicking on the `Apply Extension to All Profiles` action in the Extensions view.
