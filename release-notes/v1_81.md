...
<video src="images/1_81/closed-notebook-search.mp4" controls muted title="Closed notebook rich content search"></video>
...
<video src="images/1_81/notebook-large-output.mp4" controls muted title="Large streaming output performance"></video>
...
<video src="images/1_81/nb-sticky-scroll.mp4" controls muted title="Notebook editor sticky scroll demo"></video>
...
<video src="images/1_81/inputontop.mp4" controls muted title="Quick Chat UX improvements"></video>
...
<video src="images/1_81/slash-commands.mp4" controls muted title="Usability improvements to slash commands"></video>
...
<video src="images/1_81/notebook-cell-generation-fix-diagnostic.mp4" controls muted title="Iterative fixing for a Copilot generated notebook"></video>
...
<video src="images/1_81/debugpy-args-prompt.mp4" controls muted title="Debugging a Python file providing arguments through the 'Python: File with Arguments' configuration with the Debugpy extension"></video>
...
<video src="images/1_81/connect-to-codespace.mp4" controls muted title="Connect to Jupyter Server on GitHub Codespaces"></video>
...
<video src="images/1_81/continue-on-codespace.mp4" controls muted title="Using Continue On to move to a GitHub Codespace"></video>
