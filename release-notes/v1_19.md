...
Bug fixes as well as community PRs still resulted a great list of updates. Here are some of the release highlights:

* **[Performance](#performance)** - Faster perceived startup.
* **[Servicability/Diagnostics](#serviceability)** - New VS Code diagnostics and logging.
...
* **[New debugging recipes](#debugging-recipes)** - Learn how to debug Next.js, Meteor projects and applications using Nodemon projects.
...
* **[Debugging](#debugging)** - Undefine env variables per session, better VARIABLES rendering, edit break point command.
...
* Use the faster list widget instead of the tree when possible, [#38638](https://github.com/Microsoft/vscode/issues/38638). We re-worked the breakpoints view and the open editors explorer section.
...
* [Native Crash Issues](https://github.com/Microsoft/vscode/wiki/Native-Crash-Issues) - tracking down native crashes
