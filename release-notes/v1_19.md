...
* "Edit breakpoint" to breakpoint view context menu
TODO@Isi

* Missing option for hiding the new debug launcher from the statusbar
TODO@Isi

* Open Debug View on Launch
TODO@Isi
...
* debug console log API made official
TODO@Andre

### Debug contributions in package.json

* More finegrained debugger activation (onDebugInitialConfigurations and onDebugResolve)
TODO@Andre
