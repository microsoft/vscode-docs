...
We've added several new debugging [recipes](https://github.com/Microsoft/vscode-recipes) for the Next.js & Meteor frameworks, AspNetCore.SpaTemplates, and as well as debuging when Node using Nodemon. See [Debugging Recipes](https://code.visualstudio.com/docs/nodejs/debugging-recipes) for links to these recipes and helpful blog posts.
