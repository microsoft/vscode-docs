...
We now use [Yarn](https://yarnpkg.com/en/) to manage our production and development dependencies. This has greatly improved the setup time it takes to prepare a VS Code repository, both for development as well as build purposes. More details in the [Pull Request](https://github.com/Microsoft/vscode/pull/38481).
