...
* **[Performance](#performance)** - Faster startup and other general improvements.
...
* Use the faster list widget instead of the tree when possible [#38638](https://github.com/Microsoft/vscode/issues/38638). Re-worked the BREAKPOINTS view and the OPEN EDITORS Explorer section.
...
VS Code now displays TypeScript code-style errors as warnings. This applies to:
...
Treating these as warnings is consistent with how other tools, such as TSLint. These will still be displayed as errors when you run `tsc` from the command line.
