...
`tab.unfocusedActiveForeground`|Active tab foreground color in an inactive group. Tabs are the containers for editors in the editor area. Multiple tabs can be opened in one editor group. There can be multiple editor groups..
`tab.unfocusedInactiveForeground`|Inactive tab foreground color in an inactive group. Tabs are the containers for editors in the editor area. Multiple tabs can be opened in one editor group. There can be multiple editor groups.
...
Key|Description
---|-------
`panel.background`|This color was never really working well because the editor and tree used in panels did not pick up the background.
