...
* Register a provider using the [TreeDataProvider](/docs/extensionAPI/vscode-api.md#TreeDataProvider) API.
* Contribute actions to view using `view/title` and `view/item/context` locations in [menus](/docs/extensionAPI/extension-points.md#contributesmenus) extension point.
