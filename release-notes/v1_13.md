...
We would also like to congratulate and thank the Brazilian Portuguese community localization team! With the effort from the team, localization is now completed in Transifex. Translation has been integrated into the [Insiders build](https://code.visualstudio.com/insiders) for testing. Depending on the progress of validation, we hope to soon integrate the translations into the stable builds for Brazilian customers.
