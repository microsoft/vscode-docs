...
* [ESLint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint): Major performance improvements to lower CPU load when linting large JS files with lots of code actions (e.g. auto fix suggestions).
