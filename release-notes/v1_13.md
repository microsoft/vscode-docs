...
### HC theme improvements
We have improved the High Contrast theme to include more token colors and to use selection and status bar colors which provide a clearer contrast.
...
### Install additional SCM providers action
We have introduced an action to make it easier to discover and install SCM providers from the extension gallery.
