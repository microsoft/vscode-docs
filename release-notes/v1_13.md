...
The `Open TS Server Log` command now reveals the TypeScript log directory on your operating systems instead of trying to open the log file in VS Code. This is useful for collecting the additional typings installer log files generated alongside the main `tsserver.log` file.
