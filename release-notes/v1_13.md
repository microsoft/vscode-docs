...
### Added `Go to Implementation` and `Go to Type Definition` to the Go Menu

The `Go` menu now includes actions for `Go to Implementation` and `Go to Type Definition`:

![SCM Providers](images/1_13/go-menu.png)
