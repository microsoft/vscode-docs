...
For keyboard centric users who want to navigate up and down long documentation, press `kb(editor.action.triggerSuggestionFocus)` to move the focus to the documentation fly-out such that it can now receive keyboard shortcuts for Page Up/Down actions.
