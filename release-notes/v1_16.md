...
The terminal find widget now support find history. You can use `kb(workbench.action.terminal.findWidget.history.showNext)` and  `kb(workbench.action.terminal.findWidget.history.showPrevious)` to show next or previous find term in the find widget.
