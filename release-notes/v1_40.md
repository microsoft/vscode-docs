...
<video src="images/1_40/activity-bar-indicator.mp4" title="Video showing Active Activity Bar indicator." autoplay loop controls muted></video>
...
<video src="images/1_40/window-border.mp4" title="Video showing Animated image showing the use of the new window border colors." autoplay loop controls muted></video>
...
<video src="images/1_40/split-distribute.mp4" title="Video showing splitSizing with distribute value." autoplay loop controls muted></video>

Change this setting to `split` for the current editor to be split in half and not affect the size of other editors:

<video src="images/1_40/split-split.mp4" title="Video showing splitSizing with split value." autoplay loop controls muted></video>
...
<video src="images/1_40/minimap-scaling.mp4" title="Video showing Animated image showing the ability to resize the minimap." autoplay loop controls muted></video>
...
<video src="images/1_40/definition-preview-hover.mp4" title="Video showing Animated image showing the use of the new Show Definition Preview Hover command." autoplay loop controls muted></video>
...
Before:<br/>
<video src="images/1_40/unicode-before.mp4" title="Video showing Animation showing cursor movement before." autoplay loop controls muted></video>

After:<br/>
<video src="images/1_40/unicode-after.mp4" title="Video showing Animation showing cursor movement after." autoplay loop controls muted></video>
...
<video src="images/1_40/diff-editor-show-whitespace-button.mp4" title="Video showing Animation for button that shows when comparing two files that contain only whitespace diffs but the diff editor is configured to ignore trim whitespace." autoplay loop controls muted></video>
...
<video src="images/1_40/command-navigation.mp4" title="Video showing Command navigation jumps to nearest command after scrolling." autoplay loop controls muted></video>
...
<video src="images/1_40/scm-highlight.mp4" title="Video showing SCM view highlighting the active file." autoplay loop controls muted></video>
...
<video src="images/1_40/untracked.mp4" title="Video showing Git untracked files." autoplay loop controls muted></video>
...
<video src="images/1_40/clone.mp4" title="Video showing Git clone progress." autoplay loop controls muted></video>
