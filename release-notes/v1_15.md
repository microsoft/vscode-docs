...
You can find more information about the new markdown preview security levels [in the VS Code markdown docs](https://code.visualstudio.com/docs/languages/markdown#markdown-preview-security)
