...
* CSS: Name the custom Emmet snippets in CSS such that they only contain letters from the snippet value, so that the fuzzy matching algorithm of the suggestion list can make the right match.
