...
Visual Studio Code 64 bit builds are now available on Windows for everyone! They come in the usual installer format as well as a zip archive.

> **Note:** If you are using the **Setup Installer**, you'll need to uninstall the 32 bit version before you install the 64 bit one.

Hit these download links to get it:
