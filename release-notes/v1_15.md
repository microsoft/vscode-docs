...
Two iterations ago, we introduced the new Emmet model which users could opt into. This gave Emmet abbreviation expansions in suggestion/auto-completion list as well as multi cursor support for most of the Emmet commands. 

![Emmet abbreviation expansion in autocomplete](images/1_13/emmet.gif)

In this milestone, we are switching over to this new model for all users. Please read more on the why and the how about this on the [Emmet 2.0 blog post](/blogs/2017/08/07/emmet-2.0.md)
