...
You can always re-order, collapse/expand, or hide any of these sections either by using the `Open View...` option in the `View` menu or by using the context menu in the Extensions view.
