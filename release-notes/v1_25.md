...
* [Michael Crane (@mrcrane)](https://github.com/mrcrane)
  * Bump -core version [PR #688](https://github.com/Microsoft/vscode-chrome-debug/pull/688)
  * Set chrome PID in all launch cases [PR #687](https://github.com/Microsoft/vscode-chrome-debug/pull/687)

Contributions to `vscode-node-debug2`:

* [@digeff](https://github.com/digeff): Updated -core and bumped version [PR #194](https://github.com/Microsoft/vscode-node-debug2/pull/194)
