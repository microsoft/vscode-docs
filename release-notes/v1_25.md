...
You can always re-order, collapse/expand, or hide any of these sections by using the context menu in the Extensions view. You can also use the `Open View...` option in the `View` menu to show/hide these sections.
