...
The Inspector can be useful for debugging Language extensions. You can ask users to attach logs to their bug reports and use the Inspector to analyze the logs. 
