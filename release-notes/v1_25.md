...
Until now, the default view for the Extensions view contained a section for **Installed** extensions and another for **Recommended** extensions. The presence of installed but disabled extensions was hard to see so we now provide a new default where the **Installed** (but not disabled) extensions are shown first, followed by a section for **Recommended** extensions and at the bottom, a collapsed section for **Disabled** extensions.
