...
<video src="images/1_92/panel-top.mp4" title="Move Workbench Panel to the top" controls muted></video>
...
<video src="images/1_92/override-profile.mp4" title="Override existing Profile" controls muted></video>
...
<video src="images/1_92/auto-update-review.mp4" title="User consent required to update extension with no code to a version with code" controls muted></video>
...
<video src="images/1_92/settings-editor-nojitter.mp4" title="Settings Editor not jumping after setting check mark checked" controls muted></video>
...
<video src="images/1_92/notebook-multi-cell-comment.mp4" title="Notebook Multi Cell Commenting" controls muted></video>
...
<video src="images/1_92/md-paste-link-update.mp4" title="Links being updated when copy and pasting between Markdown files" controls muted></video>
...
<video src="images/1_92/css-paste-url.mp4" title="Dropping and pasting an image file to insert a url()" controls muted></video>
...
<video src="images/1_92/terminal_cd_flow.mp4" title="Completing directories will complete the final \, and refresh the completions for that directory" controls muted></video>
...
<video src="images/1_92/terminal_run_on_enter.mp4" title="Typing 'cd ..' only requires a single Enter key press" controls muted></video>
...
<video src="images/1_92/terminal_scripts_code.mp4" title="Completions are much less in the way now, not breaking your muscle memory" controls muted></video>
...
<video src="images/1_92/terminal_git_flow.mp4" title="Git completions show for subcommands like branch and will immediately complete branches that were just created" controls muted></video>
