...
A new slash command, `/runCommand`, enables searching for and executing a core VS Code command. It can be configured with <code codesetting="github.copilot.chat.runCommand.enabled">github.copilot.chat.runCommand.enabled</code>.
