...
* [Copilot uses GPT-4o](#gpt-4o-upgrade-for-copilot-chat) - GitHub Copilot Chat upgraded to OpenAI's GPT-4o.
...
We are rolling this out gradually for Copilot Chat users. Once it's enabled for your machine, you'll might see a message at the end of the response with a **View matches** link. If you select the link, an editor opens that shows you the details of the matching code references with more details.
