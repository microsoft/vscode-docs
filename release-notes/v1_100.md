...
Learn more about [instruction files](https://code.visualstudio.com/docs/agent-customization/overview#_instruction-files) in our documentation.
...
Learn more about [prompt files](https://code.visualstudio.com/docs/agent-customization/overview#_prompt-files-experimental) in our documentation.
...
You can also use [custom instructions](https://code.visualstudio.com/docs/agent-customization/overview#_custom-instructions) to hint when and how to use this tool, as shown in the following example:
...
Learn more about [MCP support in VS Code](https://code.visualstudio.com/docs/agent-customization/mcp-servers).
