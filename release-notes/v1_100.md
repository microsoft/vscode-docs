...
* **Performance optimization**
  * Receive faster responses for repeat requests with prompt caching ([more...](#conversation-history-summarized-and-optimized-for-prompt-caching)).
  * Get faster agent mode edits with GPT 4.1 and o4-mini ([more...](#faster-agent-mode-edits-with-gpt-41)).

* **Chat**
  * Tailor AI to your coding style with instructions files and prompts ([more...](#prompt-and-instructions-files)).
  * Expand chat with built-in tools for GitHub code search, extensions, notebooks ([more...](#search-code-of-a-github-repository-with-the-githubrepo-tool)).
  * Use MCP tools with Streamable HTTP and image output ([more...](#mcp-support-for-streamable-http)).

* **Configure VS Code**
  * Optimize your multi-window flow with compact floating windows ([more...](#floating-windows-compact-and-always-on-top-mode)).
  * Quickly identify staged changes with editor decorations ([more...](#quick-diff-decorations-for-staged-changes)).
...
**Instructions files** (also known as custom instructions or rules) provide context and rules, typically describing code guidelines or specifying which framework to use. You can then apply these instructions to your chat requests.
