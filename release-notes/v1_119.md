...
Learn how to [monitor agent usage with OpenTelemetry](https://code.visualstudio.com/docs/agents/guides/monitoring-agents) in the VS Code documentation.
...
[Copilot CLI](https://code.visualstudio.com/docs/agents/agent-types/copilot-cli) and [Claude agent](https://code.visualstudio.com/docs/agents/agent-types/third-party-agents) responses in the Chat view now show the model and its multiplier on each response. The badge appears live as each response completes, without needing to reload the window, and updates when you switch models mid-session.
...
Learn more about [agent sandboxing](https://code.visualstudio.com/docs/agents/concepts/trust-and-safety#_agent-sandboxing) in the VS Code documentation.
