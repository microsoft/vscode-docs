...
> [!NOTE]
> Our eval harness includes workspace state in the initial prompt context, so we do not expect the model to double-check the workspace, unless the task requires it.
