...
* [Cosmos DB](https://learn.microsoft.com/azure/cosmos-db/mongodb-introduction) let's you host your MongoDB databases in Azure.

* [Kubernetes](https://kubernetes.io/) and [Kubernetes in Azure](https://learn.microsoft.com/azure/container-service/container-service-kubernetes-walkthrough).
