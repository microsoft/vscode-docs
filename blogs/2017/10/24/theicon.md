...
MetaSocialImage: /assets/blogs/2017/10/24/blueicon.webp
Date: 2017-10-24
...
![Windows and macOS stable blue icon](blueicon.webp)
...
![Early VS Code icon designs](earlydesigns.webp)

None of these really stood out for us, except the one in the upper right corner.

![Early VS Code icon designs](editorlinesicon.webp)
...
![Variations on the infinity design](variationsoninfinity.webp)

Including one that will hurt your eyes:

![A variation that hurts the eyes](hurtsmyeyes.webp)
...
![Pre-release icons in orange](orangeprerelease.webp)
...
![Border iterations](outlines.webp)
...
![Insiders with the green macOS icon](insidersgreenwindows.webp)
...
![Original blue infinity icon](originalblueicon.webp)
...
![GitHub Issue 35683](newvscodeiconuglyissue.webp)

![GitHub issue 35783](vscodenewlogoissue.webp)
...
![Blue stable icons](blueicon.webp)

Which works well with the Status Bar and other blues in the editor:

![Stable drop of VS Code with the blue icon](stablewithblue.webp)
...
![screenshot of Sim Daltonism app with the Deuteranomaly effect](colorrecognition.webp)
