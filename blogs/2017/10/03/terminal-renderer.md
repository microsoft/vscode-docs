...
![Characters to the right of the terminal could become misaligned when Unicode was used](2017_09_28_misaligned.png)
...
![Only individual character changes are now drawn to the screen](2017_09_28_paint-flashing.gif)
...
![Behind the scenes an image is maintained containing the most common characters](2017_09_28_texture-atlas.png)
...
![60 frames per second is now possible in the terminal](2017_09_28_60fps.gif)
