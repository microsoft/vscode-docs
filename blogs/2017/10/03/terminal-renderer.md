...
![Characters to the right of the terminal could become misaligned when Unicode was used](misaligned.webp)
...
<video src="paint-flashing.mp4" title="Video showing Only individual character changes are now drawn to the screen." autoplay loop controls muted></video>
...
![Behind the scenes an image is maintained containing the most common characters](texture-atlas.webp)
...
<video src="60fps.mp4" title="Video showing 60 frames per second is now possible in the terminal." autoplay loop controls muted></video>
