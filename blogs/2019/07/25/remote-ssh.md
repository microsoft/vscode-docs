...
MetaSocialImage: /assets/blogs/2019/07/25/social-remote-ssh.webp
Date: 2019-07-25
...
![Remote SSH architecture](architecture-ssh.webp)
...
![Create a virtual machine](create-vm.webp)
...
![Virtual machine instance details](vm-instance-details.webp)
...
![ssh-keygen output](ssh-keygen.webp)
...
![Add SSH public key to VM](add-ssh-public-key.webp)
...
![Virtual machine auto-shutdown](vm-auto-shutdown.webp)
...
![Remote extension commands](remote-commands.webp)
...
![Virtual machine public IP address](vm-public-ip-address.webp)

Set the user and hostname in the connection information text box.

![Set user and host name](set-user-host.webp)
...
![Initializing VS Code Server](init-vs-code-server.webp)
...
![SSH indicator in Status bar](ssh-status-bar.webp)
...
![Remote button on Activity bar](remote-on-activity-bar.webp)
...
![Checking uname in the terminal](check-uname.webp)
...
![Remote open folder](remote-open-folder.webp)
...
![Intellicode extension installed remotely](intellicode-installed-remotely.webp)
...
![Enter the port to forward](enter-port.webp)

Name the connection "browser":

![Name the port](name-port.webp)
...
![Hello Remote World in a browser](hello-world-browser.webp)
...
![Debugging over SSH](debug-hello-world.webp)
