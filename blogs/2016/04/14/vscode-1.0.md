...
Today, Visual Studio Code delivers on many of the aspects that we imagined during incubation. VS Code has great editing and navigation [experiences](/docs/editing/editingevolved), streamlined [debugging](/docs/editor/debugtest/debugging), and built-in [Git support](/docs/sourcecontrol/overview).
