...
![vscode-icons extension](vscode-icons.webp)
...
![select icon theme](select-icon-theme.webp)
...
![minimal icon theme](minimal-icon-theme.webp)
...
![I heart seti](i-heart-seti.webp)
...
![Seti icon theme](seti-icon-theme.webp)
