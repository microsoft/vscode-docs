...
[Download the Insiders build](https://code.visualstudio.com/Download#insiders-downloads) today! Again, you only need to install it once and it will update itself when we push new builds each month.
