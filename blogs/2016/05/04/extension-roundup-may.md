...
If you are new to VS Code extensions, check out the [docs](/docs/editor/extensions/extension-marketplace.md) for instructions on finding and installing new extensions.
