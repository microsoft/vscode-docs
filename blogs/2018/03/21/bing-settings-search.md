...
PageTitle: How We Improved VS Code Settings Search
MetaDescription: How We Improved VS Code Settings Search
MetaSocialImage:
Date: 2018-03-21
ShortDescription: Learn what's new with settings search in Visual Studio Code
Author: Rob Lourens
---
# How We Improved VS Code Settings Search
...
There are essentially two sides to this system - collecting and indexing setting details, and serving up results. The first part of that is called the Ingestion Service. It's responsible for creating a rich index containing settings from VS Code itself and from extensions. Since we want query response time to be as short as possible, we do as much work as possible up front while ingesting settings to reduce the work we have to do while handling the query.
