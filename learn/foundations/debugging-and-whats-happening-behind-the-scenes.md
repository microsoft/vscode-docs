...
That's the full foundation: harness, model, context, tools, prompt, sessions, and the debugging layer. In the [final guide](build-your-first-app-with-agent-mode), you will put everything together and build a real application from scratch.
