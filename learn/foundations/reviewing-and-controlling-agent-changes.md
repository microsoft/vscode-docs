...
![Files changed bar showing the list of agent-edited files in chat](../images/foundations/files-changed.png)
...
![Per-change controls showing Keep and Undo actions for individual edits in the diff view](../images/foundations/per-change-controls.png)
...
![Top-level Keep All controls for accepting all agent changes](../images/foundations/keep-all.png)
...
![Editing a previous chat message in VS Code to update the original prompt](../images/foundations/edit-message.png)
...
![Edited previous chat message in VS Code showing an updated prompt requirement](../images/foundations/edited-message.png)
...
![Steer with Message option in the VS Code Send button dropdown while an agent is running](../images/foundations/steer.png)
...
![Restore Checkpoint control in VS Code chat for rolling back an agent session to an earlier state](../images/foundations/checkpoint.png)
...
![Fork control in VS Code chat for creating a new session from an earlier checkpoint](../images/foundations/fork.png)
...
![Using the /fork command in the VS Code chat input to create a new session from the current point](../images/foundations/slash-fork.png)
...
* [Create and manage chat sessions](https://code.visualstudio.com/docs/agents/run/sessions/manage-sessions)
