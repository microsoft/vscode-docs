...
![Screenshot of the arcade app builder custom agent selected in Copilot Chat](../images/customizations/ep-8-2-arcade-agent.png)
...
![Screenshot of the initial Repo Analyzer app generated by the custom agent](../images/customizations/ep-8-3-repo-analyzer-initial-view.png)
...
![Screenshot of the Repo Analyzer app showing a code quality score and recommendations for a repository](../images/customizations/ep-8-1-repo-analyzer.png)
...
![Screenshot of Copilot Chat confirming that SOLID principles were applied during code generation](../images/customizations/ep-8-4-solid.png)
