...
![Screenshot showing the Chat view with the Configure Tools button in the chat input.](../../docs/chat/images/chat-tools/agent-mode-select-tools.png)
...
![Screenshot showing the tool picker drop-down with built-in tools, MCP servers, and user-defined tool sets.](../../docs/chat/images/chat-tools/chat-tools-picker.png)
