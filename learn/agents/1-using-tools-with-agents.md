...
[![Watch Using Tools with Agents on YouTube (opens in new tab).](images/1-using-tools-with-agents/youtube-wZrQ0TAfpFg.jpg)](https://www.youtube.com/watch?v=wZrQ0TAfpFg)
