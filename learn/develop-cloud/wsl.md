...
![WSL extension](images/wsl/remote-wsl.png)
...
Check out WSL in action:

<img src="https://github.com/microsoft/vscode-remote-release/blob/main/docs/images/remote-wsl-open-code.gif?raw=true" alt="Using the WSL extensio with an Ubuntu distro on WSL" aria-hidden="true" class="thumb"/>
