...
Your development environment is where you do your coding. Visual Studio Code allows you to use a development environment different than your local computer through a container, separate (or remote) machine, or the Windows Subsystem for Linux (WSL). This is known as [remote development](https://code.visualstudio.com/docs/remote/remote-overview).
...
Check out the docs in this section to learn more about each of the remote development extensions in Visual Studio Code.