...
Since VS Code is easy to customize, Professor Dodds is able to tailor the editor for his students, preferring to hide [IntelliSense](/docs/editor/intellisense), or suggestive code completions, so they can learn from what they type and reinforce the conceptual models being built.
