...
Installing an extension pack in a remote context, which is not tagged as an UI extension, will now install any packed UI extensions in local machine as well.
