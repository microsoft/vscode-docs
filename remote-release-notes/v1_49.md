...
### Support for Docker Compose when cloning repository in volume

Cloning a repository in a volume (`F1` > `Remote-Containers: Clone Repository in Container Volume...`) now also supports DevContainers using Docker Compose.
