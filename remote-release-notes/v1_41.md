...
You can now try a Dev Container sample in a single step. Run the **Dev Containers: Try a Development Container Sample...** command and select the repository you want to try.
