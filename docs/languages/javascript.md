...
Debug Node.js in VS Code using the built-in debugger. Setup is easy and you can read a walk-through for Node.js debugging [here](/runtimes/nodejs.md#debugging-your-express-application).
