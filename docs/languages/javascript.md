...
**React Native** examples often use the experimental **Object Rest/Spread** operator. If you want to use it, it is recommended that you disable the built-in syntax checking (see below).
