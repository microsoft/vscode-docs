...
For developers new to Java or new to VS Code, we provide some tips. Once you've installed the [Extension Pack for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack), you can open the tips from within VS Code with the **Java: Tips for Beginners** command from the Command Palette.
