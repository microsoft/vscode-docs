...
Schemas and schema associations can also be defined by an extension. Check out the [jsonValidation contribution point](/docs/extensionAPI/contribution-points.md#contributesjsonvalidation).
