...
The HTML formatter is based on the [jsbeautifiery](http://jsbeautifier.org/). The formatting options offered by that library are surfaced in the VS Code [settings](/docs/getstarted/settings.md):
