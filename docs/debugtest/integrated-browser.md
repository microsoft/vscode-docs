...
MetaDescription: Use the integrated browser in VS Code to preview and debug web apps, comment on page elements, and share screenshots or console logs with AI chat.
