...
Next, you'll create a `launch.json` file to configure VS Code to launch the Microsoft C++ debugger when you press `kb(workbench.action.debug.start)` to debug the program.
