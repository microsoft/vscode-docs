...
[![Watch Installing MinGW to build C++ code on Windows on YouTube (opens in new tab).](images/config-mingw/youtube-oC69vlWofJQ.jpg)](https://www.youtube.com/watch?v=oC69vlWofJQ)
...
1. Add the path of your ucrt64 `bin` folder to the Windows `PATH` environment variable by using the following steps:
...
You can also enable [Auto Save](/docs/editing/codebasics.md#save--auto-save) to automatically save your file changes, by selecting **File** > **Auto Save**.  You can find out more about the other views in the {% data variables.product.prodname_vscode_shortname %} [User Interface documentation](/docs/editing/getting-started/userinterface.md).
