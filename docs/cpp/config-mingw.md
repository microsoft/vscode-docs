...
3. Choose **C/C++: g++.exe build and debug active file** from the list of detected compilers on your system (you'll only be asked to choose a compiler the first time you run `helloworld.cpp`).
   ...
   ![C++ debug configuration dropdown](../languages/images/cpp/select-gcc-compiler.png)
...
1. Select **C++ (GDB/LLDB)**.
   ![screenshot of debug environment list](../languages/images/cpp/select-environment.png)
1. Select **g++ build and debug active file** from the list of detected compilers on your system.
    ![C++ debug configuration dropdown](../languages/images/cpp/select-gcc-compiler.png)
