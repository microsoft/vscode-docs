...
- [Data Science project template](/docs/editor/profiles.md#data-science-profile-template) - Create a new [profile](/docs/editor/profiles) with a curated set of extensions, settings, and snippets.
