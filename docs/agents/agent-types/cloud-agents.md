...
1. Select the session type dropdown, and select **Cloud** to continue the session as a cloud agent.
    ...
    If you're using the [Plan agent](/docs/agents/planning.md), you can select **Continue in Cloud** from the **Start Implementation** dropdown to run the plan implementation in a cloud agent session
