...
* **Context window**: as you chat, the session accumulates context. Creating a new session clears the history and starts a fresh context window. You can [monitor context window usage](/docs/chat/copilot-chat-context.md#monitor-context-window-usage) in the chat input box.
...
* **Session insights**: query your session history to generate standup reports, get tips, and search past work. Learn more about [session insights](/docs/agents/sessions/session-insights.md).
