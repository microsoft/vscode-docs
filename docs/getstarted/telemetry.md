...
**Usage Data** - Usage data collects information about how features are used and perform in VS Code, which helps the team prioritize future product improvements.
