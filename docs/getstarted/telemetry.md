...
When events are created, metadata provides details about telemetry classification, purpose, and any special handling. The sections below describe these fields.
