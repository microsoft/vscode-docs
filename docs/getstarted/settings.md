...
// Integrated Terminal
    ...
    // Whether to allow menubar mnemonics (eg. alt+f) to trigger the menubar. Note that this will cause all alt keystrokes to skip the shell when true. This does nothing on macOS.
