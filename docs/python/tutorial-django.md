...
1. In the `templates/hello` folder, create `about.html`, use the snippet to insert the boilerplate markup, insert `About us` and `About page for the Visual Studio Code Django tutorial.` in the "title" and "content" blocks, respectively, then save the file.
