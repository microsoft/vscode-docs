...
| python.disableInstallationCheck | `false` | Specifies whether to suppress warnings when using an OS-installed Python interpreter, and whether to disable the check for any Python installation on the computer.|
