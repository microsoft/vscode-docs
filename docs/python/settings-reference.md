...
| python.terminal.launchArgs | `[]` | Launch arguments given the Python interpreter when running a file where each element that's separated by a space is a separate item in the list. |
...
| autopep8Args| `[]` | Arguments for autopep8where each element that's separated by a space is a separate item in the list. | [Editing - Formatting](/docs/python/editing.md#formatting) |
| blackPath | `"black"` | Path to black | [Editing - Formatting](/docs/python/editing.md#formatting) |
| blackArgs| `[]` | Arguments for black, where each element that's separated by a space is a separate item in the list. | [Editing - Formatting](/docs/python/editing.md#formatting) |
| yapfPath | `"yapf"` | Path to yapf | [Editing - Formatting](/docs/python/editing.md#formatting) |
| yapfArgs| `[]` | Arguments for yapf, where each element that's separated by a space is a separate item in the list. | [Editing - Formatting](/docs/python/editing.md#formatting) |
...
| pylintArgs | `[]` | Additional arguments for Pylint, where each element that's separated by a space is a separate item in the list. | [Linting](/docs/python/linting.md) |
...
| pep8Args | `[]` | Additional arguments for pep8, where each element that's separated by a space is a separate item in the list. | [Linting](/docs/python/linting.md) |
...
| flake8Args | `[]` | Additional arguments for flake8, where each element that's separated by a space is a separate item in the list. | [Linting](/docs/python/linting.md) |
...
| mypyArgs | `["--ignore-missing-imports", "--follow-imports=silent"]` | Additional arguments for mypy, where each element that's separated by a space is a separate item in the list. |[Linting](/docs/python/linting.md) |
...
| pydocstyleArgs | `[]` | Additional arguments for pydocstyle, where each element that's separated by a space is a separate item in the list. | [Linting](/docs/python/linting.md) |
...
| prospectorArgs | `[]` | Additional arguments for prospector, where each element that's separated by a space is a separate item in the list. | [Linting](/docs/python/linting.md) |
...
| pylamaArgs | `[]` | Additional arguments for pylama, where each element that's separated by a space is a separate item in the list.  | [Linting](/docs/python/linting.md) |
...
| unittestArgs | `["-v", "-s", ".", "-p", "*test*.py"]` | Arguments to pass to unittest, where each element that's separated by a space is a separate item in the list. | [Unit testing](/docs/python/unit-testing.md) |
...
| pyTestArgs | `[]` | Arguments to pass to PyTest, where each element that's separated by a space is a separate item in the list. When debugging unit tests with pytest-cov installed, include `--no-cov` in these arguments. | [Unit testing](/docs/python/unit-testing.md) |
...
| nosetestArgs | `[]` | Arguments to pass to Nose, where each element that's separated by a space is a separate item in the list. | [Unit testing](/docs/python/unit-testing.md) |
