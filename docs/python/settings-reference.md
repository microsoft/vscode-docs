...
| --- | --- | --- |
| tagFilePath | `"${workspaceRoot}/.vscode/tags"` | Fully qualified path to tag file (an exuberant ctag file), used to provide workspace symbols. |
...
| enabledWithoutWorkspace | `true` | Specifies whether to perform linting without a workspace open. | [Linting](/docs/python/linting.md) |
| lintOnTextChange | `true` | Specifies whether to lint as you type. | [Linting](/docs/python/linting.md) |
...
| outputWindow | `"Python"` | The output window in which to display linting messages. | [Linting](/docs/python/linting.md) |
