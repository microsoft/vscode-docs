...
| python.terminal.launchArgs | `[]` | Launch arguments given the Python interpreter when running a filewhere each element that's separated by a space is a separate item in the list. |
