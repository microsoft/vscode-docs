...
| python.terminal.activateEnvInCurrentTerminal | `false` | Specifies whether to activate the current open terminal when the Python extension is activated, using the virtual environment selected. |
