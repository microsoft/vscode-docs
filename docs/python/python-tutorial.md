...
>**Note**: If you don't have admin access, an additional option for installing Python on Windows is to use the Microsoft Store. The Microsoft Store provides installs of [Python 3.7](https://www.microsoft.com/en-us/p/python-37/9nj46sx7x90p), [Python 3.8](https://www.microsoft.com/en-us/p/python-38/9mssztt1n39l), [Python 3.9](https://www.microsoft.com/en-au/p/python-39/9p7qfqmjrfp7), and [Python 3.10](https://www.microsoft.com/en-us/p/python-310/9pjpw5ldxlz5). Be aware that you might have compatibility issues with some packages using this method.
