...
>**Note**: Environment definition files are not read by the Python extension. Unless Visual Studio Code documentation states otherwise, these only affect certain files as per their definition.
