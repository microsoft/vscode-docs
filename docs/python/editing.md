...
In this overview, we will describe the specific editing features provided by the [Python extension](https://marketplace.visualstudio.com/items?itemName=ms-python.python), including steps on how to customize these features via user and workspace [settings](/docs/editor/settings.md).
...
For more on IntelliSense generally, see [IntelliSense](/docs/editor/editing/intellisense.md).
...
You can also customize the general behavior of autocomplete and IntelliSense, even disable the features completely. You can learn more in [Customizing IntelliSense](/docs/editor/editing/intellisense.md#customizing-intellisense).
...
- [IntelliSense](/docs/editor/editing/intellisense.md) - Learn about IntelliSense features.
