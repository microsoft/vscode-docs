...
1. Start using Copilot in VS Code!
    ...
    Learn the basics with the [VS Code Tutorial](/docs/agents/agents-tutorial.md).
...
* Continue with the [Quickstart for using AI](/docs/agents/agents-tutorial.md) to discover the key features for AI-powered development in VS Code.
