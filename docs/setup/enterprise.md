...
| `ChatToolsEligibleForAutoApproval`   | Controls which agent tools are eligible for [automatic approval](/docs/copilot/chat/chat-tools.md#tool-approval). Tools set to `false` always require user approval and can't be auto-approved. | `chat.tools.eligibleForAutoApproval`          | 1.107           |
