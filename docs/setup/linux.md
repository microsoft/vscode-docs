...
To learn more about JavaScript and Node.js, see our [Node.js walkthrough](/docs/nodejs/nodejs-tutorial.md) where you'll learn about running and debugging Node.js applications with VS Code.
