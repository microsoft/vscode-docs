...
You may see the terms "folder" and "workspace" used interchangeably in {% data variables.product.prodname_vscode_shortname %} documentation, issues, and community discussions. Think of a workspace as the root of a project that has extra {% data variables.product.prodname_vscode_shortname %} knowledge and capabilities.

> **Note:** It is also possible to open {% data variables.product.prodname_vscode_shortname %} without a workspace. For example, when you open a new {% data variables.product.prodname_vscode_shortname %} window by selecting a file from your platform's **File** menu, you will not be inside a workspace. In this mode, some of {% data variables.product.prodname_vscode_shortname %}'s capabilities are reduced but you can still open text files and edit them.

## How do I open a {% data variables.product.prodname_vscode_shortname %} "workspace"?

You can open a workspace by using the **File** > **Open Folder...** menu, and then selecting a folder.

Alternatively, if you launch {% data variables.product.prodname_vscode_shortname %} from a terminal, you can pass the path to a folder as the first argument to the `code` command for opening. For example, use the following command to open the current folder (`.`) with {% data variables.product.prodname_vscode_shortname %}:
...
You don't have to do anything for a folder to become a {% data variables.product.prodname_vscode_shortname %} workspace other than open the folder with {% data variables.product.prodname_vscode_shortname %}. Once you open a folder, {% data variables.product.prodname_vscode_shortname %} automatically keeps track of configuration, such as your open files or editor layout. When you reopen that folder in {% data variables.product.prodname_vscode_shortname %}, the editor will be as you left it previously.
...
*A multi-root workspace opened in {% data variables.product.prodname_vscode_shortname %}*
...
You can flexibly add or remove folders in your workspace. Start off by opening a folder in {% data variables.product.prodname_vscode_shortname %}, and then later add more folders as you see fit.
...
Refer to [tasks](/docs/debugtest/tasks.md) and [debugging](/docs/debugtest/debugging.md) chapters for a more comprehensive overview of how to use tasks and launch configurations in {% data variables.product.prodname_vscode_shortname %}.
...
### Why is {% data variables.product.prodname_vscode_shortname %} restoring all untitled workspaces on a restart?

Untitled workspaces are designed to be something you must explicitly decide to keep or not. The first time an untitled workspace is created, {% data variables.product.prodname_vscode_shortname %} adds the specified folders into the workspace file and also adds all existing workspace settings. This user data is always restored and displayed in a {% data variables.product.prodname_vscode_shortname %} window until the untitled workspace is saved or deleted.
...
It is possible to leave the `folders` section of a `.code-workspace` file empty so that you end up with an instance of {% data variables.product.prodname_vscode_shortname %} that does not show any root folders. You can still store workspace settings and even tasks or launch configurations in this case.

### Does {% data variables.product.prodname_vscode_shortname %} support projects or solutions?

{% data variables.product.prodname_vscode_shortname %} doesn't have the concept of a "project" or "solution" as they are sometimes defined in other development tools, such as Visual Studio IDE. You might see the term "project" used in {% data variables.product.prodname_vscode_shortname %} documentation, but it usually means "the thing you're working on". Depending on your programming language or framework, the toolset itself might support something called a "project" to help define build configurations or enumerate included files.
