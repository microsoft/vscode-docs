...
* [User Interface](/docs/editing/getting-started/userinterface.md) - In case you missed a basic orientation around {% data variables.product.prodname_vscode_shortname %}.
