...
1. Add more files to your workspace and notice that each file opens a new Editor tab.
    ...
    You can open as many editors as you like and view them side by side vertically or horizontally. Learn more about [side by side editing](/docs/editing/getting-started/userinterface.md#side-by-side-editing).
