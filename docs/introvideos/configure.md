...
* [User and Workspace Settings](/docs/editor/customizing/settings.md) - Configure user and workspace settings.
* [Key Bindings](/docs/editor/customizing/keybindings.md) - See the default keyboard shortcuts (key bindings) for editing, navigation, and more.
* [Snippets](/docs/editor/customizing/userdefinedsnippets.md) - Create your own custom snippets.
* [Themes](/docs/editor/customizing/themes.md) - Change your Color Theme to customize VS Code's background text and language syntax colorization.
