...
DateApproved:
MetaDescription: Use custom dataset to finetune a generative AI model in the Azure cloud or locally with GPUs. Deploy the finetuned model to the Azure cloud or download adapter file.
MetaSocialImage:
---
...
![Command: Focus on Resource View](./images/finetune/command-focus-resource-view.png)
