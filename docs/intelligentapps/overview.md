...
| [Profiling](/docs/intelligentapps/profiling) | Diagnose the CPU, GPU, NPU resource usages of process, ONNX model on different Execution Provider and Windows ML events. | ![Screenshot showing the Profiling tool](./images/overview/profiling.png) |
