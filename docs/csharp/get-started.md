...
MetaDescription: Getting Started with C# and .NET Development in {% data variables.product.prodname_vscode %}
---
# Getting Started with C# in {% data variables.product.prodname_vscode_shortname %}

This getting started guide introduces you to C# and .NET for {% data variables.product.prodname_vscode %} through the following tasks:

1. Installing and setting up your {% data variables.product.prodname_vscode_shortname %} environment for C#.
1. Writing and running a simple "Hello World" application using C#.
1. Introduce you to other learning resources for C# in {% data variables.product.prodname_vscode_shortname %}.

Keep in mind, that this guide won't teach you C#. Instead, it teaches you how to get set up for C# development in {% data variables.product.prodname_vscode_shortname %}. If you're looking for resources to learn C#, check out the free C# Certificate from freeCodeCamp.
...
### Installing {% data variables.product.prodname_vscode_shortname %} and extensions

1. If you haven't already done so, [install {% data variables.product.prodname_vscode_shortname %}](https://code.visualstudio.com).
...
>**Note**: C# Dev Kit supports cloud native development. To do cross-platform mobile and desktop development, you can use C# Dev Kit with the [.NET MAUI extension](https://aka.ms/mauidevkit-marketplace). Learn [how to get set up](https://aka.ms/mauidevkit-docs) with .NET MAUI in {% data variables.product.prodname_vscode_shortname %}.
...
1. [Learn to build with .NET in {% data variables.product.prodname_vscode_shortname %}](https://learn.microsoft.com/training/paths/build-dotnet-applications-csharp/)
