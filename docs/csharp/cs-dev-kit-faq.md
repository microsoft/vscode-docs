...
[Learn more about configuring VS Code settings](/docs/editor/customizing/settings.md) and see below for an example of a custom timeout in a `settings.json` file. In this example, the custom timeout value is 180 seconds, or 3 minutes:
