...
If simple variable substitution isn't enough, you can also get input from the user of your task by adding an `inputs` section to your `tasks.json` file. An input has the properties:
...
Below is an example that illustrates both types of `inputs` using Angular CLI:
