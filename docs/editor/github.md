...
If you are not redirected to VS Code, you can add your authorization token manually. In the browser window, you will recieve your authorization token. Copy the token, and switch back to VS Code. Click **Signing in to github.com...** in the status bar, paste the token, and hit enter.
