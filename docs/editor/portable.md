...
This mode also provides a way to set the installation folder location for VS Code extensions, useful for corporate environments that avoid extensions from being installed in the Windows AppData folder.
