...
>**Important:** With the recent move to TypeScript 1.8.2, you will need to have a `jsconfig.json` in your workspace for typings to be picked up.  Jump to the section below on [Adding a jsconfig.json Configuration File](/docs/runtimes/nodejs.md#adding-a-jsconfigjson-configuation-file) and then return to this part of the walkthrough.  This will be fixed in a later version of TypeScript.
