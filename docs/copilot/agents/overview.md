...
You monitor and interact with all your sessions from a single [sessions list](/docs/copilot/chat/chat-sessions.md#sessions-list) in the Chat view, regardless of where they run. If you prefer working entirely through prompts, the [Sessions Window](/docs/copilot/sessions-window.md) provides a dedicated interface where sessions and chat are the central experience, with built-in access to all your AI customizations.
