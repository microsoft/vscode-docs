...
> [!NOTE]
> Autopilot consumes AI credits in the same way as the standard interactive interface. As the agent continues to work autonomously, it can consume multiple requests. Learn more about [usage-based billing](https://docs.github.com/en/copilot/concepts/billing/usage-based-billing-for-individuals).
