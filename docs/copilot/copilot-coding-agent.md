...
This is different from [using agents](/docs/copilot/agents/overview.md#built-in-agents) in VS Code, which provide interactive development within the editor and requires your active participation during the coding session.
...
Learn more about [using agents in VS Code](/docs/copilot/agents/overview.md#built-in-agents).
