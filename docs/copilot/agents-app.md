...
1. **Artifacts panel**: on the right, where you can review files updates and other artifacts generated by your agent during a session.
...
Select any session to view its chat history, where you can continue the conversation. If the session has code changes, the artifacts panel is opened and shows the pending changes and a file explorer.

<!-- TODO: screenshot of the sessions list and artifacts panel -->
