...
| Next Edit Suggestions (preview) | Predict your next code edit with Copilot Next Edit Suggestions, aka Copilot NES. NES both predicts the location of the next edit you'll want to make and what that edit should be. You can sign up for NES via [the watilist](). |
