...
>
> For more information, see [AI Toolkit models in GitHub Copilot](https://docs.github.com/en/copilot/using-github-copilot/ai-models/ai-toolkit-models-in-github-copilot).
