...
VS Code uses the `launch.json` file to store [debug configuration](/docs/editor/debugtest/debugging-configuration.md). Copilot can help you create and customize this file to set up debugging for your project.
...
Learn more about [debugging in VS Code](/docs/editor/debugtest/debugging.md).
...
* Explore [general debugging features in VS Code](/docs/editor/debugtest/debugging.md).
