...
| `features` | object | An object of [dev container features](/docs/remote/containers.md#dev-container-features) and options to be added into your primary container. For example, `"features": { "github-cli": "latest" }` <br /><br /> ⚠️ Currently in preview. Support for features in GitHub Codespaces is coming soon. |
