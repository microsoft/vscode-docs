...
* Run the `tunnel` command of the `code` [command-line interface (CLI)](/docs/editor/advanced/command-line.md#create-remote-tunnel).
...
You may create and use tunnels through the `code` [CLI](/docs/editor/advanced/command-line.md).
...
As mentioned in the [`code` CLI doc](/docs/editor/advanced/command-line.md#create-remote-tunnel), you can explore all the possible CLI commands and options through `code tunnel --help`.
