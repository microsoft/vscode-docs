...
> Note: If you already have Docker installed, then you may use [open in dev container](https://insiders.vscode.dev/redirect?url=vscode-insiders://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/microsoft/vscode-remote-try-python. You may learn more about this and how to add it to your repos in the [create a dev container doc](./create-dev-container.md#add-configuration-files-to-a-repository).
