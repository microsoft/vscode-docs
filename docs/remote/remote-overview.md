...
> **Dogfooding Note:** Install [VS Code with built-in remote support from here](https://aka.ms/vscode-remote/download) by clicking on the latest version for your OS with the  `Released` column checked.
>
