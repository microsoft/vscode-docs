...
MetaDescription: Java tutorial showing basic Java language support in the {% data variables.product.prodname_vscode %} editor
---
# Getting Started with Java in {% data variables.product.prodname_vscode_shortname %}

This tutorial shows you how to write and run Hello World program in Java with {% data variables.product.prodname_vscode %}. It also covers a few advanced features, which you can explore by reading other documents in this section.

For an overview of the features available for Java in {% data variables.product.prodname_vscode_shortname %}, see [Java Language Overview](/docs/languages/java.md).
...
## Setting up {% data variables.product.prodname_vscode_shortname %} for Java development

### Coding Pack for Java

To help you set up quickly, you can install the **Coding Pack for Java**, which includes {% data variables.product.prodname_vscode_shortname %}, the Java Development Kit (JDK), and essential Java extensions. The Coding Pack can be used as a clean installation, or to update or repair an existing development environment.
...
If you are an existing {% data variables.product.prodname_vscode_shortname %} user, you can also add Java support by installing the [Extension Pack for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack), which includes these extensions:
...
To use Java within {% data variables.product.prodname_vscode %}, you need to install a Java Development Kit (JDK) on your local environment. JDK is a software development environment used for developing Java applications.
...
>**Note**: If you open a Java file in {% data variables.product.prodname_vscode_shortname %} without opening its folder, the Java Language Server might not work properly.

{% data variables.product.prodname_vscode_shortname %} will also try to figure out the correct package for the new type and fill the new file from a template. See [Create new file](/docs/java/java-editing.md#create-new-file).
...
{% data variables.product.prodname_vscode %} also supports more complex Java projects — see [Project Management](/docs/java/java-project.md).

## Editing source code

You can use code snippets to scaffold your classes and methods. {% data variables.product.prodname_vscode_shortname %} also provides IntelliSense for code completion, and various refactor methods.
...
* [Java Web Apps](/docs/java/java-webapp.md) shows how to work with Java Web App in {% data variables.product.prodname_vscode_shortname %}
