...
### Enabling test framework for your unmanaged folder
...
If your project does not use any build tools, you can enable the JUnit 4 via [just a few clicks](#enabling-test-framework-for-your-unmanaged-folder) or manually download the following JARs and add them to the project classpath (via setting `java.project.referencedLibraries`, check [Dependency management](/docs/java/java-project.md#dependency-management) for more information):
...
If your project does not use any build tools, you can enable the TestNG via [just a few clicks](#enabling-test-framework-for-your-unmanaged-folder) or manually download the following JARs and add them to the project classpath (via setting `java.project.referencedLibraries`, check [Dependency management](/docs/java/java-project.md#dependency-management) for more information):
