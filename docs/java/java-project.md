...
> **Note**: To enable Java preview features, see [How can I use VS Code with new Java version](/docs/getstarted/java-faq.md#how-can-i-use-visual-studio-code-with-new-java-version)
