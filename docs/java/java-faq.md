...
MetaDescription: Java on {% data variables.product.prodname_vscode %} Frequent Asked Questions and Troubleshooting Guide
---
# Frequent Asked Questions

Thanks for your interest in Java on {% data variables.product.prodname_vscode %}! This FAQ will hopefully answer some of the questions you may have.
...
## Are there any other features coming to Java on {% data variables.product.prodname_vscode %}?
...
While you're using Java within {% data variables.product.prodname_vscode_shortname %}, you may also see a **Release Notes** section after you update the [Extension Pack for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-pack). The notes will give you an overview on the notable updates included in the extensions.

## How can I use {% data variables.product.prodname_vscode %} with new Java versions?

Thanks to the upstream update from JDT, you can now build your project up to Java 22 with {% data variables.product.prodname_vscode_shortname %} as well. To use the experimental/preview language features, you need to modify your project settings.
...
> Note: If you are modifying a project that was already opened in {% data variables.product.prodname_vscode_shortname %}, you may need to force clean the workspace and reload. To do so, run command **Java: Clean Java Language Server Workspace**.
...
This is done by configuring the `java.jdt.ls.vmargs` setting in {% data variables.product.prodname_vscode_shortname %} preferences (all on one line):
...
Currently we don't plan to extend the Java support to Visual Studio. There are already great IDEs for Java and we're focusing on {% data variables.product.prodname_vscode_shortname %} to provide a lightweight experience in a polyglot editor.

## Does {% data variables.product.prodname_vscode_shortname %} Java support other display languages?

Currently we support Chinese in addition to English for a few extensions including [Debugger for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-debug), [Test Runner for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-test), [Maven for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-maven), [Project Manager for Java](https://marketplace.visualstudio.com/items?itemName=vscjava.vscode-java-dependency). To learn how to switch the {% data variables.product.prodname_vscode_shortname %} display language, see [Display Languages](/docs/configure/locales.md).
...
You can visit the [Java for {% data variables.product.prodname_vscode %} wiki](https://github.com/redhat-developer/vscode-java/wiki) to find answers regarding:
