...
`categories` | | `string[]` | the categories you want to use for the extensions allowed values: `["Azure", "Debuggers", "Extension Packs", "Formatters", "Keymaps", "Language Packs", "Languages", "Linters", "Other", "SCM Providers", "Snippets", "Themes"]`
