...
| `netCore` | Determines options specific for .NET projects ([see below](#netcore-object-properties-docker-build-task)). |
...
| `netCore` | For .NET projects, this controls various options ([see below](#netcore-object-properties-docker-run-task)). |
