...
| `projectType` | Selects the default port (5000 for `flask`, 8000 for `django` and `fastapi`, none for `general`) and sets which command will be used for running the Python app. | |
