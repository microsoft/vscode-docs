...
1. Open your application code in VS Code, right-click on your **build** directory, and choose **Deploy to Static Website...**.
    ...
    ![Deploy to Static Website](/tutorials/images/static-website/deploy-build.png)
...
1. Choose your Subscription and the Storage Account that you just created. When completed, you can click into the portal to copy your website URL (primary endpoint).
    ...
    ![Deployment Complete](/tutorials/images/static-website/deployment-complete.png)
...
<a class="tutorial-next-btn" href="/tutorials/static-website/code-change">My site is on Azure</a> <a class="tutorial-feedback-btn" onclick="reportIssue('node-deployment-staticwebsite', 'deploy-explorer')" href="javascript:void(0)"> and I ran into an issue</a>
