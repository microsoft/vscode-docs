...
![Open VS Code](/tutorials/images/nodejs-deployment/openvscode.png)
...
![Edit pug file](/tutorials/images/nodejs-deployment/editpugfile.png)
...
![Commit Changes](/tutorials/images/nodejs-deployment/commitchanges.png)

## Publish Changes to Website

Click on the **Source Control** overflow menu (**...**) and choose **Publish**.

![Publish Menu](/tutorials/images/nodejs-deployment/publishmenu.png)

You will be prompted for a Remote to publish to, choose `Azure`.

![Choose Azure](/tutorials/images/nodejs-deployment/chooseazure.png)

Your changes will then be deployed to the Website. Refresh your application and you should see the changes.

![Published Changes](/tutorials/images/nodejs-deployment/vscoderocks.png)
